...
- `partition_test`: `passed` - `test result: ok. 6 passed; 0 failed; 0 ignored; 0 measured; 1783 filtered out; finished in 0.00s`
...
thread '__smelt_module_groupBy_test::test_filtering_on_undefined_grouper_result_regular_indexed' (2179790) panicked at src/groupBy.rs:48:48:
index out of bounds
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '__smelt_module_groupBy_test::test_filtering_on_undefined_grouper_result_regular' (2179789) panicked at src/groupBy.rs:48:48:
index out of bounds

thread '__smelt_module_groupBy_test::test_data_first_groupby' (2179787) panicked at src/groupBy.rs:48:48:
index out of bounds

thread '__smelt_module_groupBy_test::test_key_is_an_object_instance_method_name_groupby' (2179791) panicked at src/groupBy.rs:48:48:
index out of bounds

thread '__smelt_module_groupBy_test::test_data_last_groupby' (2179788) panicked at src/groupBy.rs:48:48:
index out of bounds
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `groupByProp_test`: `failed` - `test result: FAILED. 1 passed; 8 failed; 0 ignored; 0 measured; 1780 filtered out; finished in 0.00s`
...
test result: FAILED. 1 passed; 8 failed; 0 ignored; 0 measured; 1780 filtered out; finished in 0.00s


thread '__smelt_module_groupByProp_test::test_data_first_must_be_grouped_correctly_by_number' (2179803) panicked at src/groupByProp.rs:63:415:
index out of bounds
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '__smelt_module_groupByProp_test::test_data_first_must_be_grouped_correctly_by_string' (2179804) panicked at src/groupByProp.rs:63:415:
index out of bounds

thread '__smelt_module_groupByProp_test::test_grouping_value_is_a_key_of_object_prototype_issue_1049' (2179810) panicked at src/groupByProp.rs:63:415:
index out of bounds

thread '__smelt_module_groupByProp_test::test_data_last_must_be_grouped_correctly_by_number' (2179806) panicked at src/groupByProp.rs:63:415:
index out of bounds

thread '__smelt_module_groupByProp_test::test_data_last_must_be_grouped_correctly_by_string' (2179807) panicked at src/groupByProp.rs:63:415:
index out of bounds
Error: Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }
Error: Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }

thread '__smelt_module_groupByProp_test::test_handles_undefined_as_optional_elements' (2179811) panicked at src/groupByProp.rs:63:415:
index out of bounds
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
...
- `dataLast_test`: `passed` - `test result: ok. 0 passed; 0 failed; 0 ignored; 0 measured; 1789 filtered out; finished in 0.00s`
- `purry_test`: `passed` - `test result: ok. 3 passed; 0 failed; 0 ignored; 0 measured; 1786 filtered out; finished in 0.00s`
- `setTimeout_test`: `passed` - `test result: ok. 0 passed; 0 failed; 0 ignored; 0 measured; 1789 filtered out; finished in 0.00s`

## Full Suite

- Status: `failed`
- Result: `test result: FAILED. 1571 passed; 218 failed; 0 ignored; 0 measured; 0 filtered out; finished in 8.63s`
- Failing tests: `218`
...
- Baseline report: `blocker-logs/remeda-nested-mutation-after.md`
- Resolved tests: `0`
