...
3. **warning** `unused_assignments` - 258 diagnostics
4. **warning** `unused_mut` - 195 diagnostics
...
1. **warning** `unused_mut` - 195 occurrences
...
446. **warning** `non_snake_case` - 1 occurrence
   ...
   - Examples:
     - `src/main.rs:778`
447. **warning** `path_statements` - 1 occurrence
...
914. **warning** `unused_imports` - 1 occurrence
   ...
   - Examples:
     - `src/main.rs:783`
915. **warning** `unused_parens` - 1 occurrence
   - Message: unnecessary parentheses around `return` value
   - Examples:
     - `src/randomBigInt.rs:88`
916. **warning** `unused_parens` - 1 occurrence
