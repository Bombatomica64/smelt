...
```
- `isNonNull`: `failed` - `test result: FAILED. 2 passed; 2 failed; 0 ignored; 0 measured; 1785 filtered out; finished in 0.00s`
...
thread '__smelt_module_pullObject_test::test_datalast_undefined_values' (278079) panicked at src/pullObject_test.rs:363:1062:
