...
- `isEmptyish_test`: `failed` - `test result: FAILED. 21 passed; 10 failed; 0 ignored; 0 measured; 1758 filtered out; finished in 0.00s`

```text
__smelt_module_isEmptyish_test::test_unsupported_types_errors --- FAILED
__smelt_module_isEmptyish_test::test_unsupported_types_classes --- FAILED
...
test result: FAILED. 21 passed; 10 failed; 0 ignored; 0 measured; 1758 filtered out; finished in 0.00s
...
- Status: `failed`
- Result: `test result: FAILED. 1546 passed; 243 failed; 0 ignored; 0 measured; 0 filtered out; finished in 15.72s`
- Failing tests: `243`
...
- Baseline report: `blocker-logs/remeda-is-emptyish-before.md`
- Resolved tests: `4`
- Newly failing tests: `20`
...
- `__smelt_module_dropLastWhile_test::test_data_first_should_return_a_copy_of_the_array_when_the_last_item_fails_the_predicate`
- `__smelt_module_dropLastWhile_test::test_data_first_should_return_first_item_when_first_item_fails_the_predicate`
- `__smelt_module_dropLastWhile_test::test_data_first_should_return_items_until_the_last_predicate_failure`
...
- `__smelt_module_dropLast_test::test_n_length_296`
...
- `__smelt_module_mean_test::test_datafirst_should_return_the_mean_of_numbers_in_an_array`
- `__smelt_module_mean_test::test_datafirst_should_return_undefined_for_an_empty_array_1341`
...
- `__smelt_module_takeLastWhile_test::test_data_first_should_return_an_empty_array_when_the_last_item_fails_the_predicate`
- `__smelt_module_takeLastWhile_test::test_data_first_should_return_items_after_the_last_predicate_failure`
- `__smelt_module_takeLastWhile_test::test_data_first_should_return_rest_of_the_items_when_first_item_fails_the_predicate`
...
- `__smelt_module_takeLast_test::test_n_length_1896`
...
- `__smelt_module_zipWith_test::test_data_first_should_truncate_to_shorter_first`
...
- `__smelt_module_zip_test::test_datafirst_should_truncate_to_shorter_first`
