...
- `__smelt_module_isStrictEqual_test`: `failed` - `test result: FAILED. 13 passed; 4 failed; 0 ignored; 0 measured; 1772 filtered out; finished in 0.00s`
...
test result: FAILED. 13 passed; 4 failed; 0 ignored; 0 measured; 1772 filtered out; finished in 0.00s
...
- Status: `failed`
- Result: `test result: FAILED. 1714 passed; 75 failed; 0 ignored; 0 measured; 0 filtered out; finished in 3.66s`
- Failing tests: `75`
...
- Baseline report: `blocker-logs/remeda-full-current-2026-06-11.md`
- Resolved tests: `5`
