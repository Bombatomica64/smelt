...
- `isDefined`: `failed` - `test result: FAILED. 1 passed; 1 failed; 0 ignored; 0 measured; 1787 filtered out; finished in 0.01s`
...
```
- `isNonNull`: `failed` - `test result: FAILED. 2 passed; 2 failed; 0 ignored; 0 measured; 1785 filtered out; finished in 0.01s`

```text

running 4 tests
.. 2/4
__smelt_module_isNonNullish_test::test_should_work_as_type_guard_in_filter_1217 --- FAILED
...
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `isNonNullish`: `failed` - `test result: FAILED. 1 passed; 1 failed; 0 ignored; 0 measured; 1787 filtered out; finished in 0.00s`
...
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `pullObject`: `failed` - `test result: FAILED. 14 passed; 2 failed; 0 ignored; 0 measured; 1773 filtered out; finished in 0.01s`
...
test result: FAILED. 14 passed; 2 failed; 0 ignored; 0 measured; 1773 filtered out; finished in 0.01s

Error: Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }

thread '__smelt_module_pullObject_test::test_datalast_undefined_values' (293681) panicked at src/pullObject_test.rs:363:1062:
...
- `isNot`: `failed` - `test result: FAILED. 1 passed; 1 failed; 0 ignored; 0 measured; 1787 filtered out; finished in 0.02s`
...
test result: FAILED. 1 passed; 1 failed; 0 ignored; 0 measured; 1787 filtered out; finished in 0.02s
