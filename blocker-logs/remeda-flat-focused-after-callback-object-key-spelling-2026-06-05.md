...
- `__smelt_module_uniqueWith_test`: `passed` - `test result: ok. 5 passed; 0 failed; 0 ignored; 0 measured; 1784 filtered out; finished in 0.00s`

## Full Suite

- Status: `failed`
- Result: `test result: FAILED. 1570 passed; 219 failed; 0 ignored; 0 measured; 0 filtered out; finished in 8.37s`
- Failing tests: `219`
