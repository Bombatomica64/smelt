...
- `__smelt_module_groupByProp_test`: `passed` - `test result: ok. 9 passed; 0 failed; 0 ignored; 0 measured; 1780 filtered out; finished in 0.02s`
...
- Status: `failed`
- Result: `test result: FAILED. 1611 passed; 178 failed; 0 ignored; 0 measured; 0 filtered out; finished in 14.95s`
- Failing tests: `178`
...
- Baseline report: `blocker-logs/remeda-hasprop-before-2026-06-05.md`
- Resolved tests: `1`
