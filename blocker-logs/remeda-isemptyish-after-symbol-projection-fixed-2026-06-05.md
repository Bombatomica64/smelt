...
- `__smelt_module_isEmptyish_test`: `failed` - `test result: FAILED. 24 passed; 7 failed; 0 ignored; 0 measured; 1758 filtered out; finished in 0.01s`
...
.. 30/31
__smelt_module_isEmptyish_test::test_unsupported_types_always_true_regexp --- FAILED
...
test result: FAILED. 24 passed; 7 failed; 0 ignored; 0 measured; 1758 filtered out; finished in 0.01s


thread '__smelt_module_isEmptyish_test::test_arrays_array_like_e_g_arguments' (203628) panicked at src/isEmptyish_test.rs:239:95:
expect(...).toBe(...) failed
...
- `__smelt_module_entries_test`: `failed` - `test result: FAILED. 4 passed; 1 failed; 0 ignored; 0 measured; 1784 filtered out; finished in 0.00s`

```text

running 5 tests
__smelt_module_entries_test::test_should_ignore_symbol_keys --- FAILED
....
failures:

failures:
    __smelt_module_entries_test::test_should_ignore_symbol_keys
...
- Status: `failed`
- Result: `test result: FAILED. 1610 passed; 179 failed; 0 ignored; 0 measured; 0 filtered out; finished in 13.93s`
- Failing tests: `179`
...
- `__smelt_module_invert_test::test_data_first_symbol_keys_are_filtered_out`
...
- `__smelt_module_keys_test::test_datafirst_should_ignore_symbol_keys`
...
- `__smelt_module_mapKeys_test::test_symbols_are_filtered_out_1319`
- `__smelt_module_mapKeys_test::test_symbols_are_not_passed_to_the_mapper_1320`
- `__smelt_module_mapValues_test::test_symbols_are_filtered_out_1330`
- `__smelt_module_mapValues_test::test_symbols_are_not_passed_to_the_mapper_1331`
...
- `__smelt_module_values_test::test_should_skip_symbol_keys`
