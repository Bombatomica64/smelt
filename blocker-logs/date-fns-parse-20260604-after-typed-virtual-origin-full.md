...
- `__smelt_module_test::test_parse_context_allows_to_specify_the_context`: `failed` - `test result: FAILED. 0 passed; 1 failed; 0 ignored; 0 measured; 246 filtered out; finished in 0.11s`
...
test result: FAILED. 0 passed; 1 failed; 0 ignored; 0 measured; 246 filtered out; finished in 0.11s
...
- `__smelt_module_test::test_parse_era_abbreviated`: `passed` - `test result: ok. 1 passed; 0 failed; 0 ignored; 0 measured; 246 filtered out; finished in 0.07s`

## Full Suite

- Status: `failed`
- Result: `test result: FAILED. 239 passed; 8 failed; 0 ignored; 0 measured; 0 filtered out; finished in 5.29s`
- Failing tests: `8`
...
| Failures | Test group |
| ---: | --- |
| 8 | `__smelt_module_test` |

### Delta From Baseline

- Baseline report: `blocker-logs/date-fns-parse-20260604-after-virtual-field-method-calls-full.md`
- Resolved tests: `3`
