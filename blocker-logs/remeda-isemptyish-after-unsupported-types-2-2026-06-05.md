...
- `__smelt_module_isEmptyish_test`: `failed` - `test result: FAILED. 29 passed; 2 failed; 0 ignored; 0 measured; 1758 filtered out; finished in 0.01s`

```text

running 31 tests
.................. 18/31
__smelt_module_isEmptyish_test::test_keyed_collections_symbol_props --- FAILED
......... 28/31
...
test result: FAILED. 29 passed; 2 failed; 0 ignored; 0 measured; 1758 filtered out; finished in 0.01s
...
- `__smelt_module_hasProp_test`: `passed` - `test result: ok. 16 passed; 0 failed; 0 ignored; 0 measured; 1773 filtered out; finished in 0.01s`
- `__smelt_module_entries_test`: `passed` - `test result: ok. 5 passed; 0 failed; 0 ignored; 0 measured; 1784 filtered out; finished in 0.01s`
- `__smelt_module_invert_test`: `passed` - `test result: ok. 11 passed; 0 failed; 0 ignored; 0 measured; 1778 filtered out; finished in 0.01s`
...
- Status: `failed`
- Result: `test result: FAILED. 1609 passed; 180 failed; 0 ignored; 0 measured; 0 filtered out; finished in 22.01s`
- Failing tests: `180`
...
| 5 | `__smelt_module_isShallowEqual_test` |
...
- Resolved tests: `5`
- Newly failing tests: `21`

<details>
<summary>Failing test inventory</summary>

- `__smelt_module_clone_test::test_built_in_types_case_0_clones_regexp_object_s`
- `__smelt_module_clone_test::test_built_in_types_case_1_clones_regexp_object_s`
- `__smelt_module_clone_test::test_built_in_types_case_2_clones_regexp_object_s`
- `__smelt_module_clone_test::test_built_in_types_case_3_clones_regexp_object_s`
- `__smelt_module_clone_test::test_built_in_types_case_4_clones_regexp_object_s`
- `__smelt_module_clone_test::test_built_in_types_case_5_clones_regexp_object_s`
- `__smelt_module_clone_test::test_built_in_types_case_6_clones_regexp_object_s`
- `__smelt_module_clone_test::test_built_in_types_case_7_clones_regexp_object_s`
- `__smelt_module_clone_test::test_built_in_types_case_8_clones_regexp_object_s`
- `__smelt_module_clone_test::test_built_in_types_case_9_clones_regexp_object_s`
...
- `__smelt_module_isDeepEqual_test::test_regular_expressions_not_equal_regexp_objects_different_flags`
- `__smelt_module_isDeepEqual_test::test_regular_expressions_not_equal_regexp_objects_different_pattern`
- `__smelt_module_isDeepEqual_test::test_regular_expressions_regexp_and_object_are_not_equal`
...
- `__smelt_module_split_test::test_regex_split`
- `__smelt_module_split_test::test_regex_with_limit`
