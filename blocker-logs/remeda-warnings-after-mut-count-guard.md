...
14. **error** `E0384` - 2 occurrences
   ...
   - Examples:
     - `src/truncate.rs:89`
     - `src/truncate.rs:89`
15. **warning** `unreachable_code` - 2 occurrences
...
50. **warning** `unused_assignments` - 1 occurrence
   ...
   - Examples:
     - `src/words.rs:101`
51. **warning** `unused_parens` - 1 occurrence
   - Message: unnecessary parentheses around `return` value
   - Examples:
     - `src/randomBigInt.rs:87`
52. **warning** `unused_parens` - 1 occurrence
...
error: could not compile `remeda_smelt_probe` (bin "remeda_smelt_probe") due to 8 previous errors; 221 warnings emitted
```
