...
- Status: `failed`
- Result: `test result: FAILED. 1475 passed; 314 failed; 0 ignored; 0 measured; 0 filtered out; finished in 9.06s`
- Failing tests: `314`
...
- Baseline report: `blocker-logs/remeda-after-next3.md`
- Resolved tests: `15`
...
2. **warning** `unused_mut` - 98 diagnostics
...
1. **warning** `unused_mut` - 98 occurrences
