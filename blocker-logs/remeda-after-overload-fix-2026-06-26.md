...
- Status: `failed`
- Result: `test result: FAILED. 1783 passed; 6 failed; 0 ignored; 0 measured; 0 filtered out; finished in 2.81s`
- Failing tests: `6`
...
- `__smelt_module_firstBy_test::test_runtime_datafirst_returns_undefined_on_empty`
