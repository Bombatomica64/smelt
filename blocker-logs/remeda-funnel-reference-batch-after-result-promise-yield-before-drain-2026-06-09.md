...
- `__smelt_module_funnel_reference_batch_test`: `passed` - `test result: ok. 3 passed; 0 failed; 0 ignored; 0 measured; 1786 filtered out; finished in 0.01s`
...
- `__smelt_module_randomBigInt_test`: `passed` - `test result: ok. 13 passed; 0 failed; 0 ignored; 0 measured; 1776 filtered out; finished in 0.37s`
