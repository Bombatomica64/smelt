...
- `identity_test`: `passed` - `test result: ok. 5 passed; 0 failed; 0 ignored; 0 measured; 1784 filtered out; finished in 0.00s`

## Full Suite

- Status: `failed`
- Result: `test result: FAILED. 1557 passed; 232 failed; 0 ignored; 0 measured; 0 filtered out; finished in 10.20s`
- Failing tests: `232`
...
- Baseline report: `blocker-logs/remeda-purry-callback-forwarding-after.md`
- Resolved tests: `7`
