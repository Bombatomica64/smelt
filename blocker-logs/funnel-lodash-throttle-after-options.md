...
- `__smelt_module_funnel_lodash_throttle_test`: `failed` - `test result: FAILED. 16 passed; 1 failed; 0 ignored; 0 measured; 1772 filtered out; finished in 0.16s`

```text

running 17 tests
............. 13/17
__smelt_module_funnel_lodash_throttle_test::test_https_github_com_lodash_lodash_blob_4_17_21_test_test_js_l23038_supports_recursive_calls_604 --- FAILED
...
failures:

failures:
    __smelt_module_funnel_lodash_throttle_test::test_https_github_com_lodash_lodash_blob_4_17_21_test_test_js_l23038_supports_recursive_calls_604

test result: FAILED. 16 passed; 1 failed; 0 ignored; 0 measured; 1772 filtered out; finished in 0.16s
...
- `__smelt_module_truncate_test`: `passed` - `test result: ok. 24 passed; 0 failed; 0 ignored; 0 measured; 1765 filtered out; finished in 0.01s`
- `__smelt_module_clone_test::test_objects_clones_objects_with_circular_references`: `passed` - `test result: ok. 1 passed; 0 failed; 0 ignored; 0 measured; 1788 filtered out; finished in 0.00s`
- `__smelt_module_difference_test`: `passed` - `test result: ok. 13 passed; 0 failed; 0 ignored; 0 measured; 1776 filtered out; finished in 0.00s`
...
2. **warning** `unused_parens` - 65 occurrences
   ...
   - Examples:
     ...
     - `src/funnel.rs:452`
     - `src/funnel.rs:547`
3. **warning** `unused_unsafe` - 22 occurrences
