...
- Status: `failed`
- Result: `test result: FAILED. 158 passed; 89 failed; 0 ignored; 0 measured; 0 filtered out; finished in 3.10s`
- Failing tests: `89`
...
- Baseline report: `blocker-logs/date-fns-parse-20260603-current.md`
- Resolved tests: `0`
- Newly failing tests: `89`
