...
- `__smelt_module_funnel_reference_batch_test`: `failed` - `test result: FAILED. 2 passed; 1 failed; 0 ignored; 0 measured; 1786 filtered out; finished in 0.00s`
...
test result: FAILED. 2 passed; 1 failed; 0 ignored; 0 measured; 1786 filtered out; finished in 0.00s
...
- `__smelt_module_randomBigInt_test`: `passed` - `test result: ok. 13 passed; 0 failed; 0 ignored; 0 measured; 1776 filtered out; finished in 0.30s`
...
1. **warning** `unused_mut` - 134 diagnostics
