...
- `__smelt_module_firstBy_test`: `failed` - `test result: FAILED. 18 passed; 4 failed; 0 ignored; 0 measured; 1767 filtered out; finished in 0.00s`

```text
.. 3/22
__smelt_module_firstBy_test::test_runtime_datafirst_can_compare_valueofs --- FAILED
........ 12/22
__smelt_module_firstBy_test::test_runtime_datalast_can_compare_booleans --- FAILED
...
test result: FAILED. 18 passed; 4 failed; 0 ignored; 0 measured; 1767 filtered out; finished in 0.00s


thread '__smelt_module_firstBy_test::test_runtime_datafirst_can_compare_booleans' (3844407) panicked at src/purryOrderRules.rs:199:51:
optional value was absent after narrowing
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '__smelt_module_firstBy_test::test_runtime_datafirst_can_compare_valueofs' (3844410) panicked at src/purryOrderRules.rs:199:51:
optional value was absent after narrowing

thread '__smelt_module_firstBy_test::test_runtime_datalast_can_compare_booleans' (3844418) panicked at src/purryOrderRules.rs:199:51:
optional value was absent after narrowing

thread '__smelt_module_firstBy_test::test_runtime_datalast_can_compare_valueofs' (3844421) panicked at src/purryOrderRules.rs:199:51:
optional value was absent after narrowing
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `__smelt_module_dropFirstBy_test`: `passed` - `test result: ok. 12 passed; 0 failed; 0 ignored; 0 measured; 1777 filtered out; finished in 0.01s`
- `__smelt_module_nthBy_test`: `failed` - `test result: FAILED. 6 passed; 2 failed; 0 ignored; 0 measured; 1781 filtered out; finished in 0.00s`
...
test result: FAILED. 6 passed; 2 failed; 0 ignored; 0 measured; 1781 filtered out; finished in 0.00s


thread '__smelt_module_nthBy_test::test_runtime_datalast_handles_overflows_gracefully' (3844471) panicked at src/nthBy_test.rs:413:49:
optional value was absent after narrowing
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '__smelt_module_nthBy_test::test_runtime_datafirst_handles_overflows_gracefully' (3844467) panicked at src/nthBy_test.rs:120:49:
optional value was absent after narrowing
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
...
- `__smelt_module_flat_test`: `passed` - `test result: ok. 28 passed; 0 failed; 0 ignored; 0 measured; 1761 filtered out; finished in 0.02s`

## Full Suite

- Status: `failed`
- Result: `test result: FAILED. 1585 passed; 204 failed; 0 ignored; 0 measured; 0 filtered out; finished in 13.89s`
- Failing tests: `204`
