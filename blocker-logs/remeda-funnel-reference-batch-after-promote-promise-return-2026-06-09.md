...
- `__smelt_module_funnel_reference_batch_test`: `failed` - `test result: FAILED. 0 passed; 3 failed; 0 ignored; 0 measured; 1786 filtered out; finished in 0.00s`
...
thread '__smelt_module_funnel_reference_batch_test::test_showcase_results_as_array' (2296665) panicked at src/funnel_reference_batch_test.rs:75:5:
recursive closure control flow is not structured yet
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '__smelt_module_funnel_reference_batch_test::test_showcase_error_handling' (2296664) panicked at src/funnel_reference_batch_test.rs:75:5:
recursive closure control flow is not structured yet

thread '__smelt_module_funnel_reference_batch_test::test_showcase_results_as_object' (2296666) panicked at src/funnel_reference_batch_test.rs:75:5:
recursive closure control flow is not structured yet
...
- `__smelt_module_funnel_lodash_throttle_with_cached_value_test`: `passed` - `test result: ok. 7 passed; 0 failed; 0 ignored; 0 measured; 1782 filtered out; finished in 0.00s`
- `__smelt_module_funnel_lodash_debounce_with_cached_value_test`: `passed` - `test result: ok. 8 passed; 0 failed; 0 ignored; 0 measured; 1781 filtered out; finished in 0.03s`
- `__smelt_module_randomBigInt_test`: `passed` - `test result: ok. 13 passed; 0 failed; 0 ignored; 0 measured; 1776 filtered out; finished in 0.33s`
...
13. **warning** `unused_must_use` - 1 occurrence
   ...
   - Examples:
     - `src/funnel_reference_batch_test.rs:111`
