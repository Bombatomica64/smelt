...
_Generated 2026-09-07 by the `library-probes` workflow (`scripts/probe_libraries.py`)._
...
| [ts-pattern](https://github.com/gvergnaud/ts-pattern) | TS | **no** | n/a | `src/internals/helpers.ts` | 10 | non-working Rust (10r/0s) |
