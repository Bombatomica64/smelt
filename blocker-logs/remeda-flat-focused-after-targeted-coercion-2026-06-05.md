...
- `__smelt_module_flat_test`: `failed` - `test result: FAILED. 22 passed; 6 failed; 0 ignored; 0 measured; 1761 filtered out; finished in 0.00s`

```text
running 28 tests
........... 11/28
__smelt_module_flat_test::test_datalast_stops_at_the_given_depth --- FAILED
.... 16/28
__smelt_module_flat_test::test_datalast_works_lazily_shallow --- FAILED
__smelt_module_flat_test::test_datalast_works_with_deeper_depth --- FAILED
__smelt_module_flat_test::test_datalast_works_lazily_deep --- FAILED
...... 25/28
__smelt_module_flat_test::test_legacy_flatten_equivalent_depth_1_datalast_lazy --- FAILED
__smelt_module_flat_test::test_legacy_flattendeep_equivalent_depth_4_lazy --- FAILED
.
failures:

failures:
    __smelt_module_flat_test::test_datalast_stops_at_the_given_depth
    __smelt_module_flat_test::test_datalast_works_lazily_deep
    __smelt_module_flat_test::test_datalast_works_lazily_shallow
    __smelt_module_flat_test::test_datalast_works_with_deeper_depth
...
test result: FAILED. 22 passed; 6 failed; 0 ignored; 0 measured; 1761 filtered out; finished in 0.00s
...
- `__smelt_module_uniqueWith_test`: `failed` - `test result: FAILED. 3 passed; 2 failed; 0 ignored; 0 measured; 1784 filtered out; finished in 0.00s`

```text

running 5 tests
. 1/5
__smelt_module_uniqueWith_test::test_data_last_take_before_uniq --- FAILED
.. 4/5
__smelt_module_uniqueWith_test::test_data_last_lazy_2124 --- FAILED
...
test result: FAILED. 3 passed; 2 failed; 0 ignored; 0 measured; 1784 filtered out; finished in 0.00s
...
- Status: `failed`
- Result: `test result: FAILED. 1525 passed; 264 failed; 0 ignored; 0 measured; 0 filtered out; finished in 7.58s`
- Failing tests: `264`
...
| 7 | `__smelt_module_pipe_test` |
| 6 | `__smelt_module_evolve_test` |
| 6 | `__smelt_module_flat_test` |
| 6 | `__smelt_module_mergeDeep_test` |
| 6 | `__smelt_module_sortBy_test` |
...
- Baseline report: `blocker-logs/remeda-probe-existing-generated-2026-06-05.md`
- Resolved tests: `14`
- Newly failing tests: `60`

<details>
<summary>Failing test inventory</summary>

- `__smelt_module_binarySearchCutoffIndex_test::test_runtime_correctness_fancy_stuff`
...
- `__smelt_module_find_test::test_data_last_find`
- `__smelt_module_find_test::test_data_last_indexed_380`
- `__smelt_module_firstBy_test::test_runtime_datafirst_breaks_ties_with_multiple_order_rules`
...
- `__smelt_module_firstBy_test::test_runtime_datafirst_finds_the_minimum_with_a_non_trivial_order_rule`
...
- `__smelt_module_flatMap_test::test_datalast_works_with_non_array_outputs`
- `__smelt_module_flat_test::test_datalast_stops_at_the_given_depth`
- `__smelt_module_flat_test::test_datalast_works_lazily_deep`
- `__smelt_module_flat_test::test_datalast_works_lazily_shallow`
- `__smelt_module_flat_test::test_datalast_works_with_deeper_depth`
...
- `__smelt_module_forEach_test::test_pipe`
- `__smelt_module_forEach_test::test_with_take`
...
- `__smelt_module_map_test::test_data_last_passes_the_index_to_the_mapper_as_its_second_argument`
...
- `__smelt_module_map_test::test_pipe_invoked_lazily`
- `__smelt_module_map_test::test_pipe_invoked_lazily_indexed`
...
- `__smelt_module_pipe_test::test_lazy_lazy_after_1st_op`
- `__smelt_module_pipe_test::test_lazy_lazy_early_exit_with_hasmany`
- `__smelt_module_pipe_test::test_lazy_lazy_map_filter_take`
- `__smelt_module_pipe_test::test_lazy_lazy_map_take`
- `__smelt_module_pipe_test::test_lazy_multiple_lazy`
- `__smelt_module_pipe_test::test_lazy_multiple_take`
- `__smelt_module_pullObject_test::test_datafirst_number_keys`
...
- `__smelt_module_take_test::test_data_last_works_on_regular_inputs_1876`
- `__smelt_module_take_test::test_data_last_works_when_taking_more_than_the_length_of_the_array`
...
- `__smelt_module_zip_test::test_datalast_should_truncate_to_shorter_first`
- `__smelt_module_zip_test::test_datalast_should_truncate_to_shorter_second`
- `__smelt_module_zip_test::test_datalast_should_zip`
