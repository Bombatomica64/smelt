...
- `pullObject`: `failed` - `test result: FAILED. 15 passed; 1 failed; 0 ignored; 0 measured; 1773 filtered out; finished in 0.01s`
...
thread '__smelt_module_pullObject_test::test_datalast_undefined_values' (288517) panicked at src/pullObject_test.rs:363:1062:
...
- `isNot`: `passed` - `test result: ok. 2 passed; 0 failed; 0 ignored; 0 measured; 1787 filtered out; finished in 0.00s`
