...
thread '__smelt_module_funnel_remeda_debounce_test::test_additional_functionality_can_flush_before_a_cool_down_634' (1928915) panicked at src/funnel_remeda_debounce_test.rs:1060:49:
...
```
- `debounce_test`: `failed` - `test result: FAILED. 33 passed; 29 failed; 0 ignored; 0 measured; 1727 filtered out; finished in 0.33s`

```text

thread '__smelt_module_funnel_lodash_debounce_test::test_https_github_com_lodash_lodash_blob_4_17_21_test_test_js_l4187_should_support_a_maxwait_option' (1928988) panicked at src/funnel_lodash_debounce_test.rs:27:81:
missing field

thread '__smelt_module_funnel_lodash_debounce_test::test_https_github_com_lodash_lodash_blob_4_17_21_test_test_js_l4187_should_support_a_leading_option' (1928987) panicked at src/funnel_lodash_debounce_test.rs:32:70:
missing field

thread '__smelt_module_funnel_lodash_debounce_test::test_https_github_com_lodash_lodash_blob_4_17_21_test_test_js_l4187_should_support_a_trailing_option' (1928989) panicked at src/funnel_lodash_debounce_test.rs:27:81:
missing field

thread '__smelt_module_funnel_lodash_debounce_test::test_https_github_com_lodash_lodash_blob_4_17_21_test_test_js_l4187_should_support_maxwait_in_a_tight_loop' (1928990) panicked at src/funnel_lodash_debounce_test.rs:27:81:
missing field
Error: Custom { kind: Other, error: "expect(...).toBe(...) failed" }
Error: Custom { kind: Other, error: "expect(...).toBe(...) failed" }
Error: Custom { kind: Other, error: "expect(...).toBe(...) failed" }
...
thread '__smelt_module_funnel_remeda_debounce_test::test_additional_functionality_can_flush_before_a_cool_down_634' (1928998) panicked at src/funnel_remeda_debounce_test.rs:1060:49:
optional value was absent after narrowing
expect(...).toBe(...) failed" }
Error: Custom { kind: Other, error: "expect(...).toBe(...) failed" }
Error: Custom { kind: Other, error: "expect(...).toBe(...) failed" }
...
thread '__smelt_module_funnel_lodash_debounce_test::test_https_github_com_lodash_lodash_blob_4_17_21_test_test_js_l4187_should_queue_a_trailing_call_for_subsequent_debounced_calls_after_maxwait' (1928986) panicked at src/funnel_lodash_debounce_test.rs:27:81:
missing field
Error: Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }
Error: Custom { kind: Other, error: "expect(...).toBe(...) failed" }
Error: Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }
...
- Status: `failed`
- Result: `test result: FAILED. 1562 passed; 227 failed; 0 ignored; 0 measured; 0 filtered out; finished in 16.77s`
- Failing tests: `227`
...
- Baseline report: `blocker-logs/remeda-timers-after-isolation.md`
- Resolved tests: `0`
