...
- `__smelt_module_isEmptyish_test`: `failed` - `test result: FAILED. 26 passed; 5 failed; 0 ignored; 0 measured; 1758 filtered out; finished in 0.00s`
...
test result: FAILED. 26 passed; 5 failed; 0 ignored; 0 measured; 1758 filtered out; finished in 0.00s
...
- Status: `failed`
- Result: `test result: FAILED. 1618 passed; 171 failed; 0 ignored; 0 measured; 0 filtered out; finished in 22.46s`
- Failing tests: `171`
...
| 5 | `__smelt_module_isEmptyish_test` |
...
- Baseline report: `blocker-logs/remeda-isemptyish-after-arguments-2026-06-05.md`
- Resolved tests: `0`
- Newly failing tests: `4`
