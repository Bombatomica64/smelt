...
- `context`: `failed` - `test result: FAILED. 1 passed; 1 failed; 0 ignored; 0 measured; 245 filtered out; finished in 0.03s`
...
test result: FAILED. 1 passed; 1 failed; 0 ignored; 0 measured; 245 filtered out; finished in 0.03s

Error: Custom { kind: Other, error: "expect(...).toBe(...) failed" }
error: test failed, to rerun pass `--bin date_fns_parse_probe`
```
- `transitions`: `failed` - `test result: FAILED. 0 passed; 1 failed; 0 ignored; 0 measured; 246 filtered out; finished in 0.03s`

```text

running 1 test
__smelt_module_test::test_parse_time_zones_properly_parses_dates_around_dst_transitions --- FAILED
...
- Status: `failed`
- Result: `test result: FAILED. 240 passed; 7 failed; 0 ignored; 0 measured; 0 filtered out; finished in 1.61s`
- Failing tests: `7`
