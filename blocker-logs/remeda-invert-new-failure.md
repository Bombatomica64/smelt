...
- `__smelt_module_invert_test::test_data_first_duplicate_values`: `failed` - `test result: FAILED. 0 passed; 1 failed; 0 ignored; 0 measured; 1788 filtered out; finished in 0.00s`

```text

running 1 test
__smelt_module_invert_test::test_data_first_duplicate_values --- FAILED

failures:

failures:
    __smelt_module_invert_test::test_data_first_duplicate_values

test result: FAILED. 0 passed; 1 failed; 0 ignored; 0 measured; 1788 filtered out; finished in 0.00s
