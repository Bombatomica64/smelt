...
| --- | --- | --- | --- | --- | ---: | --- |
| [radash](https://github.com/sodiray/radash) | TS | **no** | n/a | `src/curry.ts` | 5 | non-working Rust (5r/0s) |

## radash

- Source: `sodiray/radash` @ `4cab1900d08e`
- Transpile: **no** — `smelt build` aborts at `src/curry.ts`
- Tests passing: **n/a** (no Rust crate emitted)
- Files scanned: 19 · with blockers: 4

| Occurrences | Files | Category | Blocker class |
| ---: | ---: | --- | --- |
| 1 | 1 | non-working Rust | property writes onto a callable local after it escapes are not lowered yet |
