...
- `__smelt_module_isEmpty_test`: `failed` - `test result: FAILED. 6 passed; 1 failed; 0 ignored; 0 measured; 1782 filtered out; finished in 0.00s`

```text

running 7 tests
... 3/7
__smelt_module_isEmpty_test::test_returns_false_for_a_non_empty_string --- FAILED
...
failures:
...
- `__smelt_module_groupByProp_test`: `passed` - `test result: ok. 9 passed; 0 failed; 0 ignored; 0 measured; 1780 filtered out; finished in 0.01s`

## Full Suite

- Status: `failed`
- Result: `test result: FAILED. 1611 passed; 178 failed; 0 ignored; 0 measured; 0 filtered out; finished in 17.56s`
- Failing tests: `178`
...
- Baseline report: `blocker-logs/remeda-hasprop-after-erased-hasown-2026-06-05.md`
- Resolved tests: `0`
