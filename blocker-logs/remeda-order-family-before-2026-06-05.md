...
- `__smelt_module_firstBy_test`: `failed` - `test result: FAILED. 14 passed; 8 failed; 0 ignored; 0 measured; 1767 filtered out; finished in 0.00s`
...
test result: FAILED. 14 passed; 8 failed; 0 ignored; 0 measured; 1767 filtered out; finished in 0.00s


thread '__smelt_module_firstBy_test::test_runtime_datafirst_can_compare_valueofs' (3823983) panicked at src/purryOrderRules.rs:199:51:
optional value was absent after narrowing
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '__smelt_module_firstBy_test::test_runtime_datafirst_can_compare_booleans' (3823980) panicked at src/purryOrderRules.rs:199:51:
optional value was absent after narrowing

thread '__smelt_module_firstBy_test::test_runtime_datafirst_finds_the_minimum_with_a_non_trivial_order_rule' (3823987) panicked at src/purryOrderRules.rs:199:51:
optional value was absent after narrowing

thread '__smelt_module_firstBy_test::test_runtime_datalast_can_compare_booleans' (3823991) panicked at src/purryOrderRules.rs:199:51:
optional value was absent after narrowing
Error: Custom { kind: Other, error: "expect(...).toBe(...) failed" }

thread '__smelt_module_firstBy_test::test_runtime_datalast_can_compare_valueofs' (3823994) panicked at src/purryOrderRules.rs:199:51:
optional value was absent after narrowing
Error: Custom { kind: Other, error: "expect(...).toBe(...) failed" }

thread '__smelt_module_firstBy_test::test_runtime_datalast_finds_the_minimum_with_a_non_trivial_order_rule' (3823998) panicked at src/purryOrderRules.rs:199:51:
optional value was absent after narrowing
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `__smelt_module_dropFirstBy_test`: `failed` - `test result: FAILED. 10 passed; 2 failed; 0 ignored; 0 measured; 1777 filtered out; finished in 0.00s`

```text

running 12 tests
....... 7/12
__smelt_module_dropFirstBy_test::test_runtime_datafirst_works_with_complex_compare_rules_284 --- FAILED
... 11/12
__smelt_module_dropFirstBy_test::test_runtime_datalast_works_with_complex_compare_rules_290 --- FAILED
...
test result: FAILED. 10 passed; 2 failed; 0 ignored; 0 measured; 1777 filtered out; finished in 0.00s

Error: Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }
Error: Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `__smelt_module_nthBy_test`: `failed` - `test result: FAILED. 4 passed; 4 failed; 0 ignored; 0 measured; 1781 filtered out; finished in 0.00s`
...
... 6/8
__smelt_module_nthBy_test::test_runtime_datalast_works_with_complex_order_rules --- FAILED
__smelt_module_nthBy_test::test_runtime_datafirst_works_with_complex_order_rules --- FAILED
...
test result: FAILED. 4 passed; 4 failed; 0 ignored; 0 measured; 1781 filtered out; finished in 0.00s


thread '__smelt_module_nthBy_test::test_runtime_datalast_handles_overflows_gracefully' (3824040) panicked at src/nthBy_test.rs:413:49:
optional value was absent after narrowing
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '__smelt_module_nthBy_test::test_runtime_datafirst_handles_overflows_gracefully' (3824036) panicked at src/nthBy_test.rs:120:49:
optional value was absent after narrowing
Error: Custom { kind: Other, error: "expect(...).toBe(...) failed" }
Error: Custom { kind: Other, error: "expect(...).toBe(...) failed" }
error: test failed, to rerun pass `--bin remeda_smelt_probe`
...
- Status: `failed`
- Result: `test result: FAILED. 1570 passed; 219 failed; 0 ignored; 0 measured; 0 filtered out; finished in 12.38s`
- Failing tests: `219`
...
| 5 | `__smelt_module_sortBy_test` |
| 4 | `__smelt_module_median_test` |

### Delta From Baseline

- Baseline report: `blocker-logs/remeda-flat-focused-after-callback-object-key-spelling-2026-06-05.md`
- Resolved tests: `0`
