...
- `__smelt_module_isEmptyish_test`: `failed` - `test result: FAILED. 21 passed; 10 failed; 0 ignored; 0 measured; 1758 filtered out; finished in 0.01s`
...
thread '__smelt_module_isEmptyish_test::test_arrays_array_like_e_g_arguments' (4091234) panicked at src/isEmptyish_test.rs:245:95:
expect(...).toBe(...) failed
...
- `__smelt_module_isEmpty_test`: `passed` - `test result: ok. 7 passed; 0 failed; 0 ignored; 0 measured; 1782 filtered out; finished in 0.02s`
- `__smelt_module_hasProp_test`: `passed` - `test result: ok. 16 passed; 0 failed; 0 ignored; 0 measured; 1773 filtered out; finished in 0.14s`

## Full Suite

- Status: `failed`
- Result: `test result: FAILED. 1612 passed; 177 failed; 0 ignored; 0 measured; 0 filtered out; finished in 40.63s`
- Failing tests: `177`
...
- Baseline report: `blocker-logs/remeda-isempty-after-string-record-projection-2026-06-05.md`
- Resolved tests: `0`
