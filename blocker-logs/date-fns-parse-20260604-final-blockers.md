...
- `throws_an_error`: `passed` - `test result: ok. 6 passed; 0 failed; 0 ignored; 0 measured; 241 filtered out; finished in 0.41s`
- `date_prototype_tostring`: `passed` - `test result: ok. 1 passed; 0 failed; 0 ignored; 0 measured; 246 filtered out; finished in 0.33s`

## Regression Guards

- `context`: `passed` - `test result: ok. 2 passed; 0 failed; 0 ignored; 0 measured; 245 filtered out; finished in 0.25s`
- `transitions`: `passed` - `test result: ok. 1 passed; 0 failed; 0 ignored; 0 measured; 246 filtered out; finished in 0.80s`
- `custom_locale`: `passed` - `test result: ok. 1 passed; 0 failed; 0 ignored; 0 measured; 246 filtered out; finished in 0.11s`
