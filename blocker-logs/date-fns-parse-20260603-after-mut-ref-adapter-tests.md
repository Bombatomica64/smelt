...
- Status: `failed`
- Result: `test result: FAILED. 159 passed; 88 failed; 0 ignored; 0 measured; 0 filtered out; finished in 3.34s`
- Failing tests: `88`
...
| Failures | Test group |
| ---: | --- |
| 88 | `__smelt_module_test` |

### Delta From Baseline

- Baseline report: `blocker-logs/date-fns-parse-20260603-after-object-or.md`
- Resolved tests: `0`
