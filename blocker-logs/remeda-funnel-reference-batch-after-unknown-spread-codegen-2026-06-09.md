...
- `__smelt_module_funnel_reference_batch_test`: `failed` - `test result: FAILED. 0 passed; 3 failed; 0 ignored; 0 measured; 1786 filtered out; finished in 0.01s`
...
test result: FAILED. 0 passed; 3 failed; 0 ignored; 0 measured; 1786 filtered out; finished in 0.01s
...
- `__smelt_module_randomBigInt_test`: `passed` - `test result: ok. 13 passed; 0 failed; 0 ignored; 0 measured; 1776 filtered out; finished in 0.62s`
...
10. **warning** `unused_assignments` - 1 occurrence
   ...
   - Examples:
     - `src/funnel_reference_batch_test.rs:96`
