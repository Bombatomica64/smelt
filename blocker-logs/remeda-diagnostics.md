...
1. **warning** `unused_assignments` - 462 diagnostics
2. **warning** `non_snake_case` - 411 diagnostics
3. **warning** `unused_imports` - 363 diagnostics
4. **warning** `unused_mut` - 136 diagnostics
5. **warning** `unused_parens` - 67 diagnostics
6. **warning** `unreachable_code` - 59 diagnostics
7. **warning** `unused_must_use` - 3 diagnostics
8. **warning** `path_statements` - 2 diagnostics
...
1. **warning** `unused_assignments` - 151 occurrences
   ...
   - Examples:
     ...
     - `src/evolve.rs:357`
     - `src/evolve.rs:346`
2. **warning** `unused_mut` - 136 occurrences
...
4. **warning** `unused_assignments` - 52 occurrences
   ...
   - Examples:
     ...
     - `src/evolve.rs:370`
     - `src/evolve.rs:359`
5. **warning** `unused_parens` - 47 occurrences
...
9. **warning** `unused_assignments` - 15 occurrences
   ...
   - Examples:
     ...
     - `src/fromKeys.rs:17`
     - `src/indexBy.rs:17`
10. **warning** `unused_assignments` - 10 occurrences
...
12. **warning** `unused_assignments` - 6 occurrences
   ...
   - Examples:
     ...
     - `src/funnel_lodash_debounce_with_cached_value_test.rs:93`
     - `src/funnel_lodash_debounce_with_cached_value_test.rs:75`
...
17. **warning** `unused_assignments` - 4 occurrences
   ...
   - Examples:
     - `src/funnel_lodash_debounce_with_cached_value_test.rs:95`
     - `src/funnel_lodash_debounce_with_cached_value_test.rs:77`
     - `src/funnel_lodash_throttle_with_cached_value_test.rs:81`
...
24. **warning** `unused_must_use` - 3 occurrences
   - Message: unused return value of `clone` that must be used
   - Examples:
     - `src/doNothing.rs:9`
     - `src/funnel_lodash_debounce_test.rs:101`
     - `src/take.rs:31`
...
27. **warning** `unused_parens` - 3 occurrences
   - Message: unnecessary parentheses around method argument
   - Examples:
     - `src/funnel.rs:122`
     - `src/funnel.rs:183`
     - `src/splitAt.rs:37`
28. **warning** `path_statements` - 2 occurrences
...
134. **warning** `non_snake_case` - 1 occurrence
   ...
   - Examples:
     - `src/lazyInvocationCounter.rs:21`
...
911. **warning** `unused_imports` - 1 occurrence
   ...
   - Examples:
     - `src/main.rs:783`
912. **warning** `unused_parens` - 1 occurrence
   - Message: unnecessary parentheses around `return` value
   - Examples:
     - `src/randomBigInt.rs:351`
913. **warning** `unused_parens` - 1 occurrence
