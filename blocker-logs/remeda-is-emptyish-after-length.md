...
- `isEmptyish_test`: `failed` - `test result: FAILED. 19 passed; 12 failed; 0 ignored; 0 measured; 1758 filtered out; finished in 0.01s`
...
failures:
    ...
    __smelt_module_isEmptyish_test::test_self_declared_sizes_props_are_not_coerced
...
test result: FAILED. 19 passed; 12 failed; 0 ignored; 0 measured; 1758 filtered out; finished in 0.01s
...
- `funnel_test`: `passed` - `test result: ok. 40 passed; 0 failed; 0 ignored; 0 measured; 1749 filtered out; finished in 0.02s`

## Full Suite

- Status: `failed`
- Result: `test result: FAILED. 1563 passed; 226 failed; 0 ignored; 0 measured; 0 filtered out; finished in 16.45s`
- Failing tests: `226`
...
| 12 | `__smelt_module_isEmptyish_test` |
