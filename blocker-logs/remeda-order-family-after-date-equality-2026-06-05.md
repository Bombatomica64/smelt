...
- `__smelt_module_firstBy_test`: `failed` - `test result: FAILED. 20 passed; 2 failed; 0 ignored; 0 measured; 1767 filtered out; finished in 0.01s`
...
test result: FAILED. 20 passed; 2 failed; 0 ignored; 0 measured; 1767 filtered out; finished in 0.01s
...
- `__smelt_module_nthBy_test`: `passed` - `test result: ok. 8 passed; 0 failed; 0 ignored; 0 measured; 1781 filtered out; finished in 0.01s`
...
- Status: `failed`
- Result: `test result: FAILED. 1595 passed; 194 failed; 0 ignored; 0 measured; 0 filtered out; finished in 11.49s`
- Failing tests: `194`
...
- Baseline report: `blocker-logs/remeda-order-family-after-date-order-and-nullish-fixed-2026-06-05.md`
- Resolved tests: `0`
