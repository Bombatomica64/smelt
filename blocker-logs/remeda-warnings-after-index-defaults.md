...
1. **warning** `unused_mut` - 200 diagnostics
2. **warning** `unused_assignments` - 43 diagnostics
3. **warning** `unused_parens` - 36 diagnostics
4. **warning** `unreachable_code` - 2 diagnostics
5. **error** `E0381` - 1 diagnostic

## Groups

1. **warning** `unused_mut` - 200 occurrences
...
10. **warning** `unused_parens` - 3 occurrences
   ...
   - Examples:
     ...
     - `src/funnel.rs:188`
     - `src/splitAt.rs:37`
11. **warning** `unreachable_code` - 2 occurrences
...
18. **warning** `unused_assignments` - 2 occurrences
   ...
   - Examples:
     - `src/debounce.rs:235`
     - `src/debounce.rs:223`
19. **error** `E0381` - 1 occurrence
   - Message: used binding `index_1` is possibly-uninitialized
   - Examples:
     - `src/main.rs:1254`
...
33. **warning** `unused_parens` - 1 occurrence
...
error: could not compile `remeda_smelt_probe` (bin "remeda_smelt_probe") due to 1 previous error; 281 warnings emitted
```
