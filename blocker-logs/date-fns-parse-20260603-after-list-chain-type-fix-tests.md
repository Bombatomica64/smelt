...
- Status: `failed`
- Result: `test result: FAILED. 159 passed; 88 failed; 0 ignored; 0 measured; 0 filtered out; finished in 3.52s`
- Failing tests: `88`
...
- Baseline report: `blocker-logs/date-fns-parse-20260603-after-tuple-state-mut-abi-tests.md`
- Resolved tests: `0`
