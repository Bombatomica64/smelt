...
- `__smelt_module_groupByProp_test`: `failed` - `test result: FAILED. 7 passed; 2 failed; 0 ignored; 0 measured; 1780 filtered out; finished in 0.00s`
...
test result: FAILED. 7 passed; 2 failed; 0 ignored; 0 measured; 1780 filtered out; finished in 0.00s

Error: Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }
Error: Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `__smelt_module_groupBy_test`: `passed` - `test result: ok. 5 passed; 0 failed; 0 ignored; 0 measured; 1784 filtered out; finished in 0.00s`
...
- Status: `failed`
- Result: `test result: FAILED. 1608 passed; 181 failed; 0 ignored; 0 measured; 0 filtered out; finished in 14.85s`
- Failing tests: `181`
...
- Baseline report: `blocker-logs/remeda-groupby-family-before-2026-06-05.md`
- Resolved tests: `11`
