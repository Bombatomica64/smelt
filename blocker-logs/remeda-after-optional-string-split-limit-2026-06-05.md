...
1. **warning** `unused_mut` - 98 diagnostics
2. **warning** `unused_parens` - 92 diagnostics
3. **warning** `unused_unsafe` - 23 diagnostics
4. **error** `E0308` - 17 diagnostics
5. **error** `E0057` - 16 diagnostics
6. **warning** `unused_assignments` - 13 diagnostics
7. **error** `E0277` - 3 diagnostics
8. **error** `no-code` - 1 diagnostic
9. **warning** `unreachable_code` - 1 diagnostic
...
4. **warning** `unused_unsafe` - 23 occurrences
   ...
   - Examples:
     ...
     - `src/funnel.rs:32`
     - `src/funnel.rs:83`
5. **error** `E0308` - 17 occurrences
   - Message: mismatched types
   - Examples:
     - `src/sliceString.rs:21`
     - `src/split.rs:29`
     - `src/split.rs:29`
     - `src/toCamelCase.rs:68`
     - `src/toCamelCase.rs:95`
6. **error** `E0057` - 16 occurrences
   - Message: this function takes 3 arguments but 2 arguments were supplied
   - Examples:
     - `src/allPass.rs:30`
     - `src/anyPass.rs:30`
     - `src/differenceWith.rs:41`
     - `src/funnel_reference_batch_test.rs:22`
     - `src/intersectionWith.rs:39`
...
error: could not compile `remeda_smelt_probe` (bin "remeda_smelt_probe") due to 37 previous errors; 227 warnings emitted
```
