...
```
- `__smelt_module_isStrictEqual_test`: `failed` - `test result: FAILED. 11 passed; 6 failed; 0 ignored; 0 measured; 1772 filtered out; finished in 0.00s`
...
test result: FAILED. 11 passed; 6 failed; 0 ignored; 0 measured; 1772 filtered out; finished in 0.00s
...
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `__smelt_module_isDeepEqual_test`: `failed` - `test result: FAILED. 68 passed; 5 failed; 0 ignored; 0 measured; 1716 filtered out; finished in 0.01s`
...
test result: FAILED. 68 passed; 5 failed; 0 ignored; 0 measured; 1716 filtered out; finished in 0.01s
