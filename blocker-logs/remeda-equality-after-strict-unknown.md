...
- `isDeepEqual_test`: `failed` - `test result: FAILED. 51 passed; 22 failed; 0 ignored; 0 measured; 1716 filtered out; finished in 0.01s`
...
```
- `isShallowEqual_test`: `failed` - `test result: FAILED. 10 passed; 8 failed; 0 ignored; 0 measured; 1771 filtered out; finished in 0.01s`
...
test result: FAILED. 10 passed; 8 failed; 0 ignored; 0 measured; 1771 filtered out; finished in 0.01s


thread '__smelt_module_isShallowEqual_test::test_objects_arrays_1248' (2122717) panicked at src/isShallowEqual.rs:128:26:
...
thread '__smelt_module_isShallowEqual_test::test_objects_uint_arrays_1250' (2122721) panicked at src/isShallowEqual.rs:128:26:
unknown is not object

thread '__smelt_module_isShallowEqual_test::test_shallow_inequality_arrays_of_arrays' (2122728) panicked at src/isShallowEqual.rs:128:26:
unknown is not object
Error: Custom { kind: Other, error: "expect(...).toBe(...) failed" }

thread '__smelt_module_isShallowEqual_test::test_shallow_inequality_arrays_of_objects' (2122729) panicked at src/isShallowEqual.rs:128:26:
unknown is not object
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `isStrictEqual_test`: `failed` - `test result: FAILED. 12 passed; 5 failed; 0 ignored; 0 measured; 1772 filtered out; finished in 0.00s`
...
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `isIncludedIn_test`: `failed` - `test result: FAILED. 17 passed; 3 failed; 0 ignored; 0 measured; 1769 filtered out; finished in 0.01s`
...
test result: FAILED. 17 passed; 3 failed; 0 ignored; 0 measured; 1769 filtered out; finished in 0.01s
...
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `constant_test`: `failed` - `test result: FAILED. 5 passed; 2 failed; 0 ignored; 0 measured; 1782 filtered out; finished in 0.00s`
...
test result: FAILED. 5 passed; 2 failed; 0 ignored; 0 measured; 1782 filtered out; finished in 0.00s
...
- Status: `failed`
- Result: `test result: FAILED. 1539 passed; 250 failed; 0 ignored; 0 measured; 0 filtered out; finished in 32.71s`
- Failing tests: `250`
...
| Failures | Test group |
| ---: | --- |
| 22 | `__smelt_module_isDeepEqual_test` |
...
| 8 | `__smelt_module_isShallowEqual_test` |
| 6 | `__smelt_module_clone_test` |
| 6 | `__smelt_module_evolve_test` |
| 6 | `__smelt_module_partition_test` |
| 6 | `__smelt_module_split_test` |
| 6 | `__smelt_module_uniqueBy_test` |
| 6 | `__smelt_module_when_test` |
| 6 | `__smelt_module_zipWith_test` |
| 5 | `__smelt_module_funnel_lodash_throttle_with_cached_value_test` |
| 5 | `__smelt_module_groupBy_test` |
| 5 | `__smelt_module_isStrictEqual_test` |
| 5 | `__smelt_module_randomInteger_test` |

### Delta From Baseline

- Baseline report: `blocker-logs/remeda-equality-before.md`
- Resolved tests: `16`
- Newly failing tests: `42`

<details>
<summary>Failing test inventory</summary>

- `__smelt_module_clone_test::test_built_in_types_clones_date_object`
- `__smelt_module_clone_test::test_edge_cases_empty_object`
- `__smelt_module_clone_test::test_nested_mixed_objects_clones_array_with_arrays_clones_array_with_mutual_ref_object`
- `__smelt_module_clone_test::test_objects_clones_deep_object`
- `__smelt_module_clone_test::test_objects_clones_objects_with_circular_references`
- `__smelt_module_clone_test::test_objects_clones_shallow_object`
- `__smelt_module_constant_test::test_can_completely_change_the_type_of_the_pipe`
- `__smelt_module_constant_test::test_returns_identity_doesn_t_clone`
- `__smelt_module_debounce_test::test_additional_functionality_can_flush_before_a_cool_down_196`
- `__smelt_module_differenceWith_test::test_data_first_should_return_difference`
- `__smelt_module_differenceWith_test::test_data_last_lazy_244`
- `__smelt_module_differenceWith_test::test_data_last_should_return_difference`
...
- `__smelt_module_isDeepEqual_test::test_arrays_equal_arrays`
- `__smelt_module_isDeepEqual_test::test_arrays_equal_arrays_of_objects`
- `__smelt_module_isDeepEqual_test::test_arrays_two_empty_arrays_are_equal`
- `__smelt_module_isDeepEqual_test::test_dates_equal_date_objects`
- `__smelt_module_isDeepEqual_test::test_functions_same_function_is_equal`
- `__smelt_module_isDeepEqual_test::test_maps_two_empty_maps_should_be_equal`
- `__smelt_module_isDeepEqual_test::test_maps_two_maps_with_the_same_non_primitives_data_should_be_equal`
- `__smelt_module_isDeepEqual_test::test_maps_works_on_shallow_equal_maps`
- `__smelt_module_isDeepEqual_test::test_null_prototype_objects_are_compared_recursively`
- `__smelt_module_isDeepEqual_test::test_null_prototype_objects_are_equal_to_equivalent_null_prototype_objects`
- `__smelt_module_isDeepEqual_test::test_null_prototype_objects_are_equal_to_equivalent_plain_objects`
- `__smelt_module_isDeepEqual_test::test_null_prototype_objects_work_in_data_last_form`
- `__smelt_module_isDeepEqual_test::test_objects_empty_objects_are_equal`
- `__smelt_module_isDeepEqual_test::test_objects_equal_objects_different_properties_order`
- `__smelt_module_isDeepEqual_test::test_objects_equal_objects_same_properties_order`
- `__smelt_module_isDeepEqual_test::test_objects_equal_objects_same_sub_properties`
...
- `__smelt_module_isPlainObject_test::test_accepts_simple_objects_1233`
- `__smelt_module_isPlainObject_test::test_accepts_trivial_empty_objects_1234`
...
- `__smelt_module_mergeDeep_test::test_runtime_datafirst_should_merge_nested_objects`
