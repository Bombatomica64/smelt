...
- Status: `failed`
- Result: `test result: FAILED. 1669 passed; 120 failed; 0 ignored; 0 measured; 0 filtered out; finished in 2.25s`
- Failing tests: `120`
...
| Failures | Test group |
| ---: | --- |
| 9 | `__smelt_module_sortBy_test` |
| 8 | `__smelt_module_isStrictEqual_test` |
| 7 | `__smelt_module_ceil_test` |
| 7 | `__smelt_module_floor_test` |
| 7 | `__smelt_module_round_test` |
...
| 2 | `__smelt_module_last_test` |

<details>
<summary>Failing test inventory</summary>

- `__smelt_module_add_test::test_data_last_5`
- `__smelt_module_ceil_test::test_data_last_case_0_should_return_d_when_passed_as_value_regardless_of_precision_62`
- `__smelt_module_ceil_test::test_data_last_case_0_should_throw_for_d_precision_58`
- `__smelt_module_ceil_test::test_data_last_case_1_should_return_d_when_passed_as_value_regardless_of_precision_63`
- `__smelt_module_ceil_test::test_data_last_case_1_should_throw_for_d_precision_59`
- `__smelt_module_ceil_test::test_data_last_case_2_should_return_d_when_passed_as_value_regardless_of_precision_64`
- `__smelt_module_ceil_test::test_data_last_should_throw_for_precision_higher_than_15_and_lower_than_15_61`
- `__smelt_module_ceil_test::test_data_last_should_work_with_negative_precision_56`
...
- `__smelt_module_floor_test::test_data_last_case_0_should_return_d_when_passed_as_value_regardless_of_precision_514`
- `__smelt_module_floor_test::test_data_last_case_0_should_throw_for_d_precision_510`
- `__smelt_module_floor_test::test_data_last_case_1_should_return_d_when_passed_as_value_regardless_of_precision_515`
- `__smelt_module_floor_test::test_data_last_case_1_should_throw_for_d_precision_511`
- `__smelt_module_floor_test::test_data_last_case_2_should_return_d_when_passed_as_value_regardless_of_precision_516`
- `__smelt_module_floor_test::test_data_last_should_throw_for_precision_higher_than_15_and_lower_than_15_513`
- `__smelt_module_floor_test::test_data_last_should_work_with_negative_precision_508`
...
- `__smelt_module_round_test::test_data_last_case_0_should_return_d_when_passed_as_value_regardless_of_precision_1572`
- `__smelt_module_round_test::test_data_last_case_0_should_throw_for_d_precision_1568`
- `__smelt_module_round_test::test_data_last_case_1_should_return_d_when_passed_as_value_regardless_of_precision_1573`
- `__smelt_module_round_test::test_data_last_case_1_should_throw_for_d_precision_1569`
- `__smelt_module_round_test::test_data_last_case_2_should_return_d_when_passed_as_value_regardless_of_precision_1574`
- `__smelt_module_round_test::test_data_last_should_throw_for_precision_higher_than_15_and_lower_than_15_1571`
- `__smelt_module_round_test::test_data_last_should_work_with_negative_precision_1566`
...
- `__smelt_module_splitAt_test::test_data_last_split_at_1`
- `__smelt_module_splitWhen_test::test_should_split_array`
- `__smelt_module_splitWhen_test::test_should_with_no_matches`
- `__smelt_module_subtract_test::test_data_last_1847`
- `__smelt_module_swapIndices_test::test_data_last_swap_array`
- `__smelt_module_swapIndices_test::test_data_last_swap_string`
