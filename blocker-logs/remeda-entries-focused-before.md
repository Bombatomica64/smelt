...
- `__smelt_module_entries_test`: `failed` - `test result: FAILED. 0 passed; 5 failed; 0 ignored; 0 measured; 1784 filtered out; finished in 0.00s`

```text
__smelt_module_entries_test::test_works_with_complex_objects_as_values --- FAILED

failures:

failures:
    __smelt_module_entries_test::test_returns_symbol_values
    __smelt_module_entries_test::test_should_ignore_symbol_keys
    __smelt_module_entries_test::test_should_return_pairs
    __smelt_module_entries_test::test_should_turn_numbers_to_strings
    __smelt_module_entries_test::test_works_with_complex_objects_as_values

test result: FAILED. 0 passed; 5 failed; 0 ignored; 0 measured; 1784 filtered out; finished in 0.00s


thread '__smelt_module_entries_test::test_should_ignore_symbol_keys' (3957796) panicked at src/entries_test.rs:37:205:
unknown is not array
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '__smelt_module_entries_test::test_returns_symbol_values' (3957795) panicked at src/entries_test.rs:75:205:
unknown is not array

thread '__smelt_module_entries_test::test_should_turn_numbers_to_strings' (3957798) panicked at src/entries_test.rs:55:205:
unknown is not array

thread '__smelt_module_entries_test::test_should_return_pairs' (3957797) panicked at src/entries_test.rs:17:205:
unknown is not array

thread '__smelt_module_entries_test::test_works_with_complex_objects_as_values' (3957799) panicked at src/entries_test.rs:101:205:
unknown is not array
