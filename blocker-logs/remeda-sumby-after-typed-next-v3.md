...
error[E0308]: mismatched types
  --> src/sumBy.rs:44:21
   |
25 |     let _smelt_tmp_14: SmeltUnknown;
   |                        ------------ expected due to this type
...
44 |     _smelt_tmp_14 = first_entry.clone().clone();
   |                     ^^^^^^^^^^^^^^^^^^^^^^^^^^^ expected `SmeltUnknown`, found `Option<(i64, SmeltUnknown)>`
   |
   = note: expected enum `SmeltUnknown`
              found enum `std::option::Option<(i64, SmeltUnknown)>`
