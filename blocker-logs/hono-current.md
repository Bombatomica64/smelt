...
| unsupported-lowering | 7 |

## Distinct blocker classes

| Occurrences | Files | Category | Blocker class | Example |
| ---: | ---: | --- | --- | --- |
| 6 | 3 | unresolved reference | unresolved identifier `X` | `/home/user/smelt/third_party/hono/src/client/client.ts` |
| 5 | 4 | missing stdlib | unresolved class `X` | `/home/user/smelt/third_party/hono/src/client/client.ts` |
...
| 1 | 1 | non-working Rust (unlowered) | rest parameter type must resolve to an array type | `/home/user/smelt/third_party/hono/src/client/types.ts` |
| 1 | 1 | non-working Rust (unlowered) | string replace requires string-compatible receiver, pattern, and replacement | `/home/user/smelt/third_party/hono/src/client/utils.ts` |
