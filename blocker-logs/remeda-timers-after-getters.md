...
- `debounce_test`: `failed` - `test result: FAILED. 33 passed; 29 failed; 0 ignored; 0 measured; 1727 filtered out; finished in 0.34s`

```text

thread '__smelt_module_funnel_lodash_debounce_test::test_https_github_com_lodash_lodash_blob_4_17_21_test_test_js_l4187_should_support_a_trailing_option' (1902461) panicked at src/funnel_lodash_debounce_test.rs:27:81:
missing field

thread '__smelt_module_funnel_lodash_debounce_test::test_https_github_com_lodash_lodash_blob_4_17_21_test_test_js_l4187_should_apply_default_options' (1902452) panicked at src/funnel_lodash_debounce_test.rs:27:81:
missing field

thread '__smelt_module_funnel_lodash_debounce_test::test_https_github_com_lodash_lodash_blob_4_17_21_test_test_js_l4187_should_support_maxwait_in_a_tight_loop' (1902462) panicked at src/funnel_lodash_debounce_test.rs:27:81:
missing field

thread '__smelt_module_funnel_lodash_debounce_test::test_https_github_com_lodash_lodash_blob_4_17_21_test_test_js_l4187_should_invoke_the_trailing_call_with_the_correct_arguments_and_this_binding_577' (1902455) panicked at src/funnel_lodash_debounce_test.rs:30:82:
missing field
...
thread '__smelt_module_funnel_lodash_debounce_test::test_https_github_com_lodash_lodash_blob_4_17_21_test_test_js_l4187_should_support_a_leading_option' (1902458) panicked at src/funnel_lodash_debounce_test.rs:32:70:
missing field

thread '__smelt_module_funnel_remeda_debounce_test::test_additional_functionality_can_flush_before_a_cool_down_634' (1902470) panicked at src/funnel_remeda_debounce_test.rs:1040:49:
...
```
- `funnel_test`: `passed` - `test result: ok. 40 passed; 0 failed; 0 ignored; 0 measured; 1749 filtered out; finished in 0.01s`
- `funnel_remeda_debounce_test`: `failed` - `test result: FAILED. 11 passed; 12 failed; 0 ignored; 0 measured; 1766 filtered out; finished in 0.32s`
...
test result: FAILED. 11 passed; 12 failed; 0 ignored; 0 measured; 1766 filtered out; finished in 0.32s

Error: Custom { kind: Other, error: "expect(...).toBe(...) failed" }
Error: Custom { kind: Other, error: "expect(...).toBe(...) failed" }

thread '__smelt_module_funnel_remeda_debounce_test::test_additional_functionality_can_flush_before_a_cool_down_634' (1902577) panicked at src/funnel_remeda_debounce_test.rs:1040:49:
optional value was absent after narrowing
...
- `map_test`: `passed` - `test result: ok. 12 passed; 0 failed; 0 ignored; 0 measured; 1777 filtered out; finished in 0.00s`

## Full Suite

- Status: `failed`
- Result: `test result: FAILED. 1562 passed; 227 failed; 0 ignored; 0 measured; 0 filtered out; finished in 11.53s`
- Failing tests: `227`
...
- Baseline report: `blocker-logs/remeda-purry-callback-forwarding-after-v2.md`
- Resolved tests: `5`
