...
3. **warning** `unused_parens` - 16 occurrences
   ...
   - Examples:
     ...
     - `src/find.rs:23`
     - `src/findIndex.rs:18`
4. **warning** `unused_parens` - 11 occurrences
...
error: could not compile `remeda_smelt_probe` (bin "remeda_smelt_probe") due to 3 previous errors; 176 warnings emitted
```
