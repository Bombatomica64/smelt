...
- `__smelt_module_funnel_lodash_throttle_with_cached_value_test`: `passed` - `test result: ok. 7 passed; 0 failed; 0 ignored; 0 measured; 1782 filtered out; finished in 0.01s`
- `__smelt_module_funnel_lodash_debounce_with_cached_value_test`: `passed` - `test result: ok. 8 passed; 0 failed; 0 ignored; 0 measured; 1781 filtered out; finished in 0.04s`
- `__smelt_module_randomBigInt_test`: `passed` - `test result: ok. 13 passed; 0 failed; 0 ignored; 0 measured; 1776 filtered out; finished in 0.44s`
...
4. **warning** `unused_assignments` - 10 diagnostics
...
10. **warning** `unused_assignments` - 1 occurrence
   ...
   - Examples:
     - `src/funnel_reference_batch_test.rs:99`
...
14. **warning** `unused_must_use` - 1 occurrence
   - Message: unused pinned boxed `Future` trait object that must be used
   - Examples:
     - `src/funnel_reference_batch_test.rs:98`
