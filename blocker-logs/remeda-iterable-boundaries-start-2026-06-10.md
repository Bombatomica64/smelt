...
- `__smelt_module_length_test`: `failed` - `test result: FAILED. 2 passed; 2 failed; 0 ignored; 0 measured; 1785 filtered out; finished in 0.00s`

```text

running 4 tests
. 1/4
__smelt_module_length_test::test_data_first_iterable --- FAILED
__smelt_module_length_test::test_curried_iterable --- FAILED
.
failures:
...
thread '__smelt_module_length_test::test_data_first_iterable' (901429) panicked at src/length.rs:12:411:
unknown is not array
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '__smelt_module_length_test::test_curried_iterable' (901427) panicked at src/length.rs:12:411:
unknown is not array
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `__smelt_module_first_test`: `failed` - `test result: FAILED. 21 passed; 2 failed; 0 ignored; 0 measured; 1766 filtered out; finished in 0.01s`

```text

running 23 tests
.................. 18/23
__smelt_module_first_test::test_tuple_with_last_421 --- FAILED
.. 21/23
__smelt_module_first_test::test_readonly_tuple_with_last --- FAILED
.
failures:
...
test result: FAILED. 21 passed; 2 failed; 0 ignored; 0 measured; 1766 filtered out; finished in 0.01s

Error: Custom { kind: Other, error: "expect(...).toBe(...) failed" }
Error: Custom { kind: Other, error: "expect(...).toBe(...) failed" }
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `__smelt_module_last_test`: `failed` - `test result: FAILED. 2 passed; 2 failed; 0 ignored; 0 measured; 1785 filtered out; finished in 0.00s`

```text

running 4 tests
. 1/4
__smelt_module_last_test::test_data_first_empty_array_1298 --- FAILED
. 3/4
__smelt_module_last_test::test_data_last_empty_array_1300 --- FAILED
...
thread '__smelt_module_last_test::test_data_first_empty_array_1298' (901482) panicked at src/last.rs:18:190:
negative index out of bounds: TryFromIntError(())
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '__smelt_module_last_test::test_data_last_empty_array_1300' (901484) panicked at src/last.rs:18:190:
negative index out of bounds: TryFromIntError(())
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `__smelt_module_splitAt_test`: `failed` - `test result: FAILED. 2 passed; 2 failed; 0 ignored; 0 measured; 1785 filtered out; finished in 0.00s`

```text

running 4 tests
__smelt_module_splitAt_test::test_data_first_split --- FAILED
. 2/4
__smelt_module_splitAt_test::test_data_first_split_at_1 --- FAILED
.
failures:
...
- `__smelt_module_median_test`: `passed` - `test result: ok. 6 passed; 0 failed; 0 ignored; 0 measured; 1783 filtered out; finished in 0.00s`
