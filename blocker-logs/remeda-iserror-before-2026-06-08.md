...
- `__smelt_module_isError_test`: `failed` - `test result: FAILED. 1 passed; 1 failed; 0 ignored; 0 measured; 1787 filtered out; finished in 0.00s`

```text

running 2 tests
__smelt_module_isError_test::test_should_work_as_type_guard_1190 --- FAILED
.
failures:
...
- Status: `failed`
- Result: `test result: FAILED. 1629 passed; 160 failed; 0 ignored; 0 measured; 0 filtered out; finished in 22.17s`
- Failing tests: `160`
...
- Baseline report: `blocker-logs/remeda-isemptyish-after-regexp-context-2026-06-05.md`
- Resolved tests: `0`
