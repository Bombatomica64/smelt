...
- Status: `failed`
- Result: `test result: FAILED. 1460 passed; 329 failed; 0 ignored; 0 measured; 0 filtered out; finished in 8.64s`
- Failing tests: `329`
...
| 13 | `__smelt_module_isEmptyish_test` |
| 12 | `__smelt_module_dropFirstBy_test` |
| 12 | `__smelt_module_fromKeys_test` |
| 12 | `__smelt_module_funnel_remeda_debounce_test` |
| 12 | `__smelt_module_randomBigInt_test` |
| 9 | `__smelt_module_map_test` |
...
| 8 | `__smelt_module_nthBy_test` |
| 8 | `__smelt_module_sumBy_test` |
| 8 | `__smelt_module_takeFirstBy_test` |
| 8 | `__smelt_module_when_test` |
| 7 | `__smelt_module_fromEntries_test` |
...
- Baseline report: `blocker-logs/remeda-after-entries.md`
- Resolved tests: `90`
...
- `__smelt_module_firstBy_test::test_runtime_datafirst_can_compare_booleans`
...
- `__smelt_module_flatMap_test::test_datafirst_flatmap`
- `__smelt_module_flatMap_test::test_datafirst_should_accept_fn_returning_a_readonly_array`
- `__smelt_module_flatMap_test::test_datalast_flatmap`
- `__smelt_module_flatMap_test::test_datalast_should_accept_fn_returning_a_readonly_array`
- `__smelt_module_forEachObj_test::test_datafirst_526`
- `__smelt_module_forEachObj_test::test_doesn_t_run_on_symbol_keys`
- `__smelt_module_forEachObj_test::test_number_keys_are_translated_to_string`
- `__smelt_module_forEach_test::test_datafirst_520`
- `__smelt_module_forEach_test::test_datalast_521`
- `__smelt_module_fromEntries_test::test_boolean_values`
- `__smelt_module_fromEntries_test::test_datafirst_531`
- `__smelt_module_fromEntries_test::test_datalast_532`
- `__smelt_module_fromEntries_test::test_empty_array_533`
- `__smelt_module_fromEntries_test::test_number_keys_and_values`
- `__smelt_module_fromEntries_test::test_single_entry`
- `__smelt_module_fromEntries_test::test_string_values`
...
- `__smelt_module_fromKeys_test::test_uses_the_last_value`
- `__smelt_module_fromKeys_test::test_works_on_regular_arrays`
- `__smelt_module_fromKeys_test::test_works_with_a_mix_of_key_types`
- `__smelt_module_fromKeys_test::test_works_with_duplicates`
- `__smelt_module_fromKeys_test::test_works_with_number_keys`
- `__smelt_module_fromKeys_test::test_works_with_symbols`
...
- `__smelt_module_funnel_remeda_debounce_test::test_additional_functionality_can_cancel_after_the_timer_ends_629`
...
- `__smelt_module_hasSubObject_test::test_data_first_works_with_deep_objects`
- `__smelt_module_hasSubObject_test::test_data_first_works_with_primitives`
- `__smelt_module_hasSubObject_test::test_data_last_works_with_deep_objects`
- `__smelt_module_hasSubObject_test::test_data_last_works_with_primitives`
- `__smelt_module_identity_test::test_can_be_put_in_a_pipe_734`
- `__smelt_module_identity_test::test_works_731`
...
- `__smelt_module_mapWithFeedback_test::test_data_first_should_return_an_array_of_successively_accumulated_values`
...
- `__smelt_module_map_test::test_complex_variadic_number_array`
- `__smelt_module_map_test::test_data_first_map`
- `__smelt_module_map_test::test_data_first_map_indexed`
- `__smelt_module_map_test::test_data_last_passes_the_value_to_the_mapper_as_its_first_argument`
- `__smelt_module_map_test::test_indexed_mixed_type_tuple`
- `__smelt_module_map_test::test_indexed_number_array`
- `__smelt_module_map_test::test_mixed_type_tuple`
- `__smelt_module_map_test::test_number_array`
- `__smelt_module_map_test::test_pipe_indexed_check_index_and_items`
...
- `__smelt_module_nthBy_test::test_runtime_datafirst_handles_negative_indexes`
- `__smelt_module_nthBy_test::test_runtime_datafirst_handles_overflows_gracefully`
- `__smelt_module_nthBy_test::test_runtime_datafirst_works_1374`
- `__smelt_module_nthBy_test::test_runtime_datafirst_works_with_complex_order_rules`
...
- `__smelt_module_partition_test::test_data_first_indexed_1414`
- `__smelt_module_partition_test::test_data_first_partition`
- `__smelt_module_partition_test::test_data_first_partition_with_type_guard`
...
- `__smelt_module_pick_test::test_datafirst_1426`
- `__smelt_module_pick_test::test_datalast_1427`
- `__smelt_module_pick_test::test_it_can_pick_symbol_keys`
...
- `__smelt_module_rankBy_test::test_runtime_datafirst_can_rank_items_not_in_the_array`
- `__smelt_module_rankBy_test::test_runtime_datafirst_finds_items_ranked_at_the_end_of_the_array`
- `__smelt_module_rankBy_test::test_runtime_datafirst_maintains_the_rank_for_items_already_in_the_array`
...
- `__smelt_module_sortBy_test::test_data_first_sort_booleans_correctly`
- `__smelt_module_sortBy_test::test_data_first_sort_dates_correctly`
- `__smelt_module_sortBy_test::test_data_first_sort_objects_correctly`
- `__smelt_module_sortBy_test::test_data_first_sort_objects_correctly_mixing_sort_pair_and_sort_projection`
- `__smelt_module_sortBy_test::test_data_first_sort_objects_descending_correctly`
...
- `__smelt_module_sumBy_test::test_data_first_indexed_1855`
- `__smelt_module_sumBy_test::test_data_first_should_return_0_for_an_empty_array`
- `__smelt_module_sumBy_test::test_data_first_sumby`
...
- `__smelt_module_takeFirstBy_test::test_runtime_datafirst_clones_the_array_when_needed`
- `__smelt_module_takeFirstBy_test::test_runtime_datafirst_handles_overflowing_numbers_gracefully_1884`
- `__smelt_module_takeFirstBy_test::test_runtime_datafirst_works_1881`
- `__smelt_module_takeFirstBy_test::test_runtime_datafirst_works_with_complex_compare_rules_1886`
...
- `__smelt_module_uniqueWith_test::test_data_first_should_return_items_that_are_not_equal_to_themselves`
- `__smelt_module_uniqueWith_test::test_data_first_should_return_uniq`
- `__smelt_module_uniqueWith_test::test_data_last_lazy_2124`
- `__smelt_module_uniqueWith_test::test_data_last_should_return_uniq`
...
- `__smelt_module_when_test::test_datalast_passes_extra_args_to_the_functions`
- `__smelt_module_when_test::test_datalast_without_else_passes_extra_args_to_the_functions`
- `__smelt_module_when_test::test_recipes_acts_as_a_coalesce_tool`
