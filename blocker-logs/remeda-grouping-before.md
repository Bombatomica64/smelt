...
thread '__smelt_module_groupBy_test::test_filtering_on_undefined_grouper_result_regular' (2131431) panicked at src/groupBy.rs:48:48:
index out of bounds
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '__smelt_module_groupBy_test::test_filtering_on_undefined_grouper_result_regular_indexed' (2131432) panicked at src/groupBy.rs:48:48:
index out of bounds

thread '__smelt_module_groupBy_test::test_key_is_an_object_instance_method_name_groupby' (2131433) panicked at src/groupBy.rs:48:48:
index out of bounds

thread '__smelt_module_groupBy_test::test_data_first_groupby' (2131429) panicked at src/groupBy.rs:48:48:
index out of bounds

thread '__smelt_module_groupBy_test::test_data_last_groupby' (2131430) panicked at src/groupBy.rs:48:48:
index out of bounds
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `groupByProp_test`: `failed` - `test result: FAILED. 1 passed; 8 failed; 0 ignored; 0 measured; 1780 filtered out; finished in 0.01s`
...
test result: FAILED. 1 passed; 8 failed; 0 ignored; 0 measured; 1780 filtered out; finished in 0.01s


thread '__smelt_module_groupByProp_test::test_data_first_must_be_grouped_correctly_by_number' (2131445) panicked at src/groupByProp.rs:63:415:
index out of bounds
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '__smelt_module_groupByProp_test::test_data_last_must_be_grouped_correctly_by_number' (2131448) panicked at src/groupByProp.rs:63:415:
index out of bounds

thread '__smelt_module_groupByProp_test::test_grouping_value_is_a_key_of_object_prototype_issue_1049' (2131452) panicked at src/groupByProp.rs:63:415:
index out of bounds

thread '__smelt_module_groupByProp_test::test_data_first_must_be_grouped_correctly_by_string' (2131446) panicked at src/groupByProp.rs:63:415:
index out of bounds

thread '__smelt_module_groupByProp_test::test_data_last_must_be_grouped_correctly_by_string' (2131449) panicked at src/groupByProp.rs:63:415:
index out of bounds
Error: Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }
Error: Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }

thread '__smelt_module_groupByProp_test::test_handles_undefined_as_optional_elements' (2131453) panicked at src/groupByProp.rs:63:415:
index out of bounds
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `partition_test`: `failed` - `test result: FAILED. 0 passed; 6 failed; 0 ignored; 0 measured; 1783 filtered out; finished in 0.00s`
...
test result: FAILED. 0 passed; 6 failed; 0 ignored; 0 measured; 1783 filtered out; finished in 0.00s
...
- Status: `failed`
- Result: `test result: FAILED. 1566 passed; 223 failed; 0 ignored; 0 measured; 0 filtered out; finished in 32.00s`
- Failing tests: `223`
