...
2. **warning** `unused_parens` - 43 diagnostics
3. **warning** `unused_unsafe` - 22 diagnostics
4. **error** `E0308` - 20 diagnostics
5. **warning** `unused_assignments` - 16 diagnostics
6. **error** `E0057` - 3 diagnostics
7. **error** `E0369` - 1 diagnostic
8. **error** `E0599` - 1 diagnostic
...
3. **error** `E0308` - 20 occurrences
   ...
   - Examples:
     ...
     - `src/zip.rs:99`
     - `src/zip.rs:99`
4. **warning** `unused_parens` - 18 occurrences
...
8. **warning** `unused_parens` - 4 occurrences
   ...
   - Examples:
     ...
     - `src/funnel.rs:251`
     - `src/splitAt.rs:38`
9. **error** `E0057` - 3 occurrences
   - Message: this function takes 4 arguments but 1 argument was supplied
   - Examples:
     - `src/zipWith.rs:62`
     - `src/zipWith.rs:67`
     - `src/zipWith.rs:77`
...
24. **warning** `unused_parens` - 1 occurrence
...
error: could not compile `remeda_smelt_probe` (bin "remeda_smelt_probe") due to 25 previous errors; 183 warnings emitted
```
