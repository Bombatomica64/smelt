...
- `__smelt_module_dropFirstBy_test`: `passed` - `test result: ok. 12 passed; 0 failed; 0 ignored; 0 measured; 1777 filtered out; finished in 0.02s`
...
- Status: `failed`
- Result: `test result: FAILED. 1519 passed; 270 failed; 0 ignored; 0 measured; 0 filtered out; finished in 32.78s`
- Failing tests: `270`
...
- Baseline report: `blocker-logs/remeda-dropfirstby-continue-before.md`
- Resolved tests: `28`
