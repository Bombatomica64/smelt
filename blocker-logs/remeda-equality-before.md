...
```
- `isShallowEqual_test`: `failed` - `test result: FAILED. 11 passed; 7 failed; 0 ignored; 0 measured; 1771 filtered out; finished in 0.01s`

```text
__smelt_module_isShallowEqual_test::test_objects_sets_1252 --- FAILED
..... 12/18
...
test result: FAILED. 11 passed; 7 failed; 0 ignored; 0 measured; 1771 filtered out; finished in 0.01s
...
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `isStrictEqual_test`: `failed` - `test result: FAILED. 10 passed; 7 failed; 0 ignored; 0 measured; 1772 filtered out; finished in 0.00s`
...
- Status: `failed`
- Result: `test result: FAILED. 1565 passed; 224 failed; 0 ignored; 0 measured; 0 filtered out; finished in 36.35s`
- Failing tests: `224`
