...
- `__smelt_module_forEach_test`: `failed` - `test result: FAILED. 3 passed; 1 failed; 0 ignored; 0 measured; 1785 filtered out; finished in 0.00s`
...
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `__smelt_module_forEachObj_test`: `passed` - `test result: ok. 4 passed; 0 failed; 0 ignored; 0 measured; 1785 filtered out; finished in 0.00s`
