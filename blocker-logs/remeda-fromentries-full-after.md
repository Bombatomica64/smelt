...
- Status: `failed`
- Result: `test result: FAILED. 1518 passed; 271 failed; 0 ignored; 0 measured; 0 filtered out; finished in 15.83s`
- Failing tests: `271`
...
- Baseline report: `blocker-logs/remeda-dropfirstby-continue-after.md`
- Resolved tests: `11`
- Newly failing tests: `12`
...
- `__smelt_module_first_test::test_pipe_empty_array`
