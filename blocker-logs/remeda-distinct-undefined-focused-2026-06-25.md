...
- `isDeepEqual`: `passed` - `test result: ok. 73 passed; 0 failed; 0 ignored; 0 measured; 1716 filtered out; finished in 0.02s`
...
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `isNonNullish`: `passed` - `test result: ok. 2 passed; 0 failed; 0 ignored; 0 measured; 1787 filtered out; finished in 0.01s`
- `pullObject`: `failed` - `test result: FAILED. 7 passed; 9 failed; 0 ignored; 0 measured; 1773 filtered out; finished in 0.01s`

```text
    __smelt_module_pullObject_test::test_datalast_string_items
    __smelt_module_pullObject_test::test_datalast_undefined_values

test result: FAILED. 7 passed; 9 failed; 0 ignored; 0 measured; 1773 filtered out; finished in 0.01s

Error:
thread '__smelt_module_pullObject_test::test_datalast_guaranteed_to_run_on_each_item' (261854) panicked at src/pipe.rs:296:758:
unknown is not iterable
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }

thread '__smelt_module_pullObject_test::test_datalast_number_keys' (261857) panicked at src/pipe.rs:296:758:
unknown is not iterable

thread '__smelt_module_pullObject_test::test_datalast_last_value_wins' (261855) panicked at src/pipe.rs:296:758:
unknown is not iterable

thread '__smelt_module_pullObject_test::test_datalast_number_items' (261856) panicked at src/pipe.rs:296:758:
unknown is not iterable

thread '__smelt_module_pullObject_test::test_datalast_object_items' (261858) panicked at src/pipe.rs:296:758:
unknown is not iterable

thread '__smelt_module_pullObject_test::test_datalast_undefined_values' (261860) panicked at src/pipe.rs:296:758:
unknown is not iterable

thread '__smelt_module_pullObject_test::test_datalast_string_items' (261859) panicked at src/pipe.rs:296:758:
unknown is not iterable
...
- `isNot`: `failed` - `test result: FAILED. 1 passed; 1 failed; 0 ignored; 0 measured; 1787 filtered out; finished in 0.01s`
...
test result: FAILED. 1 passed; 1 failed; 0 ignored; 0 measured; 1787 filtered out; finished in 0.01s
