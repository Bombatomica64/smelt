...
- Baseline report: `blocker-logs/remeda-after-rvalue-closure-call-and-numeric-text-2026-06-05.md`
- Resolved tests: `0`
...
error: could not compile `remeda_smelt_probe` (bin "remeda_smelt_probe") due to 4 previous errors; 270 warnings emitted
```
