...
1. **warning** `unused_mut` - 102 diagnostics
...
1. **warning** `unused_mut` - 102 occurrences
...
error: could not compile `remeda_smelt_probe` (bin "remeda_smelt_probe") due to 18 previous errors; 185 warnings emitted
```
