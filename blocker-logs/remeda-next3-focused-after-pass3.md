...
thread '__smelt_module_ceil_test::test_data_first_case_1_should_throw_for_d_precision_49' (4009292) panicked at src/ceil.rs:13:1206:
precision must be an integer: inf
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '__smelt_module_ceil_test::test_data_first_should_throw_for_non_integer_precision_50' (4009295) panicked at src/ceil.rs:13:1206:
precision must be an integer: 21.37

thread '__smelt_module_ceil_test::test_data_first_case_0_should_throw_for_d_precision_48' (4009290) panicked at src/ceil.rs:13:1206:
precision must be an integer: NaN

thread '__smelt_module_ceil_test::test_data_first_should_throw_for_precision_higher_than_15_and_lower_than_15_51' (4009296) panicked at src/ceil.rs:13:1206:
precision must be between -15 and 15

thread '__smelt_module_ceil_test::test_data_first_should_throw_for_precision_higher_than_15_and_lower_than_15_51' (4009296) panicked at src/ceil.rs:13:1206:
precision must be between -15 and 15

thread '__smelt_module_ceil_test::test_data_last_case_0_should_throw_for_d_precision_58' (4009301) panicked at src/ceil.rs:13:1206:
precision must be an integer: NaN

thread '__smelt_module_ceil_test::test_data_last_case_1_should_throw_for_d_precision_59' (4009303) panicked at src/ceil.rs:13:1206:
precision must be an integer: inf

thread '__smelt_module_ceil_test::test_data_last_should_throw_for_non_integer_precision_60' (4009305) panicked at src/ceil.rs:13:1206:
precision must be an integer: 21.37

thread '__smelt_module_ceil_test::test_data_last_should_throw_for_precision_higher_than_15_and_lower_than_15_61' (4009306) panicked at src/ceil.rs:13:1206:
precision must be between -15 and 15
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
