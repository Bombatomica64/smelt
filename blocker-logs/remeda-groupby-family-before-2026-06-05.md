...
- `__smelt_module_groupByProp_test`: `failed` - `test result: FAILED. 1 passed; 8 failed; 0 ignored; 0 measured; 1780 filtered out; finished in 0.00s`
...
thread '__smelt_module_groupByProp_test::test_data_first_must_be_grouped_correctly_by_number' (3938716) panicked at src/groupByProp.rs:63:415:
index out of bounds
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '__smelt_module_groupByProp_test::test_data_last_must_be_grouped_correctly_by_number' (3938719) panicked at src/groupByProp.rs:63:415:
index out of bounds

thread '__smelt_module_groupByProp_test::test_grouping_value_is_a_key_of_object_prototype_issue_1049' (3938723) panicked at src/groupByProp.rs:63:415:
index out of bounds

thread '__smelt_module_groupByProp_test::test_data_last_must_be_grouped_correctly_by_string' (3938720) panicked at src/groupByProp.rs:63:415:
index out of bounds

thread '__smelt_module_groupByProp_test::test_data_first_must_be_grouped_correctly_by_string' (3938717) panicked at src/groupByProp.rs:63:415:
index out of bounds
Error: Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }
Error: Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }

thread '__smelt_module_groupByProp_test::test_handles_undefined_as_optional_elements' (3938724) panicked at src/groupByProp.rs:63:415:
index out of bounds
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `__smelt_module_groupBy_test`: `failed` - `test result: FAILED. 0 passed; 5 failed; 0 ignored; 0 measured; 1784 filtered out; finished in 0.00s`
...
thread '__smelt_module_groupBy_test::test_filtering_on_undefined_grouper_result_regular' (3938738) panicked at src/groupBy.rs:48:48:
index out of bounds
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '__smelt_module_groupBy_test::test_filtering_on_undefined_grouper_result_regular_indexed' (3938739) panicked at src/groupBy.rs:48:48:
index out of bounds

thread '__smelt_module_groupBy_test::test_data_first_groupby' (3938736) panicked at src/groupBy.rs:48:48:
index out of bounds

thread '__smelt_module_groupBy_test::test_key_is_an_object_instance_method_name_groupby' (3938740) panicked at src/groupBy.rs:48:48:
index out of bounds

thread '__smelt_module_groupBy_test::test_data_last_groupby' (3938737) panicked at src/groupBy.rs:48:48:
index out of bounds
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
...
- `__smelt_module_firstBy_test`: `passed` - `test result: ok. 22 passed; 0 failed; 0 ignored; 0 measured; 1767 filtered out; finished in 0.00s`
...
- Status: `failed`
- Result: `test result: FAILED. 1597 passed; 192 failed; 0 ignored; 0 measured; 0 filtered out; finished in 13.34s`
- Failing tests: `192`
...
- Baseline report: `blocker-logs/remeda-order-family-after-new-date-now-2026-06-05.md`
- Resolved tests: `0`
