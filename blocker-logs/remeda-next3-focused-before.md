...
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `__smelt_module_ceil_test`: `failed` - `test result: FAILED. 11 passed; 10 failed; 0 ignored; 0 measured; 1768 filtered out; finished in 0.00s`

```text
test result: FAILED. 11 passed; 10 failed; 0 ignored; 0 measured; 1768 filtered out; finished in 0.00s

Error: 
thread '__smelt_module_ceil_test::test_data_first_case_0_should_throw_for_d_precision_48' (3993685) panicked at src/ceil.rs:13:1206:
precision must be an integer: NaN
Customnote: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
 { kind: Other
thread '__smelt_module_ceil_test::test_data_first_case_1_should_throw_for_d_precision_49' (3993687) panicked at src/ceil.rs:13:1206:
precision must be an integer: inf
, error: "
thread '__smelt_module_ceil_test::test_data_first_should_throw_for_non_integer_precision_50' (3993690) panicked at src/ceil.rs:13:1206:
precision must be an integer: 21.37
expect(...).toBe(...) failed" }

thread '__smelt_module_ceil_test::test_data_first_should_throw_for_precision_higher_than_15_and_lower_than_15_51' (3993691) panicked at src/ceil.rs:13:1206:
precision must be between -15 and 15

thread '__smelt_module_ceil_test::test_data_last_case_0_should_throw_for_d_precision_58' (3993696) panicked at src/ceil.rs:13:1206:
precision must be an integer: NaN

thread '__smelt_module_ceil_test::test_data_last_should_throw_for_precision_higher_than_15_and_lower_than_15_61' (3993701) panicked at src/ceil.rs:13:1206:
precision must be between -15 and 15
Error: Custom
thread '__smelt_module_ceil_test::test_data_last_should_throw_for_non_integer_precision_60' (3993700) panicked at src/ceil.rs:13:1206:
precision must be an integer: 21.37
 { kind: Other, error: "expect(...).toBe(...) failed" }

thread '__smelt_module_ceil_test::test_data_last_case_1_should_throw_for_d_precision_59' (3993698) panicked at src/ceil.rs:13:1206:
precision must be an integer: inf
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
