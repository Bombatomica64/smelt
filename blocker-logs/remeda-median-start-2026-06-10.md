...
- `__smelt_module_median_test`: `failed` - `test result: FAILED. 2 passed; 4 failed; 0 ignored; 0 measured; 1783 filtered out; finished in 0.00s`

```text

running 6 tests
__smelt_module_median_test::test_datafirst_arrays_of_even_length --- FAILED
__smelt_module_median_test::test_datafirst_arrays_of_odd_length --- FAILED
. 3/6
__smelt_module_median_test::test_datalast_arrays_of_even_length --- FAILED
. 5/6
__smelt_module_median_test::test_datalast_arrays_of_odd_length --- FAILED
