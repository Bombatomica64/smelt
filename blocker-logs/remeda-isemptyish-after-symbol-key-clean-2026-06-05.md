...
thread '__smelt_module_isEmptyish_test::test_arrays_array_like_e_g_arguments' (274132) panicked at src/isEmptyish_test.rs:239:95:
expect(...).toBe(...) failed
...
- `__smelt_module_invert_test`: `failed` - `test result: FAILED. 10 passed; 1 failed; 0 ignored; 0 measured; 1778 filtered out; finished in 0.01s`

```text

running 11 tests
........ 8/11
__smelt_module_invert_test::test_data_first_symbol_values_are_fine --- FAILED
..
failures:
...
test result: FAILED. 10 passed; 1 failed; 0 ignored; 0 measured; 1778 filtered out; finished in 0.01s
...
- Status: `failed`
- Result: `test result: FAILED. 1619 passed; 170 failed; 0 ignored; 0 measured; 0 filtered out; finished in 15.64s`
- Failing tests: `170`
