...
- `__smelt_module_isEmptyish_test`: `failed` - `test result: FAILED. 27 passed; 4 failed; 0 ignored; 0 measured; 1758 filtered out; finished in 0.01s`
...
test result: FAILED. 27 passed; 4 failed; 0 ignored; 0 measured; 1758 filtered out; finished in 0.01s
...
- `__smelt_module_hasProp_test`: `failed` - `test result: FAILED. 15 passed; 1 failed; 0 ignored; 0 measured; 1773 filtered out; finished in 0.01s`

```text

running 16 tests
............. 13/16
__smelt_module_hasProp_test::test_returns_false_for_properties_only_on_a_custom_prototype --- FAILED
..
failures:

failures:
    __smelt_module_hasProp_test::test_returns_false_for_properties_only_on_a_custom_prototype

test result: FAILED. 15 passed; 1 failed; 0 ignored; 0 measured; 1773 filtered out; finished in 0.01s
...
- Status: `failed`
- Result: `test result: FAILED. 1624 passed; 165 failed; 0 ignored; 0 measured; 0 filtered out; finished in 20.52s`
- Failing tests: `165`
...
| 4 | `__smelt_module_isEmptyish_test` |
