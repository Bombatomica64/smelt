...
- `__smelt_module_filter_test`: `failed` - `test result: FAILED. 3 passed; 3 failed; 0 ignored; 0 measured; 1783 filtered out; finished in 0.01s`
...
test result: FAILED. 3 passed; 3 failed; 0 ignored; 0 measured; 1783 filtered out; finished in 0.01s
...
```
- `__smelt_module_zipWith_test`: `failed` - `test result: FAILED. 3 passed; 6 failed; 0 ignored; 0 measured; 1780 filtered out; finished in 0.01s`

```text
__smelt_module_zipWith_test::test_data_second_with_initial_arg_should_truncate_to_shorter_first --- FAILED
__smelt_module_zipWith_test::test_data_second_with_initial_arg_should_truncate_to_shorter_second --- FAILED
...
test result: FAILED. 3 passed; 6 failed; 0 ignored; 0 measured; 1780 filtered out; finished in 0.01s

Error: Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }
Error: Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }
Error: 
thread '__smelt_module_zipWith_test::test_data_second_with_initial_arg_should_truncate_to_shorter_first' (1611461) panicked at src/zipWith.rs:37:42:
optional value was absent after narrowing
Customnote: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
 { kind: Other, error: "expect(...).toStrictEqual(...) failed" }

thread '__smelt_module_zipWith_test::test_data_second_with_initial_arg_should_truncate_to_shorter_second' (1611462) panicked at src/zipWith.rs:37:42:
optional value was absent after narrowing

thread '__smelt_module_zipWith_test::test_data_second_with_initial_arg_should_zip_with_predicate' (1611463) panicked at src/zipWith.rs:37:42:
optional value was absent after narrowing
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `__smelt_module_constant_test`: `failed` - `test result: FAILED. 4 passed; 3 failed; 0 ignored; 0 measured; 1782 filtered out; finished in 0.01s`
...
test result: FAILED. 4 passed; 3 failed; 0 ignored; 0 measured; 1782 filtered out; finished in 0.01s
...
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `__smelt_module_identity_test`: `failed` - `test result: FAILED. 2 passed; 3 failed; 0 ignored; 0 measured; 1784 filtered out; finished in 0.00s`

```text

running 5 tests
. 1/5
__smelt_module_identity_test::test_works_with_more_than_one_argument_732 --- FAILED
__smelt_module_identity_test::test_works_731 --- FAILED
. 4/5
...
test result: FAILED. 2 passed; 3 failed; 0 ignored; 0 measured; 1784 filtered out; finished in 0.00s
...
- `__smelt_module_sumBy_test`: `passed` - `test result: ok. 8 passed; 0 failed; 0 ignored; 0 measured; 1781 filtered out; finished in 0.01s`
