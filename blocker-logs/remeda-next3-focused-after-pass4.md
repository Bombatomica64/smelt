...
```
- `__smelt_module_ceil_test`: `failed` - `test result: FAILED. 17 passed; 4 failed; 0 ignored; 0 measured; 1768 filtered out; finished in 0.00s`

```text


thread '__smelt_module_ceil_test::test_data_first_should_throw_for_non_integer_precision_50' (4014920) panicked at src/ceil.rs:13:1206:
precision must be an integer: 21.37
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '__smelt_module_ceil_test::test_data_first_should_throw_for_precision_higher_than_15_and_lower_than_15_51' (4014921) panicked at src/ceil.rs:13:1206:
precision must be between -15 and 15

thread '__smelt_module_ceil_test::test_data_first_case_0_should_throw_for_d_precision_48' (4014915) panicked at src/ceil.rs:13:1206:
precision must be an integer: NaN

thread '__smelt_module_ceil_test::test_data_first_case_1_should_throw_for_d_precision_49' (4014917) panicked at src/ceil.rs:13:1206:
precision must be an integer: inf

thread '__smelt_module_ceil_test::test_data_first_should_throw_for_precision_higher_than_15_and_lower_than_15_51' (4014921) panicked at src/ceil.rs:13:1206:
precision must be between -15 and 15

thread '__smelt_module_ceil_test::test_data_last_case_1_should_throw_for_d_precision_59' (4014928) panicked at src/ceil.rs:13:1206:
precision must be an integer: inf

thread '__smelt_module_ceil_test::test_data_last_case_0_should_throw_for_d_precision_58' (4014926) panicked at src/ceil.rs:13:1206:
precision must be an integer: NaN

thread '__smelt_module_ceil_test::test_data_last_should_throw_for_non_integer_precision_60' (4014930) panicked at src/ceil.rs:13:1206:
precision must be an integer: 21.37

thread '__smelt_module_ceil_test::test_data_last_should_throw_for_precision_higher_than_15_and_lower_than_15_61' (4014931) panicked at src/ceil.rs:13:1206:
precision must be between -15 and 15
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
