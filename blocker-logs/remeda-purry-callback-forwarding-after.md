...
- `filter_test`: `failed` - `test result: FAILED. 5 passed; 1 failed; 0 ignored; 0 measured; 1783 filtered out; finished in 0.01s`
...
test result: FAILED. 5 passed; 1 failed; 0 ignored; 0 measured; 1783 filtered out; finished in 0.01s

Error: Custom { kind: Other, error: "expect(...).toStrictEqual(...) failed" }
error: test failed, to rerun pass `--bin remeda_smelt_probe`
```
- `map_test`: `failed` - `test result: FAILED. 11 passed; 1 failed; 0 ignored; 0 measured; 1777 filtered out; finished in 0.01s`

```text

running 12 tests
.......... 10/12
__smelt_module_map_test::test_pipe_indexed_check_index_and_items --- FAILED
.
failures:
...
test result: FAILED. 11 passed; 1 failed; 0 ignored; 0 measured; 1777 filtered out; finished in 0.01s
...
- `identity_test`: `passed` - `test result: ok. 5 passed; 0 failed; 0 ignored; 0 measured; 1784 filtered out; finished in 0.01s`

## Full Suite

- Status: `failed`
- Result: `test result: FAILED. 1550 passed; 239 failed; 0 ignored; 0 measured; 0 filtered out; finished in 19.08s`
- Failing tests: `239`
...
- Baseline report: `blocker-logs/remeda-purry-pipe-after-mapped.md`
- Resolved tests: `0`
