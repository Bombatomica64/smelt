...
- Status: `failed`
- Result: `test result: FAILED. 1718 passed; 71 failed; 0 ignored; 0 measured; 0 filtered out; finished in 8.33s`
- Failing tests: `71`
...
- Baseline report: `blocker-logs/remeda-full-current-2026-06-22.md`
- Resolved tests: `4`
