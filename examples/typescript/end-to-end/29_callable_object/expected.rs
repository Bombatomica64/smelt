...
#[allow(dead_code)]
struct Counter {
    bump: ::std::rc::Rc<dyn Fn() -> f64>,
    current: ::std::rc::Rc<dyn Fn() -> f64>,
    reset: ::std::rc::Rc<dyn Fn() -> ()>,
    __smelt_call: ::std::rc::Rc<dyn Fn() -> f64>,
}
impl Default for Counter {
    fn default() -> Self {
        Self {
            bump: { let smelt_default_callback: ::std::rc::Rc<dyn Fn() -> f64> = ::std::rc::Rc::new(move || -> f64 { 0.0 }); smelt_default_callback },
            current: { let smelt_default_callback: ::std::rc::Rc<dyn Fn() -> f64> = ::std::rc::Rc::new(move || -> f64 { 0.0 }); smelt_default_callback },
            reset: { let smelt_default_callback: ::std::rc::Rc<dyn Fn() -> ()> = ::std::rc::Rc::new(move || -> () { () }); smelt_default_callback },
            __smelt_call: { let smelt_default_callback: ::std::rc::Rc<dyn Fn() -> f64> = ::std::rc::Rc::new(move || -> f64 { 0.0 }); smelt_default_callback },
        }
    }
}
impl ::std::fmt::Debug for Counter {
    fn fmt(&self, formatter: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        formatter.debug_struct("Counter").finish_non_exhaustive()
    }
}
impl IntoSmeltUnknown for Counter {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        SmeltUnknown::Object(SmeltObject::new(Vec::from([
        ("bump".to_owned(), SmeltUnknown::Null),
        ("current".to_owned(), SmeltUnknown::Null),
        ("reset".to_owned(), SmeltUnknown::Null),
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let _smelt_tmp_1: Counter = make_counter();
    c = _smelt_tmp_1;
    _smelt_tmp_2 = (c.bump.clone())();
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_2)); };
    _smelt_tmp_4 = (c.bump.clone())();
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_4)); };
    _smelt_tmp_6 = (c.current.clone())();
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_6)); };
    _smelt_tmp_8 = (c.reset.clone())();
    _smelt_tmp_9 = (c.current.clone())();
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_9)); };
    _smelt_tmp_11 = (c.bump.clone())();
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_11)); };
    return Ok(());
}
...
pub(crate) fn make_counter() -> Counter {
    let smelt_capture_count: ::std::rc::Rc<::std::cell::RefCell<f64>> = ::std::rc::Rc::new(::std::cell::RefCell::new(0.0));
    let _smelt_tmp_6 = ::std::rc::Rc::new({
    let smelt_capture_count = smelt_capture_count.clone();
    move || {
    (*smelt_capture_count.borrow())
    }
});
    let counter_1 = _smelt_tmp_6.clone();
    let _smelt_tmp_7 = ::std::rc::Rc::new({
    let smelt_capture_count = smelt_capture_count.clone();
    move || {
    let _smelt_tmp_1: f64 = (*smelt_capture_count.borrow()) + 1.0;
    (*smelt_capture_count.borrow_mut()) = _smelt_tmp_1;
    (*smelt_capture_count.borrow())
    }
});
    let __smelt_callable_prop = _smelt_tmp_7.clone();
    ...
    let __smelt_callable_prop_1 = _smelt_tmp_8.clone();
    let _smelt_tmp_9 = ::std::rc::Rc::new({
    let smelt_capture_count = smelt_capture_count.clone();
    move || {
    (*smelt_capture_count.borrow_mut()) = 0.0;
    ()
    }
});
    let __smelt_callable_prop_2 = _smelt_tmp_9.clone();
    let _smelt_tmp_10: Counter = Counter { bump: __smelt_callable_prop.clone(), current: __smelt_callable_prop_1.clone(), reset: __smelt_callable_prop_2.clone(), __smelt_call: counter_1.clone() };
