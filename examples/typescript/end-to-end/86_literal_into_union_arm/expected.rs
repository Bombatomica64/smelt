...
pub(crate) fn total(rows: SmeltUnion7) -> String {
    ...
    row = _smelt_tmp_6.borrow().get({ let normalized = _smelt_tmp_7 as i64; usize::try_from(normalized).unwrap_or(usize::MAX) }).cloned().unwrap_or_else(|| (0.0, 0.0));
