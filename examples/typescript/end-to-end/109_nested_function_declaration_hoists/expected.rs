...
fn main() {
    let _smelt_tmp_0: f64 = scaled(2.0);
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_0)); };
    let _smelt_tmp_2: f64 = count_up(0.0);
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_2)); };
    let _smelt_tmp_4: f64 = count_up_hoisted(1.0);
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_4)); };
    let _smelt_tmp_6: String = pick_label(true);
    let _ = { println!("{}", _smelt_tmp_6); };
    let _smelt_tmp_8: String = pick_label(false);
...
pub(crate) fn scaled(base: f64) -> f64 {
    let scale: f64 = 3.0;
    let _smelt_tmp_3 = ::std::rc::Rc::new({
    let scale = scale.clone();
    move |closure_arg_0: f64| {
    let _smelt_tmp_2: f64 = closure_arg_0 * scale;
    _smelt_tmp_2
    }
});
    let step = _smelt_tmp_3.clone();
    let _smelt_tmp_4: f64 = (step)(base);
    return _smelt_tmp_4;
}

pub(crate) fn count_up(base: f64) -> f64 {
    let smelt_capture_walk: ::std::rc::Rc<::std::cell::RefCell<::std::rc::Rc<dyn Fn(f64) -> f64>>> = ::std::rc::Rc::new(::std::cell::RefCell::new({ let smelt_default_callback: ::std::rc::Rc<dyn Fn(f64) -> f64> = ::std::rc::Rc::new(move |arg0: f64| -> f64 { 0.0 }); smelt_default_callback }));
    let limit: f64 = 3.0;
    let _smelt_tmp_3 = ::std::rc::Rc::new({
    ...
    let _smelt_tmp_3: bool = closure_arg_0 >= limit;
    if _smelt_tmp_3 {
    closure_arg_0
    } else {
    _smelt_tmp_4 = closure_arg_0 + 1.0;
    _smelt_tmp_5 = ((*smelt_capture_walk.upgrade().expect("self-recursive closure called after its defining scope returned").borrow()))(_smelt_tmp_4);
    _smelt_tmp_5
    }
    }
});
    (*smelt_capture_walk.borrow_mut()) = _smelt_tmp_3.clone();
    let _smelt_tmp_4: f64 = { let smelt_callable = ::std::clone::Clone::clone(&(*smelt_capture_walk.borrow())); (smelt_callable)(base) };
    return _smelt_tmp_4;
}

pub(crate) fn count_up_hoisted(base: f64) -> f64 {
    let smelt_capture_climb: ::std::rc::Rc<::std::cell::RefCell<::std::rc::Rc<dyn Fn(f64) -> f64>>> = ::std::rc::Rc::new(::std::cell::RefCell::new({ let smelt_default_callback: ::std::rc::Rc<dyn Fn(f64) -> f64> = ::std::rc::Rc::new(move |arg0: f64| -> f64 { 0.0 }); smelt_default_callback }));
    let limit: f64 = 4.0;
    let _smelt_tmp_3 = ::std::rc::Rc::new({
    let smelt_capture_climb = ::std::rc::Rc::downgrade(&smelt_capture_climb);
    let limit = limit.clone();
    move |closure_arg_0: f64| {
    let _smelt_tmp_4: f64;
    let _smelt_tmp_5: f64;
    ...
    _smelt_tmp_4 = closure_arg_0 + 1.0;
    _smelt_tmp_5 = ((*smelt_capture_climb.upgrade().expect("self-recursive closure called after its defining scope returned").borrow()))(_smelt_tmp_4);
    _smelt_tmp_5
    }
    }
});
    (*smelt_capture_climb.borrow_mut()) = _smelt_tmp_3.clone();
    let _smelt_tmp_4: f64 = { let smelt_callable = ::std::clone::Clone::clone(&(*smelt_capture_climb.borrow())); (smelt_callable)(base) };
    return _smelt_tmp_4;
}

pub(crate) fn pick_label(flag: bool) -> String {
    let decorate: ::std::rc::Rc<dyn Fn(String) -> String>;
    let mut _smelt_tmp_2: ::std::rc::Rc<dyn Fn(String) -> String> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> String> = ::std::rc::Rc::new(move |arg0: String| -> String { String::new() }); smelt_default_callback };
    let _smelt_tmp_3: String;
    if flag {
    _smelt_tmp_2 = ::std::rc::Rc::new(|closure_arg_0: String| {
    let _smelt_tmp_1: String = "[".to_owned() + &closure_arg_0.clone();
    let _smelt_tmp_2: String = _smelt_tmp_1.clone() + &"]".to_owned();
    _smelt_tmp_2.clone()
    });
    decorate = _smelt_tmp_2.clone();
    _smelt_tmp_3 = (decorate)("on".to_owned());
    return _smelt_tmp_3;
    } else {
    return "off".to_owned();
    }
