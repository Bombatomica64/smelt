...
#[allow(dead_code)]
struct Ticker(::std::rc::Rc<::std::cell::RefCell<TickerInner>>);
...
impl Default for Ticker {
    fn default() -> Self {
        Ticker(::std::rc::Rc::new(::std::cell::RefCell::new(TickerInner::default())))
    }
}
...
impl IntoSmeltUnknown for Ticker {
    fn into_smelt_unknown(self) -> SmeltUnknown {
...
impl IntoSmeltUnknown for Labeller {
    fn into_smelt_unknown(self) -> SmeltUnknown {
...
impl SmeltFromUnknown for Labeller {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self {
...
impl IntoSmeltUnknown for Sizer {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        SmeltUnknown::Object(SmeltObject::new(Vec::from([
        ])))
    }
}
impl SmeltFromUnknown for Sizer {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self {
        let mut result = Self::default();
        if let SmeltUnknown::Object(object) = value {
        }
...
fn main() {
    ...
    let _smelt_tmp_3: Ticker = Ticker::new();
    ticker = _smelt_tmp_3;
    let _ = ticker.bump("ab".to_owned());
    _smelt_tmp_5 = smelt_number_to_string(ticker.0.borrow().count.clone());
    _smelt_tmp_6 = "void method: ".to_owned() + &_smelt_tmp_5;
    let _ = { println!("{}", _smelt_tmp_6); };
    let _smelt_tmp_8: Labeller = Labeller::new();
    labeller = _smelt_tmp_8;
    let _smelt_tmp_9: String = labeller.bump("!".to_owned());
    _smelt_tmp_10 = "value method: ".to_owned() + &_smelt_tmp_9;
    let _ = { println!("{}", _smelt_tmp_10); };
    let _smelt_tmp_12: String = labeller.bump("?".to_owned());
    held = _smelt_tmp_12;
    _smelt_tmp_13 = "bound value: ".to_owned() + &held;
    let _ = { println!("{}", _smelt_tmp_13); };
    let _smelt_tmp_15: String = labeller.describe(3.0);
    _smelt_tmp_16 = "same name, other params: ".to_owned() + &_smelt_tmp_15;
    let _ = { println!("{}", _smelt_tmp_16); };
    let _smelt_tmp_18: Sizer = Sizer::new();
    let _smelt_tmp_19: f64 = _smelt_tmp_18.describe("abcd".to_owned());
    _smelt_tmp_20 = smelt_number_to_string(_smelt_tmp_19);
    _smelt_tmp_21 = "other class: ".to_owned() + &_smelt_tmp_20;
...
impl Ticker {
    fn new() -> Self {
    let mut this: Self = Ticker(::std::rc::Rc::new(::std::cell::RefCell::new(TickerInner { count: 0.0 })));
    this.0.borrow_mut().count = 0.0;
    return this;
    }
    fn bump(&self, key: String) -> () {
    let _smelt_tmp_2: f64 = key.chars().count() as f64;
    let _smelt_tmp_3: f64 = self.0.borrow().count.clone() + _smelt_tmp_2;
    self.0.borrow_mut().count = _smelt_tmp_3;
    return;
    }
    ...
    fn __smelt_proto_entries(&self) -> Vec<(String, SmeltUnknown)> {
        ...
        smelt_proto_entries.push(("__smelt_method:bump".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.bump(SmeltFromUnknown::smelt_from_unknown(smelt_args.get(0).cloned().unwrap_or(SmeltUnknown::Undefined))); Ok({ let () = smelt_result; SmeltUnknown::Undefined }) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Ticker::bump")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries
    }
}
...
impl Labeller {
    fn new() -> Self {
    let mut this: Self = Labeller { label: String::new() };
    this.label = "labelled".to_owned();
    return this;
    }
    fn bump(&self, key: String) -> String {
    let _smelt_tmp_2: String = self.label.clone() + &key.clone();
    return _smelt_tmp_2;
    }
    fn describe(&self, size: f64) -> String {
    let _smelt_tmp_2: String = self.label.clone() + &"/".to_owned();
    let _smelt_tmp_3: String = smelt_number_to_string(size);
    let _smelt_tmp_4: String = _smelt_tmp_2 + &_smelt_tmp_3;
    return _smelt_tmp_4;
    }
    /// Prototype-carried members of this class, as receiver-bound erased functions.
    ///
    ...
    fn __smelt_proto_entries(&self) -> Vec<(String, SmeltUnknown)> {
        let mut smelt_proto_entries: Vec<(String, SmeltUnknown)> = Vec::new();
        smelt_proto_entries.push(("__smelt_method:bump".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.bump(SmeltFromUnknown::smelt_from_unknown(smelt_args.get(0).cloned().unwrap_or(SmeltUnknown::Undefined))); Ok(SmeltUnknown::String(smelt_result.into())) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Labeller::bump")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries.push(("__smelt_method:describe".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.describe(SmeltFromUnknown::smelt_from_unknown(smelt_args.get(0).cloned().unwrap_or(SmeltUnknown::Undefined))); Ok(SmeltUnknown::String(smelt_result.into())) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Labeller::describe")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries
    }
}
...
impl Sizer {
    ...
    fn describe(&self, text: String) -> f64 {
    let _smelt_tmp_2: f64 = text.chars().count() as f64;
    return _smelt_tmp_2;
    }
    /// Prototype-carried members of this class, as receiver-bound erased functions.
    ///
    ...
    fn __smelt_proto_entries(&self) -> Vec<(String, SmeltUnknown)> {
        let mut smelt_proto_entries: Vec<(String, SmeltUnknown)> = Vec::new();
        smelt_proto_entries.push(("__smelt_method:describe".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.describe(SmeltFromUnknown::smelt_from_unknown(smelt_args.get(0).cloned().unwrap_or(SmeltUnknown::Undefined))); Ok(SmeltUnknown::Number(smelt_result as f64)) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Sizer::describe")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries
    }
}
