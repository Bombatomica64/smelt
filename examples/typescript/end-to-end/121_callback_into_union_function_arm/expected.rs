...
impl IntoSmeltUnknown for Ex {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        SmeltUnknown::Object(SmeltObject::new(Vec::from([
        ("code".to_owned(), SmeltUnknown::Number(self.code as f64)),
        ])))
    }
}
impl SmeltFromUnknown for Ex {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self {
        let mut result = Self::default();
        if let SmeltUnknown::Object(object) = value {
            if let Some(field) = object.get("code") {
                result.code = SmeltFromUnknown::smelt_from_unknown(field);
            }
        }
        result
    }
...
pub enum SmeltUnion4 {
    M0(Ex),
    M1(::std::rc::Rc<dyn Fn(String) -> Ex>),
}
impl IntoSmeltUnknown for SmeltUnion4 {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        match self {
            Self::M0(value) => { let smelt_object_value = value; let smelt_struct_value = smelt_object_value.clone(); let mut smelt_object_entries = Vec::new(); smelt_object_entries.push(("code".to_owned(), SmeltUnknown::Number(smelt_object_value.code as f64))); smelt_object_entries.push(("__smelt_class".to_owned(), SmeltUnknown::String("Ex".into()))); SmeltUnknown::Object(SmeltObject::new(smelt_object_entries)) },
            Self::M1(value) => { let smelt_function_value = value; if let Some(smelt_callable_object) = smelt_lookup_callable_object(&smelt_function_value) { smelt_callable_object } else { let smelt_origin_identity = smelt_canonical_function_identity(&smelt_function_value); let smelt_function_origin = smelt_function_value.clone(); let smelt_erased_function: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new(move |smelt_args: Vec<SmeltUnknown>| Ok::<SmeltUnknown, Box<dyn std::error::Error>>({ let smelt_object_value = (smelt_function_value)(match smelt_args.get(0).cloned().unwrap_or(SmeltUnknown::Null).clone() { SmeltUnknown::String(value) | SmeltUnknown::Symbol(value) => value.to_string(), SmeltUnknown::Number(value) => smelt_number_to_string(value), SmeltUnknown::Bool(value) => value.to_string(), SmeltUnknown::Null | SmeltUnknown::Undefined => String::new(), SmeltUnknown::Array(_) | SmeltUnknown::Object(_) => "[object Object]".to_owned(), SmeltUnknown::Function(_) => "function () { [native code] }".to_owned(), SmeltUnknown::Promise(_) => "[object Promise]".to_owned() }); let smelt_struct_value = smelt_object_value.clone(); let mut smelt_object_entries = Vec::new(); smelt_object_entries.push(("code".to_owned(), SmeltUnknown::Number(smelt_object_value.code as f64))); smelt_object_entries.push(("__smelt_class".to_owned(), SmeltUnknown::String("Ex".into()))); SmeltUnknown::Object(SmeltObject::new(smelt_object_entries)) })); smelt_register_function_origin(&smelt_erased_function, smelt_function_origin); smelt_link_function_identity_key(&smelt_erased_function, smelt_origin_identity); SmeltUnknown::Function(smelt_erased_function) } },
        }
    }
}
impl SmeltUnion4 {
    fn from_smelt_unknown(value: SmeltUnknown) -> Self {
        if matches!(value, SmeltUnknown::Object(_)) { return Self::M0(Default::default()); }
        Self::M1({ let smelt_source_value = value.clone(); let smelt_function = match smelt_source_value.clone() { SmeltUnknown::Function(smelt_function) => Some(smelt_function), SmeltUnknown::Object(smelt_object) => match smelt_object.get("__smelt_call") { Some(SmeltUnknown::Function(smelt_function)) => Some(smelt_function), _ => None }, _ => None }; if let Some(smelt_function) = smelt_function { let smelt_origin_identity = smelt_canonical_function_identity(&smelt_function); let smelt_callback: ::std::rc::Rc<dyn Fn(String) -> Ex> = if let Some(smelt_original) = smelt_restore_function_origin::<::std::rc::Rc<dyn Fn(String) -> Ex>>(&smelt_function) { smelt_original } else { ::std::rc::Rc::new(move |arg0: String| -> Ex { let smelt_result = (smelt_function)({ let mut smelt_call_args = Vec::new(); smelt_call_args.push(SmeltUnknown::String(arg0.into())); smelt_call_args }).unwrap_or_else(|error| smelt_panic_throw(error)); Default::default() }) }; smelt_register_callable_object(&smelt_callback, smelt_source_value); smelt_link_function_identity_key(&smelt_callback, smelt_origin_identity); smelt_callback } else { { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> Ex> = ::std::rc::Rc::new(move |arg0: String| -> Ex { Default::default() }); smelt_default_callback } } })
    }
}
...
fn main() {
    let e500: ::std::rc::Rc<dyn Fn(String) -> Ex>;
    let mut _smelt_tmp_3: ::std::rc::Rc<dyn Fn() -> Ex> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn() -> Ex> = ::std::rc::Rc::new(move || -> Ex { Default::default() }); smelt_default_callback };
    let mut _smelt_tmp_6: ::std::rc::Rc<dyn Fn(String) -> Ex> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> Ex> = ::std::rc::Rc::new(move |arg0: String| -> Ex { Default::default() }); smelt_default_callback };
    let _smelt_tmp_1: f64 = timeout__module_main(1.0, None::<SmeltUnion4>);
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_1)); };
    _smelt_tmp_3 = ::std::rc::Rc::new(|| {
    let _smelt_tmp_0: Ex = Ex::new(408.0);
    _smelt_tmp_0.clone()
    });
    let _smelt_tmp_4: f64 = timeout__module_main(2.0, Some(SmeltUnion4::M1({ let smelt_callback = _smelt_tmp_3.clone(); let smelt_adapted: ::std::rc::Rc<dyn Fn(String) -> Ex> = ::std::rc::Rc::new(move |arg0: String| (smelt_callback)()); smelt_adapted })));
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_4)); };
    _smelt_tmp_6 = ::std::rc::Rc::new(|closure_arg_0: String| {
    let _smelt_tmp_1: f64 = closure_arg_0.chars().count() as f64;
    let _smelt_tmp_2: f64 = 500.0 + _smelt_tmp_1;
    let _smelt_tmp_3: Ex = Ex::new(_smelt_tmp_2);
    _smelt_tmp_3.clone()
    });
    e500 = _smelt_tmp_6.clone();
    let _smelt_tmp_7: f64 = timeout__module_main(3.0, Some(SmeltUnion4::M1(e500)));
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_7)); };
    let _smelt_tmp_9: Ex = Ex::new(1.0);
    let _smelt_tmp_10: f64 = timeout__module_main(4.0, Some(SmeltUnion4::M0(_smelt_tmp_9)));
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_10)); };
    return;
}

impl Ex {
    fn new(code: f64) -> Self {
    let mut this: Self = Ex { code: 0.0 };
    this.code = code;
    return this;
    }
}
...
pub(crate) fn timeout__module_main(duration: f64, exception: Option<SmeltUnion4>) -> f64 {
    let exception_1: SmeltUnion4;
    let ex: Ex;
    let _smelt_tmp_5: SmeltUnion4;
    let _smelt_tmp_6: bool;
    let mut _smelt_tmp_7: Ex;
    let mut _smelt_tmp_8: ::std::rc::Rc<dyn Fn(String) -> Ex> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> Ex> = ::std::rc::Rc::new(move |arg0: String| -> Ex { Default::default() }); smelt_default_callback };
    let _smelt_tmp_9: Ex;
    let _smelt_tmp_10: Ex;
    let _smelt_tmp_11: f64;
    let _smelt_tmp_4: Ex = Ex::new(504.0);
    _smelt_tmp_5 = exception.clone().map_or_else(|| SmeltUnion4::M0(_smelt_tmp_4), |value| value);
    exception_1 = _smelt_tmp_5;
    _smelt_tmp_6 = matches!(exception_1.clone(), SmeltUnion4::M1(_));
    let mut _smelt_tmp_7: Ex = Default::default();
    if _smelt_tmp_6 {
    _smelt_tmp_8 = (match exception_1 { SmeltUnion4::M1(value) => value, _ => unreachable!("union guard selected an excluded member") }).clone();
    _smelt_tmp_9 = (_smelt_tmp_8)("ctx".to_owned());
    _smelt_tmp_7 = _smelt_tmp_9;
    } else {
    _smelt_tmp_10 = match exception_1 { SmeltUnion4::M0(value) => value, _ => unreachable!("union guard selected an excluded member") };
    _smelt_tmp_7 = _smelt_tmp_10;
    }
    ex = _smelt_tmp_7;
    _smelt_tmp_11 = duration + ex.code;
