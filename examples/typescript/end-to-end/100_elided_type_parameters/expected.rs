...
impl IntoSmeltUnknown for Route {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        SmeltUnknown::Object(SmeltObject::new(Vec::from([
        ("path".to_owned(), SmeltUnknown::String(self.path.into())),
        ])))
    }
}
impl SmeltFromUnknown for Route {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self {
        let mut result = Self::default();
        if let SmeltUnknown::Object(object) = value {
            if let Some(field) = object.get("path") {
                result.path = SmeltFromUnknown::smelt_from_unknown(field);
            }
        }
        result
    }
...
#[allow(dead_code)]
struct Session(::std::rc::Rc<::std::cell::RefCell<SessionInner>>);
#[allow(dead_code)]
struct SessionInner {
    name: String,
    renew: Option<::std::rc::Rc<dyn Fn(Session) -> String>>,
}
impl Default for SessionInner {
    fn default() -> Self {
        Self {
            name: String::new(),
            renew: None::<::std::rc::Rc<dyn Fn(Session) -> String>>,
        }
    }
}
impl ::std::fmt::Debug for SessionInner {
    fn fmt(&self, formatter: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        formatter.debug_struct("SessionInner").finish_non_exhaustive()
    }
}
impl Clone for Session {
    fn clone(&self) -> Self {
        Session(::std::rc::Rc::clone(&self.0))
    }
}
...
impl Default for Session {
    fn default() -> Self {
        Session(::std::rc::Rc::new(::std::cell::RefCell::new(SessionInner::default())))
    }
}
...
impl IntoSmeltUnknown for Session {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        ...
        ("renew".to_owned(), __smelt_inner.renew.clone().map_or(SmeltUnknown::Undefined, |value| SmeltUnknown::Null)),
        ]);
...
struct Pair<Carried> {
    left: Cell<Carried>,
    right: Route,
    _smelt_phantom: ::std::marker::PhantomData<(Carried)>,
}
impl<Carried: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> Default for Pair<Carried> where Cell<Carried>: Default {
    fn default() -> Self {
        Self {
...
impl<Carried> ::std::fmt::Debug for Pair<Carried> {
    fn fmt(&self, formatter: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        formatter.debug_struct("Pair").finish_non_exhaustive()
    }
}
impl<Carried> Clone for Pair<Carried> where Cell<Carried>: Clone {
    fn clone(&self) -> Self {
        Pair {
...
impl<Carried> PartialEq for Pair<Carried> where Cell<Carried>: PartialEq {
    fn eq(&self, other: &Self) -> bool {
        self.left == other.left && self.right == other.right
    }
}
impl<Carried: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> IntoSmeltUnknown for Pair<Carried> {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        SmeltUnknown::Object(SmeltObject::new(Vec::from([
        ("left".to_owned(), (self.left).into_smelt_unknown()),
        ("right".to_owned(), (self.right).into_smelt_unknown()),
        ])))
    }
}
impl<Carried: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> SmeltFromUnknown for Pair<Carried> {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self {
        let mut result = Self::default();
        if let SmeltUnknown::Object(object) = value {
            ...
            if let Some(field) = object.get("right") {
                result.right = SmeltFromUnknown::smelt_from_unknown(field);
            }
        }
        result
    }
...
fn main() {
    ...
    let pair: Pair<f64>;
    let mut _smelt_tmp_8: ::std::rc::Rc<dyn Fn(Session) -> String> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(Session) -> String> = ::std::rc::Rc::new(move |arg0: Session| -> String { String::new() }); smelt_default_callback };
    let mut _smelt_tmp_11: ::std::rc::Rc<dyn Fn(Session) -> String> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(Session) -> String> = ::std::rc::Rc::new(move |arg0: Session| -> String { String::new() }); smelt_default_callback };
    let _smelt_tmp_12: String;
    let _smelt_tmp_19: f64;
    let _smelt_tmp_21: Route;
    let _smelt_tmp_4: Route = Route::new("/users".to_owned());
    route = _smelt_tmp_4;
    let _smelt_tmp_5: String = route.describe();
    let _ = { println!("{}", _smelt_tmp_5); };
    let _smelt_tmp_7: Session = Session::new("s1".to_owned());
    session = _smelt_tmp_7;
    _smelt_tmp_8 = ::std::rc::Rc::new(|closure_arg_0: Session| {
    let _smelt_tmp_1: String = "renewed ".to_owned() + &closure_arg_0.0.borrow().name.clone().clone();
    _smelt_tmp_1.clone()
    });
    session.0.borrow_mut().renew = Some(_smelt_tmp_8.clone());
    let _smelt_tmp_9: String = session.label();
    let _ = { println!("{}", _smelt_tmp_9); };
    _smelt_tmp_11 = session.0.borrow().renew.clone().clone().unwrap_or({ let smelt_default_callback: ::std::rc::Rc<dyn Fn(Session) -> String> = ::std::rc::Rc::new(move |arg0: Session| -> String { String::new() }); smelt_default_callback });
    _smelt_tmp_12 = (_smelt_tmp_11)(session);
    let _ = { println!("{}", _smelt_tmp_12); };
    let _smelt_tmp_14: Cell<String> = Cell::new("held".to_owned());
    cell = _smelt_tmp_14;
    let _smelt_tmp_15: String = cell.get();
    let _ = { println!("{}", _smelt_tmp_15); };
    let _smelt_tmp_17: Pair<f64> = Pair::new(41.0, "/posts".to_owned());
    pair = _smelt_tmp_17;
    let _smelt_tmp_18: f64 = pair.carried();
    _smelt_tmp_19 = _smelt_tmp_18 + 1.0;
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_19)); };
    _smelt_tmp_21 = pair.right.clone();
    let _smelt_tmp_22: String = pair.right.describe();
...
impl Route {
    ...
    let mut this: Self = Route { path: String::new() };
    this.path = path.clone();
    return this;
    }
    fn describe(&self) -> String {
    let _smelt_tmp_1: String = "route ".to_owned() + &self.path.clone();
    return _smelt_tmp_1;
    }
...
impl Session {
    ...
    let mut this: Self = Session(::std::rc::Rc::new(::std::cell::RefCell::new(SessionInner { name: String::new(), renew: None::<::std::rc::Rc<dyn Fn(Session) -> String>> })));
    this.0.borrow_mut().name = name.clone();
    this.0.borrow_mut().renew = None::<::std::rc::Rc<dyn Fn(Session) -> String>>;
    return this;
    }
    fn label(&self) -> String {
    let _smelt_tmp_1: String = "session ".to_owned() + &self.0.borrow().name.clone().clone();
    return _smelt_tmp_1;
    }
    /// Prototype-carried members of this class, as receiver-bound erased functions.
    ///
...
impl<T: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> Cell<T> {
    ...
    fn __smelt_proto_entries(&self) -> Vec<(String, SmeltUnknown)> {
        let mut smelt_proto_entries: Vec<(String, SmeltUnknown)> = Vec::new();
        smelt_proto_entries.push(("__smelt_method:get".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.get(); Ok((smelt_result).into_smelt_unknown()) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Cell::get")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries
    }
}

impl<Carried: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> Pair<Carried> {
    fn new(value: Carried, path: String) -> Self {
    let mut this: Self = Pair { left: Default::default(), right: Default::default(), _smelt_phantom: ::std::marker::PhantomData };
    let _smelt_tmp_3: Cell<Carried> = Cell::new(value.clone());
    this.left = _smelt_tmp_3;
    let _smelt_tmp_4: Route = Route::new(path.clone());
    this.right = _smelt_tmp_4;
    return this;
    }
    fn carried(&self) -> Carried {
    let _smelt_tmp_1: Cell<Carried> = self.left.clone();
    let _smelt_tmp_2: Carried = <Carried as SmeltFromUnknown>::smelt_from_unknown((self.left.get()).into_smelt_unknown());
    return _smelt_tmp_2;
    }
    /// Prototype-carried members of this class, as receiver-bound erased functions.
    ///
    ...
    fn __smelt_proto_entries(&self) -> Vec<(String, SmeltUnknown)> {
        let mut smelt_proto_entries: Vec<(String, SmeltUnknown)> = Vec::new();
        smelt_proto_entries.push(("__smelt_method:carried".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.carried(); Ok((smelt_result).into_smelt_unknown()) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Pair::carried")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries
    }
}
