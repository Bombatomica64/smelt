...
fn main() {
    ...
    let mut _smelt_tmp_9: Option<::std::rc::Rc<dyn Fn(String) -> f64>> = None::<::std::rc::Rc<dyn Fn(String) -> f64>>;
    let mut _smelt_tmp_10: ::std::rc::Rc<dyn Fn() -> ::std::rc::Rc<dyn Fn(String) -> f64>> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn() -> ::std::rc::Rc<dyn Fn(String) -> f64>> = ::std::rc::Rc::new(move || -> ::std::rc::Rc<dyn Fn(String) -> f64> { { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> f64> = ::std::rc::Rc::new(move |arg0: String| -> f64 { 0.0 }); smelt_default_callback } }); smelt_default_callback };
    let mut _smelt_tmp_11: ::std::rc::Rc<dyn Fn(String) -> f64> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> f64> = ::std::rc::Rc::new(move |arg0: String| -> f64 { 0.0 }); smelt_default_callback };
    ...
    let mut _smelt_tmp_14: ::std::rc::Rc<dyn Fn(String) -> f64> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> f64> = ::std::rc::Rc::new(move |arg0: String| -> f64 { 0.0 }); smelt_default_callback };
    ...
    let mut _smelt_tmp_24: ::std::rc::Rc<dyn Fn(String) -> f64> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> f64> = ::std::rc::Rc::new(move |arg0: String| -> f64 { 0.0 }); smelt_default_callback };
    let _smelt_tmp_25: bool;
    let mut _smelt_tmp_26: f64;
    let _smelt_tmp_27: f64;
    let mut _smelt_tmp_28: ::std::rc::Rc<dyn Fn(String) -> f64> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> f64> = ::std::rc::Rc::new(move |arg0: String| -> f64 { 0.0 }); smelt_default_callback };
    let _smelt_tmp_29: f64;
    let _smelt_tmp_31: bool;
    let mut _smelt_tmp_32: f64;
    let _smelt_tmp_33: f64;
    let mut _smelt_tmp_34: ::std::rc::Rc<dyn Fn(String) -> f64> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> f64> = ::std::rc::Rc::new(move |arg0: String| -> f64 { 0.0 }); smelt_default_callback };
    let _smelt_tmp_35: f64;
    let mut _smelt_tmp_37: ::std::rc::Rc<dyn Fn(String) -> f64> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> f64> = ::std::rc::Rc::new(move |arg0: String| -> f64 { 0.0 }); smelt_default_callback };
    let _smelt_tmp_38: bool;
    let mut _smelt_tmp_39: f64;
    let _smelt_tmp_40: f64;
    let mut _smelt_tmp_41: ::std::rc::Rc<dyn Fn(String) -> f64> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> f64> = ::std::rc::Rc::new(move |arg0: String| -> f64 { 0.0 }); smelt_default_callback };
    let _smelt_tmp_42: f64;
    let _smelt_tmp_44: f64;
    ...
    let _smelt_tmp_7 = ((_smelt_tmp_6)()).clone();
    via_iife = Some(_smelt_tmp_7.clone());
    let mut via_or_assign: Option<::std::rc::Rc<dyn Fn(String) -> f64>> = None::<::std::rc::Rc<dyn Fn(String) -> f64>>;
    let _smelt_tmp_8: bool = !(via_or_assign.clone().is_none());
    let mut _smelt_tmp_9: Option<::std::rc::Rc<dyn Fn(String) -> f64>> = None::<::std::rc::Rc<dyn Fn(String) -> f64>>;
    if _smelt_tmp_8 {
    _smelt_tmp_9 = via_or_assign;
    } else {
    ...
    _smelt_tmp_11 = ((_smelt_tmp_10)()).clone();
    _smelt_tmp_9 = Some(_smelt_tmp_11.clone());
    }
    via_or_assign = _smelt_tmp_9;
    ...
    _smelt_tmp_14 = via_nullish_assign.clone().unwrap_or(_smelt_tmp_13.clone());
    via_nullish_assign = Some(_smelt_tmp_14.clone());
    ...
    direct = _smelt_tmp_16.clone();
    _smelt_tmp_17 = annotated.clone().clone().expect("optional value was absent after narrowing");
    _smelt_tmp_18 = false;
    let mut _smelt_tmp_19: f64 = 0.0;
    if _smelt_tmp_18 {
    _smelt_tmp_20 = -1.0;
    _smelt_tmp_19 = _smelt_tmp_20;
    } else {
    _smelt_tmp_21 = annotated.clone().clone().expect("optional value was absent after narrowing");
    _smelt_tmp_19 = _smelt_tmp_21;
    }
    let _ = { println!("{}", _smelt_tmp_19); };
    let _ = { println!("{}", initialized); };
    _smelt_tmp_24 = via_iife.clone().clone().unwrap_or({ let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> f64> = ::std::rc::Rc::new(move |arg0: String| -> f64 { 0.0 }); smelt_default_callback });
    _smelt_tmp_25 = false;
    let mut _smelt_tmp_26: f64 = 0.0;
    if _smelt_tmp_25 {
    _smelt_tmp_27 = -1.0;
    _smelt_tmp_26 = _smelt_tmp_27;
    } else {
    _smelt_tmp_28 = via_iife.clone().unwrap_or({ let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> f64> = ::std::rc::Rc::new(move |arg0: String| -> f64 { 0.0 }); smelt_default_callback });
    _smelt_tmp_29 = (_smelt_tmp_28)("ab".to_owned());
    _smelt_tmp_26 = _smelt_tmp_29;
    }
    let _ = { println!("{}", _smelt_tmp_26); };
    _smelt_tmp_31 = via_or_assign.clone().is_none();
    let mut _smelt_tmp_32: f64 = 0.0;
    if _smelt_tmp_31 {
    _smelt_tmp_33 = -1.0;
    _smelt_tmp_32 = _smelt_tmp_33;
    } else {
    _smelt_tmp_34 = via_or_assign.clone().unwrap_or({ let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> f64> = ::std::rc::Rc::new(move |arg0: String| -> f64 { 0.0 }); smelt_default_callback });
    _smelt_tmp_35 = (_smelt_tmp_34)("ab".to_owned());
    _smelt_tmp_32 = _smelt_tmp_35;
    }
    let _ = { println!("{}", _smelt_tmp_32); };
    _smelt_tmp_37 = via_nullish_assign.clone().clone().unwrap_or({ let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> f64> = ::std::rc::Rc::new(move |arg0: String| -> f64 { 0.0 }); smelt_default_callback });
    _smelt_tmp_38 = false;
    let mut _smelt_tmp_39: f64 = 0.0;
    if _smelt_tmp_38 {
    _smelt_tmp_40 = -1.0;
    _smelt_tmp_39 = _smelt_tmp_40;
    } else {
    _smelt_tmp_41 = via_nullish_assign.clone().unwrap_or({ let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> f64> = ::std::rc::Rc::new(move |arg0: String| -> f64 { 0.0 }); smelt_default_callback });
    _smelt_tmp_42 = (_smelt_tmp_41)("ab".to_owned());
    _smelt_tmp_39 = _smelt_tmp_42;
    }
    let _ = { println!("{}", _smelt_tmp_39); };
    _smelt_tmp_44 = (direct)("ab".to_owned());
    let _ = { println!("{}", _smelt_tmp_44); };
    let _smelt_tmp_46: String = inside_a_function();
    let _ = { println!("{}", _smelt_tmp_46); };
    return;
}
