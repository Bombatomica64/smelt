...
fn main() {
    ...
    let _smelt_tmp_14: SmeltHeaders;
    let _smelt_tmp_15: Option<String>;
    let _smelt_tmp_16: String;
    let _smelt_tmp_18: SmeltResponse;
    let _smelt_tmp_19: f64;
    let _smelt_tmp_21: SmeltHeaders;
    let _smelt_tmp_22: Option<String>;
    let _smelt_tmp_23: String;
    let _smelt_tmp_25: SmeltRecord<String, String>;
    let _smelt_tmp_26: globalThis_ResponseInit;
    let _smelt_tmp_29: (String, String);
    let _smelt_tmp_30: SmeltList<(String, String)>;
    let _smelt_tmp_31: globalThis_ResponseInit;
    let _smelt_tmp_34: SmeltList<String>;
    let _smelt_tmp_35: SmeltList<SmeltList<String>>;
    let _smelt_tmp_36: SmeltHeaders;
    let _smelt_tmp_37: globalThis_ResponseInit;
    let _smelt_tmp_40: SmeltRecord<String, String>;
    let _smelt_tmp_41: SmeltRequest;
    let _smelt_tmp_42: String;
    let _smelt_tmp_44: SmeltHeaders;
    let _smelt_tmp_45: Option<String>;
    let _smelt_tmp_46: String;
    let _smelt_tmp_6 = ::std::rc::Rc::new(|closure_arg_0: Option<String>, closure_arg_1: Option<globalThis_ResponseInit>| {
    ...
    let create_response_instance = _smelt_tmp_6.clone();
    let _smelt_tmp_7: SmeltRecord<String, String> = SmeltRecord::from([("x-a".to_owned(), "1".to_owned())]);
    let _smelt_tmp_8: globalThis_ResponseInit = globalThis_ResponseInit { status: Some(201.0), status_text: Some("Created".to_owned()), headers: Some(SmeltUnion9::M1(_smelt_tmp_7)) };
    let created_init: globalThis_ResponseInit = _smelt_tmp_8;
    let _smelt_tmp_9: SmeltResponse = (create_response_instance)(Some("hi".to_owned()), Some(created_init));
    let with_init: SmeltResponse = _smelt_tmp_9;
    let _smelt_tmp_10: f64 = with_init.clone().status();
    let _ = { println!("{}", _smelt_tmp_10); };
    _smelt_tmp_12 = with_init.clone().status_text();
    let _ = { println!("{}", _smelt_tmp_12); };
    _smelt_tmp_14 = with_init.headers();
    _smelt_tmp_15 = _smelt_tmp_14.get(&"x-a".to_owned());
    _smelt_tmp_16 = _smelt_tmp_15.clone().unwrap_or("none".to_owned());
    let _ = { println!("{}", _smelt_tmp_16); };
    _smelt_tmp_18 = (create_response_instance)(None::<String>, None::<globalThis_ResponseInit>);
    bare = _smelt_tmp_18;
    _smelt_tmp_19 = bare.clone().status();
    let _ = { println!("{}", _smelt_tmp_19); };
    _smelt_tmp_21 = bare.headers();
    _smelt_tmp_22 = _smelt_tmp_21.get(&"x-a".to_owned());
    _smelt_tmp_23 = _smelt_tmp_22.clone().unwrap_or("none".to_owned());
    let _ = { println!("{}", _smelt_tmp_23); };
    _smelt_tmp_25 = SmeltRecord::from([("content-type".to_owned(), "text/plain".to_owned())]);
    _smelt_tmp_26 = globalThis_ResponseInit { status: Some(202.0), status_text: None::<String>, headers: Some(SmeltUnion9::M1(_smelt_tmp_25)) };
    let _smelt_tmp_27: String = status_of(_smelt_tmp_26);
    let _ = { println!("{}", _smelt_tmp_27); };
    _smelt_tmp_29 = ("content-type".to_owned(), "text/html".to_owned());
    _smelt_tmp_30 = Into::<SmeltList<_>>::into(SmeltList::from({ let smelt_list_items: Vec<(String, String)> = vec![_smelt_tmp_29.clone()]; smelt_list_items }));
    pairs = Into::<SmeltList<_>>::into(_smelt_tmp_30);
    _smelt_tmp_31 = globalThis_ResponseInit { status: Some(203.0), status_text: None::<String>, headers: Some(SmeltUnion9::M0(pairs)) };
    let _smelt_tmp_32: String = status_of(_smelt_tmp_31);
    let _ = { println!("{}", _smelt_tmp_32); };
    _smelt_tmp_34 = Into::<SmeltList<_>>::into(SmeltList::from({ let smelt_list_items: Vec<String> = vec!["content-type".to_owned(), "application/json".to_owned()]; smelt_list_items }));
    _smelt_tmp_35 = Into::<SmeltList<_>>::into(SmeltList::from({ let smelt_list_items: Vec<SmeltList<String>> = vec![_smelt_tmp_34.clone()]; smelt_list_items }));
    _smelt_tmp_36 = SmeltHeaders::from_pairs(_smelt_tmp_35.to_vec().into_iter().filter_map(|smelt_pair| { let smelt_pair = smelt_pair.to_vec(); Some((smelt_pair.first()?.clone(), smelt_pair.get(1)?.clone())) }).collect::<Vec<(String, String)>>());
    _smelt_tmp_37 = globalThis_ResponseInit { status: Some(206.0), status_text: None::<String>, headers: Some(SmeltUnion9::M2(_smelt_tmp_36)) };
    let _smelt_tmp_38: String = status_of(_smelt_tmp_37);
    let _ = { println!("{}", _smelt_tmp_38); };
    _smelt_tmp_40 = SmeltRecord::from([("x-b".to_owned(), "2".to_owned())]);
    _smelt_tmp_41 = SmeltRequest::from_parts(&"http://example.test/x".to_owned(), "POST".to_owned(), SmeltHeaders::from_pairs(_smelt_tmp_40.iter().map(|(smelt_name, smelt_value)| (smelt_name.clone(), smelt_value.clone())).collect::<Vec<(String, String)>>()), SmeltBody::from_text(&"payload".to_owned()));
    request = _smelt_tmp_41;
    _smelt_tmp_42 = request.clone().method();
    let _ = { println!("{}", _smelt_tmp_42); };
    _smelt_tmp_44 = request.headers();
    _smelt_tmp_45 = _smelt_tmp_44.get(&"x-b".to_owned());
    _smelt_tmp_46 = _smelt_tmp_45.clone().unwrap_or("none".to_owned());
