...
fn main() {
    let lengths: SmeltList<f64>;
    let checker: Checker;
    let mut _smelt_tmp_8: ::std::rc::Rc<dyn Fn(String, i64, &SmeltList<String>) -> bool> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String, i64, &SmeltList<String>) -> bool> = ::std::rc::Rc::new(move |arg0: String, arg1: i64, arg2: &SmeltList<String>| -> bool { false }); smelt_default_callback };
    let _smelt_tmp_9: SmeltList<String>;
    let _smelt_tmp_10: String;
    let mut _smelt_tmp_12: ::std::rc::Rc<dyn Fn(String, i64, &SmeltList<String>) -> bool> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String, i64, &SmeltList<String>) -> bool> = ::std::rc::Rc::new(move |arg0: String, arg1: i64, arg2: &SmeltList<String>| -> bool { false }); smelt_default_callback };
    let _smelt_tmp_13: SmeltList<String>;
    let _smelt_tmp_14: String;
    let mut _smelt_tmp_16: ::std::rc::Rc<dyn Fn(String, i64, &SmeltList<String>) -> bool> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String, i64, &SmeltList<String>) -> bool> = ::std::rc::Rc::new(move |arg0: String, arg1: i64, arg2: &SmeltList<String>| -> bool { false }); smelt_default_callback };
    let _smelt_tmp_17: SmeltList<String>;
    let _smelt_tmp_18: String;
    let mut _smelt_tmp_20: ::std::rc::Rc<dyn Fn(String) -> bool> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> bool> = ::std::rc::Rc::new(move |arg0: String| -> bool { false }); smelt_default_callback };
    ...
    let mut _smelt_tmp_29: ::std::rc::Rc<dyn Fn(String, i64, &SmeltList<String>) -> bool> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String, i64, &SmeltList<String>) -> bool> = ::std::rc::Rc::new(move |arg0: String, arg1: i64, arg2: &SmeltList<String>| -> bool { false }); smelt_default_callback };
    let _smelt_tmp_30: SmeltList<String>;
    ...
    _smelt_tmp_20 = ::std::rc::Rc::new(|closure_arg_0: String| {
    let _smelt_tmp_1: bool = is_long(closure_arg_0.clone());
    _smelt_tmp_1
    });
    _smelt_tmp_21 = Into::<SmeltList<_>>::into({ let smelt_callback = ::std::rc::Rc::new(|closure_arg_0: String| {
    let _smelt_tmp_1: bool = is_long(closure_arg_0.clone());
    _smelt_tmp_1
    }); words.borrow().iter().enumerate().filter_map(|(index, item)| if (smelt_callback)(item.clone()) { Some(item.clone()) } else { None }).collect::<Vec<_>>() });
    _smelt_tmp_22 = _smelt_tmp_21.borrow().join(&",".to_owned());
    let _ = { println!("{}", _smelt_tmp_22); };
    _smelt_tmp_24 = ::std::rc::Rc::new(|closure_arg_0: String| {
    (closure_arg_0.chars().count() as i64) as f64
    });
    _smelt_tmp_25 = Into::<SmeltList<_>>::into({ let smelt_callback = ::std::rc::Rc::new(|closure_arg_0: String| {
    (closure_arg_0.chars().count() as i64) as f64
    }); words.borrow().iter().enumerate().map(|(index, item)| { (smelt_callback)(item.clone()) }).collect::<Vec<_>>() });
    lengths = Into::<SmeltList<_>>::into(_smelt_tmp_25);
    _smelt_tmp_26 = lengths.borrow().iter().map(|item| { smelt_number_to_string(*item) }).collect::<Vec<_>>().join(&",".to_owned());
    let _ = { println!("{}", _smelt_tmp_26); };
    let _smelt_tmp_28: Checker = Checker::new();
    checker = _smelt_tmp_28;
    _smelt_tmp_29 = ::std::rc::Rc::new({
    let checker = checker.clone();
    move |closure_arg_0: String, closure_arg_1: i64, closure_arg_2: &SmeltList<String>| {
    let _smelt_tmp_4: bool = checker.matches(closure_arg_0.clone());
    _smelt_tmp_4
    }
});
    _smelt_tmp_30 = Into::<SmeltList<_>>::into({ let smelt_callback = ::std::rc::Rc::new({
    let checker = checker.clone();
    move |closure_arg_0: String, closure_arg_1: i64, closure_arg_2: &SmeltList<String>| {
    let _smelt_tmp_4: bool = checker.matches(closure_arg_0.clone());
    _smelt_tmp_4
    }
}); let smelt_array = words; smelt_array.borrow().iter().enumerate().filter_map(|(index, item)| if (smelt_callback)(item.clone(), index as i64, &smelt_array) { Some(item.clone()) } else { None }).collect::<Vec<_>>() });
...
impl Checker {
    ...
    let _smelt_tmp_2: String = value.clone();
    let _smelt_tmp_3: String = "ab".to_owned();
    let _smelt_tmp_4: bool = value.clone().starts_with(&_smelt_tmp_3);
    return _smelt_tmp_4;
    }
    ...
    fn __smelt_proto_entries(&self) -> Vec<(String, SmeltUnknown)> {
        ...
        smelt_proto_entries.push(("__smelt_method:matches".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.matches(SmeltFromUnknown::smelt_from_unknown(smelt_args.get(0).cloned().unwrap_or(SmeltUnknown::Undefined))); Ok(SmeltUnknown::Bool(smelt_result)) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Checker::matches")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries
    }
}
...
pub(crate) fn is_long(value: String) -> bool {
    let _smelt_tmp_1: f64 = value.chars().count() as f64;
    let _smelt_tmp_2: bool = _smelt_tmp_1 > 2.0;
    return _smelt_tmp_2;
}
