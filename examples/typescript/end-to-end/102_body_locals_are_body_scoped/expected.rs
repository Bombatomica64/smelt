...
fn main() {
    let mut _smelt_tmp_5: ::std::rc::Rc<dyn Fn(String, ::std::rc::Rc<dyn Fn() -> String>) -> String> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String, ::std::rc::Rc<dyn Fn() -> String>) -> String> = ::std::rc::Rc::new(move |arg0: String, arg1: ::std::rc::Rc<dyn Fn() -> String>| -> String { String::new() }); smelt_default_callback };
    let mut _smelt_tmp_6: ::std::rc::Rc<dyn Fn() -> String> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn() -> String> = ::std::rc::Rc::new(move || -> String { String::new() }); smelt_default_callback };
    let _smelt_tmp_7: String;
    let mut _smelt_tmp_9: ::std::rc::Rc<dyn Fn(String, ::std::rc::Rc<dyn Fn() -> String>) -> String> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String, ::std::rc::Rc<dyn Fn() -> String>) -> String> = ::std::rc::Rc::new(move |arg0: String, arg1: ::std::rc::Rc<dyn Fn() -> String>| -> String { String::new() }); smelt_default_callback };
    let mut _smelt_tmp_10: ::std::rc::Rc<dyn Fn() -> String> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn() -> String> = ::std::rc::Rc::new(move || -> String { String::new() }); smelt_default_callback };
    let _smelt_tmp_11: String;
    let _smelt_tmp_1 = ::std::rc::Rc::new(|closure_arg_0: String, closure_arg_1: ::std::rc::Rc<dyn Fn() -> String>| {
    let _smelt_tmp_2: String = "".to_owned() + &closure_arg_0.clone();
    let _smelt_tmp_3: String = _smelt_tmp_2.clone() + &"=".to_owned();
    let _smelt_tmp_4: String = (closure_arg_1)();
    let _smelt_tmp_5: String = _smelt_tmp_3.clone() + &_smelt_tmp_4.clone();
    _smelt_tmp_5.clone()
    });
    let _smelt_tmp_2 = ::std::rc::Rc::new(|| {
    let _smelt_tmp_3 = ::std::rc::Rc::new(|closure_arg_0: f64| -> ::std::rc::Rc<dyn Fn(f64) -> f64> {
    let _smelt_tmp_1 = ::std::rc::Rc::new({
    let smelt_captured_closure_arg_0 = closure_arg_0.clone();
    move |closure_arg_0: f64| {
    let _smelt_tmp_2: f64 = closure_arg_0 + smelt_captured_closure_arg_0;
    _smelt_tmp_2
    }
});
    _smelt_tmp_1.clone()
    });
    let make = _smelt_tmp_3.clone();
    let _smelt_tmp_4 = ((make)(5.0)).clone();
    let add_five = _smelt_tmp_4.clone();
    let _smelt_tmp_5 = ::std::rc::Rc::new(|closure_arg_0: f64| {
    let _smelt_tmp_1: f64 = closure_arg_0 * 2.0;
    _smelt_tmp_1
    });
    let twice = _smelt_tmp_5.clone();
    let _smelt_tmp_6 = ((make)(1.0)).clone();
    let _smelt_tmp_7: f64 = (_smelt_tmp_6)(0.0);
    let _smelt_tmp_8: f64 = (add_five)(_smelt_tmp_7);
    let _smelt_tmp_9: f64 = (twice)(_smelt_tmp_8);
    let _smelt_tmp_10: String = smelt_number_to_string(_smelt_tmp_9);
    _smelt_tmp_10.clone()
    });
    let _smelt_tmp_3: String = (_smelt_tmp_1)("first".to_owned(), _smelt_tmp_2.clone());
    let _ = { println!("{}", _smelt_tmp_3); };
    _smelt_tmp_5 = ::std::rc::Rc::new(|closure_arg_0: String, closure_arg_1: ::std::rc::Rc<dyn Fn() -> String>| {
    let _smelt_tmp_2: String = "".to_owned() + &closure_arg_0.clone();
    let _smelt_tmp_3: String = _smelt_tmp_2.clone() + &"=".to_owned();
    let _smelt_tmp_4: String = (closure_arg_1)();
    let _smelt_tmp_5: String = _smelt_tmp_3.clone() + &_smelt_tmp_4.clone();
    ...
    let _smelt_tmp_4 = ::std::rc::Rc::new(|closure_arg_0: f64| -> ::std::rc::Rc<dyn Fn(f64) -> f64> {
    let _smelt_tmp_1 = ::std::rc::Rc::new({
    let smelt_captured_closure_arg_0 = closure_arg_0.clone();
    move |closure_arg_0: f64| {
    let _smelt_tmp_2: f64 = closure_arg_0 + smelt_captured_closure_arg_0;
    ...
    let make = _smelt_tmp_4.clone();
    let _smelt_tmp_5 = ((make)(5.0)).clone();
    let add_five = _smelt_tmp_5.clone();
    let _smelt_tmp_6 = ::std::rc::Rc::new(|closure_arg_0: f64| {
    let _smelt_tmp_1: f64 = closure_arg_0 * 2.0;
    _smelt_tmp_1
    });
    let twice = _smelt_tmp_6.clone();
    let _smelt_tmp_7 = ::std::rc::Rc::new(|closure_arg_0: f64| {
    let _smelt_tmp_1: String = "x".to_owned().repeat(closure_arg_0 as usize);
    _smelt_tmp_1.clone()
    });
    let repeat = _smelt_tmp_7.clone();
    let _smelt_tmp_8 = ((make)(2.0)).clone();
    let _smelt_tmp_9: f64 = (_smelt_tmp_8)(0.0);
    let _smelt_tmp_10: f64 = (add_five)(_smelt_tmp_9);
    let _smelt_tmp_11: f64 = (twice)(_smelt_tmp_10);
    let _smelt_tmp_12: String = (repeat)(_smelt_tmp_11);
    _smelt_tmp_12.clone()
    });
    _smelt_tmp_7 = (_smelt_tmp_5)("second".to_owned(), _smelt_tmp_6.clone());
    let _ = { println!("{}", _smelt_tmp_7); };
    _smelt_tmp_9 = ::std::rc::Rc::new(|closure_arg_0: String, closure_arg_1: ::std::rc::Rc<dyn Fn() -> String>| {
    let _smelt_tmp_2: String = "".to_owned() + &closure_arg_0.clone();
    let _smelt_tmp_3: String = _smelt_tmp_2.clone() + &"=".to_owned();
    let _smelt_tmp_4: String = (closure_arg_1)();
    let _smelt_tmp_5: String = _smelt_tmp_3.clone() + &_smelt_tmp_4.clone();
    ...
    _smelt_tmp_11 = (_smelt_tmp_9)("third".to_owned(), _smelt_tmp_10.clone());
