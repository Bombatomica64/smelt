...
impl IntoSmeltUnknown for Registry {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        ...
        ("slots".to_owned(), SmeltUnknown::Array(__smelt_inner.slots.clone().into_iter().map(|value| SmeltUnknown::String(value.into())).collect())),
        ]);
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut caught: String;
    let _smelt_tmp_10: SmeltList<String>;
    let _smelt_tmp_12: String;
    let _smelt_tmp_2: Registry = Registry::new();
    registry = _smelt_tmp_2;
    let _ = registry.add("alpha".to_owned());
    let _ = registry.add("beta".to_owned());
    let _ = { println!("{}", registry.__smelt_get_first()?.clone()); };
    let _smelt_tmp_6: String = registry.describe()?;
    let _ = { println!("{}", _smelt_tmp_6); };
    let _smelt_tmp_8: String = registry.label();
    let _ = { println!("{}", _smelt_tmp_8); };
    _smelt_tmp_10 = Into::<SmeltList<_>>::into(SmeltList::from({ let smelt_list_items: Vec<String> = vec!["a".to_owned(), "b".to_owned()]; smelt_list_items }));
    let _smelt_tmp_11: SmeltList<String> = registry.tagged(_smelt_tmp_10);
    _smelt_tmp_12 = _smelt_tmp_11.borrow().join(&",".to_owned());
    let _ = { println!("{}", _smelt_tmp_12); };
    let _ = registry.add("gamma".to_owned());
    let _ = registry.add("delta".to_owned());
    caught = "none".to_owned();
    match ::std::panic::catch_unwind(::std::panic::AssertUnwindSafe(|| registry.describe())) {
        Ok(Ok(__smelt_value)) => {
...
impl Registry {
    fn new() -> Self {
    let mut this: Self = Registry(::std::rc::Rc::new(::std::cell::RefCell::new(RegistryInner { slots: SmeltList::new(Vec::<String>::new()) })));
    ...
    this.0.borrow_mut().slots = Into::<SmeltList<_>>::into(_smelt_tmp_1);
    return this;
    }
    fn __smelt_get_first(&self) -> Result<String, Box<dyn std::error::Error>> {
    let _smelt_tmp_5: SmeltList<String>;
    let _smelt_tmp_1: f64 = self.0.borrow().slots.clone().len() as f64;
    ...
    let mut _smelt_tmp_2: SmeltList<String> = Into::<SmeltList<_>>::into(self.0.borrow().slots.clone());
    let _smelt_tmp_3: f64 = { let smelt_push_item = name.clone(); _smelt_tmp_2.borrow_mut().push(smelt_push_item); _smelt_tmp_2.len() as f64 };
    self.0.borrow_mut().slots = Into::<SmeltList<_>>::into(_smelt_tmp_2);
    return;
    }
    fn describe(&self) -> Result<String, Box<dyn std::error::Error>> {
    let _smelt_tmp_5: String;
    let _smelt_tmp_1: f64 = self.0.borrow().slots.clone().len() as f64;
    let _smelt_tmp_2: bool = _smelt_tmp_1 > 3.0;
    if _smelt_tmp_2 {
    return Err::<_, Box<dyn std::error::Error>>(smelt_throw(SmeltUnknown::Object(SmeltObject::from_unknown_record((SmeltRecord::from([("__smelt_error".to_owned(), SmeltUnknown::String("Error".into())), ("message".to_owned(), SmeltUnknown::String("too many".into())), ("stack".to_owned(), SmeltUnknown::Undefined), ("cause".to_owned(), SmeltUnknown::Undefined)])).clone()))));
    } else {
    _smelt_tmp_5 = "first=".to_owned() + &self.__smelt_get_first()?.clone();
    return Ok(_smelt_tmp_5);
    }
    }
    fn label(&self) -> String {
    let _smelt_tmp_1: String = "[".to_owned() + &self.__smelt_get_first().unwrap_or_else(|error| smelt_panic_throw(error)).clone();
    let _smelt_tmp_2: String = _smelt_tmp_1 + &"]".to_owned();
    return _smelt_tmp_2;
    }
    fn tagged(&self, prefix: SmeltList<String>) -> SmeltList<String> {
    let _smelt_tmp_2 = ::std::rc::Rc::new({
    let smelt_self = self.clone();
    move |closure_arg_0: String, _arg0: i64, _arg1: &SmeltList<String>| {
    let _smelt_tmp_2: String = closure_arg_0.clone() + &":".to_owned();
    let _smelt_tmp_3: String = _smelt_tmp_2.clone() + &smelt_self.__smelt_get_first().unwrap_or_else(|error| smelt_panic_throw(error)).clone();
    _smelt_tmp_3.clone()
    }
});
    let _smelt_tmp_3: SmeltList<String> = Into::<SmeltList<_>>::into({ let smelt_callback = ::std::rc::Rc::new({
    let smelt_self = self.clone();
    move |closure_arg_0: String, _arg0: i64, _arg1: &SmeltList<String>| {
    let _smelt_tmp_2: String = closure_arg_0.clone() + &":".to_owned();
    let _smelt_tmp_3: String = _smelt_tmp_2.clone() + &smelt_self.__smelt_get_first().unwrap_or_else(|error| smelt_panic_throw(error)).clone();
...
}); let smelt_array = prefix.clone(); smelt_array.borrow().iter().enumerate().map(|(index, item)| { (smelt_callback)(item.clone(), index as i64, &smelt_array) }).collect::<Vec<_>>() });
    return _smelt_tmp_3;
    }
    ...
    fn __smelt_proto_entries(&self) -> Vec<(String, SmeltUnknown)> {
        ...
        smelt_proto_entries.push(("__smelt_method:add".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.add(SmeltFromUnknown::smelt_from_unknown(smelt_args.get(0).cloned().unwrap_or(SmeltUnknown::Undefined))); Ok({ let () = smelt_result; SmeltUnknown::Undefined }) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Registry::add")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries.push(("__smelt_method:describe".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.describe()?; Ok(SmeltUnknown::String(smelt_result.into())) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Registry::describe")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries.push(("__smelt_method:label".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.label(); Ok(SmeltUnknown::String(smelt_result.into())) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Registry::label")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries.push(("__smelt_method:tagged".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.tagged(SmeltFromUnknown::smelt_from_unknown(smelt_args.get(0).cloned().unwrap_or(SmeltUnknown::Undefined))); Ok(SmeltUnknown::Array(smelt_result.into_iter().map(|value| SmeltUnknown::String(value.into())).collect())) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Registry::tagged")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries
    }
}
