...
fn main() {
    ...
    let from_array: ::std::collections::HashSet<String>;
    let copied: ::std::collections::HashSet<String>;
    let direct: ::std::collections::HashSet<String>;
    let via_spread: ::std::collections::HashSet<String>;
    ...
    let _smelt_tmp_19: ::std::collections::HashSet<String>;
    ...
    let _smelt_tmp_30: ::std::collections::HashSet<String>;
    let _smelt_tmp_31: f64;
    let _smelt_tmp_33: ::std::collections::HashSet<String>;
    let _smelt_tmp_34: f64;
    let _smelt_tmp_36: bool;
    let _smelt_tmp_38: SmeltList<String>;
    let _smelt_tmp_39: ::std::collections::HashSet<String>;
    let _smelt_tmp_40: SmeltList<String>;
    let _smelt_tmp_41: ::std::collections::HashSet<String>;
    let _smelt_tmp_42: f64;
    let _smelt_tmp_43: f64;
    let _smelt_tmp_44: bool;
    let _smelt_tmp_46: SmeltList<String>;
    let mut _smelt_tmp_47: ::std::rc::Rc<dyn Fn(String, i64, &SmeltList<String>) -> bool> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String, i64, &SmeltList<String>) -> bool> = ::std::rc::Rc::new(move |arg0: String, arg1: i64, arg2: &SmeltList<String>| -> bool { false }); smelt_default_callback };
    let _smelt_tmp_48: bool;
    let _smelt_tmp_50: SmeltList<String>;
    let mut _smelt_tmp_51: ::std::rc::Rc<dyn Fn(String, i64, &SmeltList<String>) -> bool> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String, i64, &SmeltList<String>) -> bool> = ::std::rc::Rc::new(move |arg0: String, arg1: i64, arg2: &SmeltList<String>| -> bool { false }); smelt_default_callback };
    ...
    let _smelt_tmp_7: ::std::collections::HashSet<String> = _smelt_tmp_6.borrow().iter().cloned().collect::<::std::collections::HashSet<_>>();
    let reg_exp_meta_chars: ::std::collections::HashSet<String> = _smelt_tmp_7;
    ...
    _smelt_tmp_16 = reg_exp_meta_chars.contains(&"a".to_owned());
    let _ = { println!("{}", _smelt_tmp_16); };
    _smelt_tmp_18 = Into::<SmeltList<_>>::into("aabbcc".to_owned().chars().map(|ch| ch.to_string()).collect::<Vec<_>>());
    _smelt_tmp_19 = _smelt_tmp_18.borrow().iter().cloned().collect::<::std::collections::HashSet<_>>();
    repeated = _smelt_tmp_19;
    _smelt_tmp_20 = repeated.len() as f64;
    let _ = { println!("{}", _smelt_tmp_20); };
    _smelt_tmp_22 = repeated.clone().contains(&"a".to_owned());
    let mut _smelt_tmp_23: bool = false;
    if _smelt_tmp_22 {
    _smelt_tmp_24 = repeated.clone().contains(&"b".to_owned());
    _smelt_tmp_23 = _smelt_tmp_24;
    } else {
    _smelt_tmp_23 = false;
    }
    _smelt_tmp_25 = repeated.clone().contains(&"c".to_owned());
    _smelt_tmp_26 = _smelt_tmp_23 && _smelt_tmp_25;
    let _ = { println!("{}", _smelt_tmp_26); };
    _smelt_tmp_28 = repeated.contains(&"d".to_owned());
    let _ = { println!("{}", _smelt_tmp_28); };
    _smelt_tmp_30 = ::std::collections::HashSet::from(["a".to_owned(), "b".to_owned(), "a".to_owned()]);
    from_array = _smelt_tmp_30;
    _smelt_tmp_31 = from_array.len() as f64;
    let _ = { println!("{}", _smelt_tmp_31); };
    _smelt_tmp_33 = from_array.clone();
    copied = from_array;
    _smelt_tmp_34 = copied.len() as f64;
    let _ = { println!("{}", _smelt_tmp_34); };
    _smelt_tmp_36 = copied.contains(&"b".to_owned());
    let _ = { println!("{}", _smelt_tmp_36); };
    _smelt_tmp_38 = Into::<SmeltList<_>>::into("hello".to_owned().chars().map(|ch| ch.to_string()).collect::<Vec<_>>());
    _smelt_tmp_39 = _smelt_tmp_38.borrow().iter().cloned().collect::<::std::collections::HashSet<_>>();
    direct = _smelt_tmp_39;
    _smelt_tmp_40 = Into::<SmeltList<_>>::into("hello".to_owned().chars().map(|ch| ch.to_string()).collect::<Vec<_>>());
    _smelt_tmp_41 = _smelt_tmp_40.borrow().iter().cloned().collect::<::std::collections::HashSet<_>>();
    via_spread = _smelt_tmp_41;
    _smelt_tmp_42 = direct.len() as f64;
    _smelt_tmp_43 = via_spread.len() as f64;
    ...
    _smelt_tmp_47 = ::std::rc::Rc::new({
    let via_spread = via_spread.clone();
    move |closure_arg_0: String, closure_arg_1: i64, closure_arg_2: &SmeltList<String>| {
    let _smelt_tmp_4: bool = via_spread.clone().contains(&closure_arg_0);
    _smelt_tmp_4
    }
});
    _smelt_tmp_48 = { let smelt_callback = ::std::rc::Rc::new({
    let via_spread = via_spread.clone();
    move |closure_arg_0: String, closure_arg_1: i64, closure_arg_2: &SmeltList<String>| {
    let _smelt_tmp_4: bool = via_spread.clone().contains(&closure_arg_0);
    _smelt_tmp_4
    }
}); let smelt_array = _smelt_tmp_46; smelt_array.borrow().iter().enumerate().all(|(index, item)| (smelt_callback)(item.clone(), index as i64, &smelt_array)) };
    let _ = { println!("{}", _smelt_tmp_48); };
    _smelt_tmp_50 = Into::<SmeltList<_>>::into(via_spread.iter().cloned().collect::<Vec<_>>());
    _smelt_tmp_51 = ::std::rc::Rc::new({
    let direct = direct.clone();
    move |closure_arg_0: String, closure_arg_1: i64, closure_arg_2: &SmeltList<String>| {
    let _smelt_tmp_4: bool = direct.clone().contains(&closure_arg_0);
    _smelt_tmp_4
    }
});
    _smelt_tmp_52 = { let smelt_callback = ::std::rc::Rc::new({
    let direct = direct.clone();
    move |closure_arg_0: String, closure_arg_1: i64, closure_arg_2: &SmeltList<String>| {
    let _smelt_tmp_4: bool = direct.clone().contains(&closure_arg_0);
    _smelt_tmp_4
    }
}); let smelt_array = _smelt_tmp_50; smelt_array.borrow().iter().enumerate().all(|(index, item)| (smelt_callback)(item.clone(), index as i64, &smelt_array)) };
    let _ = { println!("{}", _smelt_tmp_52); };
    return;
}
