...
pub(crate) fn make_handler(prefix: String) -> ::std::rc::Rc<dyn Fn(String, bool) -> SmeltFuture<String>> {
    ...
    if _smelt_tmp_8 {
    _smelt_tmp_10 = closure_arg_0.clone();
    _smelt_tmp_11 = "/".to_owned();
    _smelt_tmp_12 = _smelt_tmp_10.clone().starts_with(&_smelt_tmp_11.clone());
    _smelt_tmp_9 = _smelt_tmp_12;
    } else {
    _smelt_tmp_9 = false;
    }
    if _smelt_tmp_9 {
    _smelt_tmp_14 = closure_arg_0.clone();
    _smelt_tmp_15 = "/".to_owned();
    _smelt_tmp_16 = _smelt_tmp_14.clone().ends_with(&_smelt_tmp_15.clone());
    _smelt_tmp_17 = !(_smelt_tmp_16);
    _smelt_tmp_13 = _smelt_tmp_17;
    } else {
    _smelt_tmp_13 = false;
    }
    if _smelt_tmp_13 {
    _smelt_tmp_19 = closure_arg_0.clone() != "/".to_owned();
    _smelt_tmp_18 = _smelt_tmp_19;
    } else {
    _smelt_tmp_18 = false;
    }
    if _smelt_tmp_18 {
    _smelt_tmp_21 = closure_arg_0.clone().contains(&"..".to_owned());
    _smelt_tmp_22 = !(_smelt_tmp_21);
    _smelt_tmp_20 = _smelt_tmp_22;
    } else {
    _smelt_tmp_20 = false;
    }
    if _smelt_tmp_20 {
    _smelt_tmp_24 = closure_arg_0.chars().count() as f64;
    _smelt_tmp_25 = _smelt_tmp_24 < 64.0;
    _smelt_tmp_23 = _smelt_tmp_25;
    } else {
    _smelt_tmp_23 = false;
    }
    if _smelt_tmp_23 {
    _smelt_tmp_27 = closure_arg_0.clone().find(&prefix.clone()).map_or(-1.0, |idx| idx as f64);
    _smelt_tmp_28 = _smelt_tmp_27 == 0.0;
    _smelt_tmp_26 = _smelt_tmp_28;
    } else {
    _smelt_tmp_26 = false;
    }
    if _smelt_tmp_26 {
    _smelt_tmp_30 = closure_arg_0.clone().chars().nth(1.0 as usize).map(|ch| ch.to_string()).unwrap_or_default();
    _smelt_tmp_31 = _smelt_tmp_30.clone() != "_".to_owned();
    _smelt_tmp_29 = _smelt_tmp_31;
    } else {
    _smelt_tmp_29 = false;
    }
    if _smelt_tmp_29 {
    _smelt_tmp_32 = score + 1.0;
    score = _smelt_tmp_32;
    } else {
    }
...
pub(crate) fn check(path: String) -> Result<f64, Box<dyn std::error::Error>> {
    ...
    let _smelt_tmp_1: f64 = path.chars().count() as f64;
    let _smelt_tmp_2: bool = _smelt_tmp_1 > 10.0;
    if _smelt_tmp_2 {
    return Err::<_, Box<dyn std::error::Error>>(smelt_throw(SmeltUnknown::Object(SmeltObject::from_unknown_record((SmeltRecord::from([("__smelt_error".to_owned(), SmeltUnknown::String("Error".into())), ("message".to_owned(), SmeltUnknown::String("too long".into())), ("stack".to_owned(), SmeltUnknown::Undefined), ("cause".to_owned(), SmeltUnknown::Undefined)])).clone()))));
    } else {
    _smelt_tmp_5 = path.chars().count() as f64;
    return Ok(_smelt_tmp_5);
    }
}

pub(crate) fn counter() -> ::std::rc::Rc<dyn Fn(f64) -> f64> {
    let _smelt_tmp_0 = ::std::rc::Rc::new(move |closure_arg_0: f64| {
    ...
    _smelt_tmp_7 = -5.0;
    _smelt_tmp_8 = closure_arg_0 == _smelt_tmp_7;
    _smelt_tmp_6 = _smelt_tmp_8;
    }
    if _smelt_tmp_6 {
    _smelt_tmp_9 = hits + 1.0;
    hits = _smelt_tmp_9;
    } else {
    }
    _smelt_tmp_10 = closure_arg_0 % 2.0;
    _smelt_tmp_11 = _smelt_tmp_10 == 0.0;
    if _smelt_tmp_11 {
    _smelt_tmp_13 = closure_arg_0 % 3.0;
    _smelt_tmp_14 = _smelt_tmp_13 == 0.0;
    _smelt_tmp_12 = _smelt_tmp_14;
    } else {
    _smelt_tmp_12 = false;
    }
    if _smelt_tmp_12 {
    _smelt_tmp_16 = closure_arg_0 % 5.0;
    _smelt_tmp_17 = _smelt_tmp_16 == 0.0;
    _smelt_tmp_15 = _smelt_tmp_17;
    } else {
    _smelt_tmp_15 = false;
    }
    if _smelt_tmp_15 {
    _smelt_tmp_18 = hits + 100.0;
    _smelt_tmp_18
    } else {
    hits
    }
    });
    return _smelt_tmp_0.clone();
}

pub(crate) async fn run() -> Result<(), Box<dyn std::error::Error>> {
    let handler: ::std::rc::Rc<dyn Fn(String, bool) -> SmeltFuture<String>>;
    let count: ::std::rc::Rc<dyn Fn(f64) -> f64>;
    ...
    let _smelt_tmp_2 = make_handler("/api".to_owned()).clone();
    handler = _smelt_tmp_2.clone();
    let _smelt_tmp_3: SmeltFuture<String> = (handler)("/api/users".to_owned(), false);
    _smelt_tmp_4 = _smelt_tmp_3.await?;
    let _ = { println!("{}", _smelt_tmp_4); };
    let _smelt_tmp_6: SmeltFuture<String> = (handler)("/api/users/".to_owned(), false);
    _smelt_tmp_7 = _smelt_tmp_6.await?;
    let _ = { println!("{}", _smelt_tmp_7); };
    let _smelt_tmp_9: SmeltFuture<String> = (handler)("/api".to_owned(), true);
    _smelt_tmp_10 = _smelt_tmp_9.await?;
    let _ = { println!("{}", _smelt_tmp_10); };
    let _smelt_tmp_12: SmeltFuture<String> = (handler)("/api/a".to_owned(), true);
    _smelt_tmp_13 = _smelt_tmp_12.await?;
    let _ = { println!("{}", _smelt_tmp_13); };
    let _smelt_tmp_15: SmeltFuture<String> = (handler)("relative".to_owned(), false);
    _smelt_tmp_16 = _smelt_tmp_15.await?;
    let _ = { println!("{}", _smelt_tmp_16); };
    let _smelt_tmp_18 = counter().clone();
    count = _smelt_tmp_18.clone();
    _smelt_tmp_19 = (count)(3.0);
    _smelt_tmp_20 = -5.0;
    _smelt_tmp_21 = (count)(_smelt_tmp_20);
    _smelt_tmp_22 = (count)(30.0);
    _smelt_tmp_23 = -7.0;
    _smelt_tmp_24 = (count)(_smelt_tmp_23);
    _smelt_tmp_25 = (count)(0.0);
    let _ = { println!("{} {} {} {} {}", smelt_console_number(_smelt_tmp_19), smelt_console_number(_smelt_tmp_21), smelt_console_number(_smelt_tmp_22), smelt_console_number(_smelt_tmp_24), smelt_console_number(_smelt_tmp_25)); };
    return Ok(());
}
