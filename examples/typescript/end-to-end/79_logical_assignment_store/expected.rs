...
fn main() {
    ...
    field_value = 5.0;
    _smelt_tmp_40 = field_value.to_string();
    _smelt_tmp_41 = "field: ".to_owned() + &_smelt_tmp_40;
    _smelt_tmp_42 = _smelt_tmp_41 + &" ".to_owned();
    _smelt_tmp_43 = holder.get(&"field".to_owned()).expect("missing field").to_string();
    ...
    element_value = 5.0;
    _smelt_tmp_47 = element_value.to_string();
    ...
    _smelt_tmp_54 = numbers.get(&"a".to_owned().clone()).unwrap_or(0.0).to_string();
    ...
    _smelt_tmp_68 = or_field.to_string();
    _smelt_tmp_69 = "or field: ".to_owned() + &_smelt_tmp_68;
    _smelt_tmp_70 = _smelt_tmp_69 + &" ".to_owned();
    _smelt_tmp_71 = falsy_holder.get(&"field".to_owned()).expect("missing field").to_string();
    ...
    _smelt_tmp_106 = nullish.get(&"a".to_owned().clone()).unwrap_or(0.0).to_string();
    ...
    _smelt_tmp_114 = _smelt_tmp_113.to_string();
    ...
    _smelt_tmp_120 = present.get(&"a".to_owned().clone()).unwrap_or(0.0).to_string();
    ...
    _smelt_tmp_124 = absent_local.map_or_else(|| "undefined".to_owned(), |value| value.to_string());
    ...
    _smelt_tmp_129 = optional.get(&"field".to_owned()).flatten().clone().map_or_else(|| "undefined".to_owned(), |value| value.to_string());
    ...
    _smelt_tmp_134 = truthy.to_string();
