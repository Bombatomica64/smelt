...
fn main() {
    ...
    let mut shifted: f64;
    let mut signed: f64;
    let mut unsigned: f64;
    let mut rest: f64;
    let mut flipped: f64;
    let values: SmeltList<f64>;
    let mut hash: f64;
    let mut value: f64;
