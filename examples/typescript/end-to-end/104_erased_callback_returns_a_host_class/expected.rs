...
pub enum SmeltUnion4 {
    M0(bool),
    M1(::std::rc::Rc<dyn Fn(f64) -> SmeltArrayBuffer>),
}
impl IntoSmeltUnknown for SmeltUnion4 {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        match self {
            Self::M0(value) => SmeltUnknown::Bool(value),
            Self::M1(value) => { let smelt_function_value = value; if let Some(smelt_callable_object) = smelt_lookup_callable_object(&smelt_function_value) { smelt_callable_object } else { let smelt_origin_identity = smelt_canonical_function_identity(&smelt_function_value); let smelt_function_origin = smelt_function_value.clone(); let smelt_erased_function: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new(move |smelt_args: Vec<SmeltUnknown>| Ok::<SmeltUnknown, Box<dyn std::error::Error>>(((smelt_function_value)(match smelt_args.get(0).cloned().unwrap_or(SmeltUnknown::Null).clone() { SmeltUnknown::Number(value) => value, SmeltUnknown::Object(value) => match value.get("__smelt_date") { Some(SmeltUnknown::Number(value)) => value, _ => f64::NAN }, SmeltUnknown::String(value) => value.parse::<f64>().unwrap_or(f64::NAN), SmeltUnknown::Bool(value) => if value { 1.0 } else { 0.0 }, SmeltUnknown::Null | SmeltUnknown::Undefined | SmeltUnknown::Symbol(_) | SmeltUnknown::Array(_) | SmeltUnknown::Function(_) | SmeltUnknown::Promise(_) => f64::NAN })).clone().into_smelt_unknown())); smelt_register_function_origin(&smelt_erased_function, smelt_function_origin); smelt_link_function_identity_key(&smelt_erased_function, smelt_origin_identity); SmeltUnknown::Function(smelt_erased_function) } },
        }
    }
}
impl SmeltUnion4 {
    fn from_smelt_unknown(value: SmeltUnknown) -> Self {
        if matches!(value, SmeltUnknown::Bool(_)) { return Self::M0(match value.clone() { SmeltUnknown::Null | SmeltUnknown::Undefined => false, SmeltUnknown::Bool(value) => value, SmeltUnknown::Number(value) => value != 0.0 && !value.is_nan(), SmeltUnknown::String(value) => !value.is_empty(), SmeltUnknown::Symbol(_) | SmeltUnknown::Array(_) | SmeltUnknown::Object(_) | SmeltUnknown::Function(_) | SmeltUnknown::Promise(_) => true }); }
        Self::M1({ let smelt_source_value = value.clone(); let smelt_function = match smelt_source_value.clone() { SmeltUnknown::Function(smelt_function) => Some(smelt_function), SmeltUnknown::Object(smelt_object) => match smelt_object.get("__smelt_call") { Some(SmeltUnknown::Function(smelt_function)) => Some(smelt_function), _ => None }, _ => None }; if let Some(smelt_function) = smelt_function { let smelt_origin_identity = smelt_canonical_function_identity(&smelt_function); let smelt_callback: ::std::rc::Rc<dyn Fn(f64) -> SmeltArrayBuffer> = if let Some(smelt_original) = smelt_restore_function_origin::<::std::rc::Rc<dyn Fn(f64) -> SmeltArrayBuffer>>(&smelt_function) { smelt_original } else { ::std::rc::Rc::new(move |arg0: f64| -> SmeltArrayBuffer { let smelt_result = (smelt_function)({ let mut smelt_call_args = Vec::new(); smelt_call_args.push(SmeltUnknown::Number(arg0 as f64)); smelt_call_args }).unwrap_or_else(|error| smelt_panic_throw(error)); <SmeltArrayBuffer as SmeltFromUnknown>::smelt_from_unknown(smelt_result.clone()) }) }; smelt_register_callable_object(&smelt_callback, smelt_source_value); smelt_link_function_identity_key(&smelt_callback, smelt_origin_identity); smelt_callback } else { { let smelt_default_callback: ::std::rc::Rc<dyn Fn(f64) -> SmeltArrayBuffer> = ::std::rc::Rc::new(move |arg0: f64| -> SmeltArrayBuffer { SmeltArrayBuffer::new(0) }); smelt_default_callback } } })
    }
}
...
fn main() {
    let mut _smelt_tmp_5: ::std::rc::Rc<dyn Fn(f64) -> SmeltArrayBuffer> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(f64) -> SmeltArrayBuffer> = ::std::rc::Rc::new(move |arg0: f64| -> SmeltArrayBuffer { SmeltArrayBuffer::new(0) }); smelt_default_callback };
    let _smelt_tmp_0 = ::std::rc::Rc::new(|closure_arg_0: f64| {
    let _smelt_tmp_1: SmeltArrayBuffer = make__module_main(closure_arg_0);
    _smelt_tmp_1.clone()
    });
    let _smelt_tmp_1: String = describe(SmeltUnion4::M1(_smelt_tmp_0));
    let _ = { println!("{}", _smelt_tmp_1); };
    let _smelt_tmp_3: String = describe(SmeltUnion4::M0(true));
    let _ = { println!("{}", _smelt_tmp_3); };
    _smelt_tmp_5 = ::std::rc::Rc::new(|closure_arg_0: f64| {
    let _smelt_tmp_1: SmeltArrayBuffer = make__module_main(closure_arg_0);
    _smelt_tmp_1.clone()
    });
    let _smelt_tmp_6: String = label(SmeltUnion4::M1(_smelt_tmp_5));
...
pub(crate) fn describe(maker: SmeltUnion4) -> String {
    let buffer: SmeltArrayBuffer;
    let mut _smelt_tmp_3: ::std::rc::Rc<dyn Fn(f64) -> SmeltArrayBuffer> = { let smelt_default_callback: ::std::rc::Rc<dyn Fn(f64) -> SmeltArrayBuffer> = ::std::rc::Rc::new(move |arg0: f64| -> SmeltArrayBuffer { SmeltArrayBuffer::new(0) }); smelt_default_callback };
    let _smelt_tmp_4: SmeltArrayBuffer;
    let _smelt_tmp_5: f64;
    let _smelt_tmp_6: String;
    let _smelt_tmp_7: bool;
    let _smelt_tmp_8: String;
    let _smelt_tmp_2: bool = matches!(maker.clone(), SmeltUnion4::M1(_));
    if _smelt_tmp_2 {
    _smelt_tmp_3 = (match maker.clone() { SmeltUnion4::M1(value) => value, _ => unreachable!("union guard selected an excluded member") }).clone();
    _smelt_tmp_4 = (_smelt_tmp_3)(4.0);
    buffer = _smelt_tmp_4;
    _smelt_tmp_5 = buffer.byte_length();
    _smelt_tmp_6 = "bytes=".to_owned() + &smelt_number_to_string(_smelt_tmp_5);
    return _smelt_tmp_6;
    } else {
    _smelt_tmp_7 = match maker.clone() { SmeltUnion4::M0(value) => value, _ => unreachable!("union guard selected an excluded member") };
    _smelt_tmp_8 = "flag=".to_owned() + &_smelt_tmp_7.to_string();
    return _smelt_tmp_8;
    }
}

pub(crate) fn label(maker: SmeltUnion4) -> String {
    let _smelt_tmp_1: String = match &maker { SmeltUnion4::M0(_) => "boolean", SmeltUnion4::M1(_) => "function" }.to_owned();
    let _smelt_tmp_2: String = "".to_owned() + &_smelt_tmp_1;
    return _smelt_tmp_2;
}

pub(crate) fn make__module_main(size: f64) -> SmeltArrayBuffer {
    let _smelt_tmp_1: SmeltArrayBuffer = SmeltArrayBuffer::new(((size) as f64).max(0.0) as usize);
    return _smelt_tmp_1;
}
