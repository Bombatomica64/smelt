...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    holder = _smelt_tmp_6;
    let _ = { println!("{}", holder.__smelt_get___smelt_symbol_unique__at_813()); };
