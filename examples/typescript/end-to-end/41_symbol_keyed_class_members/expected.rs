...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    holder = _smelt_tmp_6;
    let _ = { println!("{}", holder.__smelt_get___smelt_symbol_unique_symbol_813()); };
    _smelt_tmp_8 = match ({ let smelt_function_value = ({ let smelt_receiver = holder.clone(); let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new(move |smelt_args: Vec<SmeltUnknown>| Ok::<SmeltUnknown, Box<dyn std::error::Error>>(SmeltUnknown::Number(smelt_receiver.__smelt_symbol_unique_symbol_described_841(match smelt_args.get(0).cloned().unwrap_or(SmeltUnknown::Null).clone() { SmeltUnknown::Number(value) => value, SmeltUnknown::Object(value) => match value.get("__smelt_date") { Some(SmeltUnknown::Number(value)) => value, _ => f64::NAN }, SmeltUnknown::String(value) => value.parse::<f64>().unwrap_or(f64::NAN), SmeltUnknown::Bool(value) => if value { 1.0 } else { 0.0 }, SmeltUnknown::Null | SmeltUnknown::Undefined | SmeltUnknown::Symbol(_) | SmeltUnknown::Array(_) | SmeltUnknown::Function(_) | SmeltUnknown::Promise(_) => f64::NAN }) as f64))); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Holder::__smelt_symbol_unique_symbol_described_841")); SmeltUnknown::Function(smelt_method) }.clone()); let smelt_call_args: Vec<SmeltUnknown> = Into::into(vec![SmeltUnknown::Number(1.0 as f64)]); let smelt_callable = match smelt_function_value { SmeltUnknown::Function(smelt_function) => Some(smelt_function), SmeltUnknown::Object(smelt_object) => match smelt_object.get("__smelt_call") { Some(SmeltUnknown::Function(smelt_function)) => Some(smelt_function.clone()), _ => None }, _ => None }; if let Some(smelt_function) = smelt_callable { (smelt_function)(smelt_call_args).unwrap_or_else(|error| smelt_panic_throw(error)) } else { SmeltUnknown::Null } }).clone() { SmeltUnknown::Number(value) => value, SmeltUnknown::Object(value) => match value.get("__smelt_date") { Some(SmeltUnknown::Number(value)) => value, _ => f64::NAN }, SmeltUnknown::String(value) => value.parse::<f64>().unwrap_or(f64::NAN), SmeltUnknown::Bool(value) => if value { 1.0 } else { 0.0 }, SmeltUnknown::Null | SmeltUnknown::Undefined | SmeltUnknown::Symbol(_) | SmeltUnknown::Array(_) | SmeltUnknown::Function(_) | SmeltUnknown::Promise(_) => f64::NAN };
    ...
    _smelt_tmp_12 = match ({ let smelt_function_value = ({ let smelt_receiver = holder.clone(); let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new(move |smelt_args: Vec<SmeltUnknown>| Ok::<SmeltUnknown, Box<dyn std::error::Error>>(SmeltUnknown::String((smelt_receiver.__smelt_symbol_unique_symbol_same_914()).into()))); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Holder::__smelt_symbol_unique_symbol_same_914")); SmeltUnknown::Function(smelt_method) }.clone()); let smelt_call_args: Vec<SmeltUnknown> = Into::into(vec![]); let smelt_callable = match smelt_function_value { SmeltUnknown::Function(smelt_function) => Some(smelt_function), SmeltUnknown::Object(smelt_object) => match smelt_object.get("__smelt_call") { Some(SmeltUnknown::Function(smelt_function)) => Some(smelt_function.clone()), _ => None }, _ => None }; if let Some(smelt_function) = smelt_callable { (smelt_function)(smelt_call_args).unwrap_or_else(|error| smelt_panic_throw(error)) } else { SmeltUnknown::Null } }).clone() { SmeltUnknown::String(value) | SmeltUnknown::Symbol(value) => value.to_string(), SmeltUnknown::Number(value) => value.to_string(), SmeltUnknown::Bool(value) => value.to_string(), SmeltUnknown::Null | SmeltUnknown::Undefined => String::new(), SmeltUnknown::Array(_) | SmeltUnknown::Object(_) => "[object Object]".to_owned(), SmeltUnknown::Function(_) => "function () { [native code] }".to_owned(), SmeltUnknown::Promise(_) => "[object Promise]".to_owned() };
    _smelt_tmp_13 = match ({ let smelt_function_value = ({ let smelt_receiver = holder.clone(); let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new(move |smelt_args: Vec<SmeltUnknown>| Ok::<SmeltUnknown, Box<dyn std::error::Error>>(SmeltUnknown::String((smelt_receiver.__smelt_symbol_unique_symbol_same_945()).into()))); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Holder::__smelt_symbol_unique_symbol_same_945")); SmeltUnknown::Function(smelt_method) }.clone()); let smelt_call_args: Vec<SmeltUnknown> = Into::into(vec![]); let smelt_callable = match smelt_function_value { SmeltUnknown::Function(smelt_function) => Some(smelt_function), SmeltUnknown::Object(smelt_object) => match smelt_object.get("__smelt_call") { Some(SmeltUnknown::Function(smelt_function)) => Some(smelt_function.clone()), _ => None }, _ => None }; if let Some(smelt_function) = smelt_callable { (smelt_function)(smelt_call_args).unwrap_or_else(|error| smelt_panic_throw(error)) } else { SmeltUnknown::Null } }).clone() { SmeltUnknown::String(value) | SmeltUnknown::Symbol(value) => value.to_string(), SmeltUnknown::Number(value) => value.to_string(), SmeltUnknown::Bool(value) => value.to_string(), SmeltUnknown::Null | SmeltUnknown::Undefined => String::new(), SmeltUnknown::Array(_) | SmeltUnknown::Object(_) => "[object Object]".to_owned(), SmeltUnknown::Function(_) => "function () { [native code] }".to_owned(), SmeltUnknown::Promise(_) => "[object Promise]".to_owned() };
...
impl Holder {
    ...
    fn __smelt_get___smelt_symbol_unique_symbol_813(&self) -> f64 {
    return 41.0;
    }
    fn __smelt_symbol_unique_symbol_described_841(&self, offset: f64) -> f64 {
    ...
    fn __smelt_symbol_unique_symbol_same_914(&self) -> String {
    return "a".to_owned();
    }
    fn __smelt_symbol_unique_symbol_same_945(&self) -> String {
    return "b".to_owned();
    }
    ...
    fn __smelt_proto_entries(&self) -> Vec<(String, SmeltUnknown)> {
        ...
        smelt_proto_entries.push(("__smelt_method:__smelt_symbol_unique_symbol_described_841".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.__smelt_symbol_unique_symbol_described_841(SmeltFromUnknown::smelt_from_unknown(smelt_args.get(0).cloned().unwrap_or(SmeltUnknown::Undefined))); Ok(SmeltUnknown::Number(smelt_result as f64)) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Holder::__smelt_symbol_unique_symbol_described_841")); SmeltUnknown::Function(smelt_method) }));
        ...
        smelt_proto_entries.push(("__smelt_method:__smelt_symbol_unique_symbol_same_914".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.__smelt_symbol_unique_symbol_same_914(); Ok(SmeltUnknown::String(smelt_result.into())) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Holder::__smelt_symbol_unique_symbol_same_914")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries.push(("__smelt_method:__smelt_symbol_unique_symbol_same_945".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.__smelt_symbol_unique_symbol_same_945(); Ok(SmeltUnknown::String(smelt_result.into())) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Holder::__smelt_symbol_unique_symbol_same_945")); SmeltUnknown::Function(smelt_method) }));
