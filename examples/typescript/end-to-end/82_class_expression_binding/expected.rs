...
fn main() {
    ...
    _smelt_tmp_16 = _smelt_tmp_15.to_string();
    ...
    _smelt_tmp_20 = _smelt_tmp_19.borrow().get({ let normalized = 0.0 as i64; usize::try_from(normalized).unwrap_or(usize::MAX) }).cloned().unwrap_or_else(|| 0.0).to_string();
