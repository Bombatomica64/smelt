...
struct RouterInner {
    log: String,
    pick: ::std::rc::Rc<dyn Fn(String) -> String>,
}
impl Default for RouterInner {
    fn default() -> Self {
        Self {
            log: String::new(),
            pick: { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> String> = ::std::rc::Rc::new(move |arg0: String| -> String { String::new() }); smelt_default_callback },
        }
    }
}
...
impl IntoSmeltUnknown for Router {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        ...
        ("log".to_owned(), SmeltUnknown::String((__smelt_inner.log.clone()).into())),
        ("pick".to_owned(), SmeltUnknown::Null),
        ]);
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let first: String;
    let second: String;
    let _smelt_tmp_3: Router = Router::new();
    router = _smelt_tmp_3;
    let _smelt_tmp_4: String = router.route("a".to_owned())?;
    first = _smelt_tmp_4;
    let _smelt_tmp_5: String = router.route("b".to_owned())?;
    second = _smelt_tmp_5;
    let _ = { println!("{}", first); };
    let _ = { println!("{}", second); };
    let _ = { println!("{}", router.0.borrow().log.clone()); };
    return Ok(());
}

impl Router {
    fn new() -> Self {
    let mut this: Self = Router(::std::rc::Rc::new(::std::cell::RefCell::new(RouterInner { log: String::new(), pick: { let smelt_default_callback: ::std::rc::Rc<dyn Fn(String) -> String> = ::std::rc::Rc::new(move |arg0: String| -> String { String::new() }); smelt_default_callback } })));
    this.0.borrow_mut().log = "".to_owned();
    let _smelt_tmp_1 = ::std::rc::Rc::new(|closure_arg_0: String| {
    let _smelt_tmp_1: String = "slow:".to_owned() + &closure_arg_0.clone();
    _smelt_tmp_1.clone()
    });
    this.0.borrow_mut().pick = _smelt_tmp_1.clone();
    return this;
    }
    fn describe(&self, path: String) -> String {
    let _smelt_tmp_2: String = "[".to_owned() + &path.clone();
    let _smelt_tmp_3: String = _smelt_tmp_2 + &"]".to_owned();
    return _smelt_tmp_3;
    }
    fn route(&self, path: String) -> Result<String, Box<dyn std::error::Error>> {
    let _smelt_tmp_8: String;
    let _smelt_tmp_9: String;
    let _smelt_tmp_10: String;
    let _smelt_tmp_4: String = { let smelt_callable = ::std::clone::Clone::clone(&self.0.borrow().pick.clone()); (smelt_callable)(path.clone()) };
    let before: String = _smelt_tmp_4;
    let _smelt_tmp_5 = ::std::rc::Rc::new(|closure_arg_0: String| {
    let _smelt_tmp_1: String = "fast:".to_owned() + &closure_arg_0.clone();
    _smelt_tmp_1.clone()
    });
    self.0.borrow_mut().pick = _smelt_tmp_5.clone();
    let _smelt_tmp_6: String = { let smelt_callable = ::std::clone::Clone::clone(&self.0.borrow().pick.clone()); (smelt_callable)(path.clone()) };
    let after: String = _smelt_tmp_6;
    let _smelt_tmp_7: String = self.describe(path.clone());
    _smelt_tmp_8 = self.0.borrow().log.clone().clone() + &_smelt_tmp_7;
    self.0.borrow_mut().log = _smelt_tmp_8;
    _smelt_tmp_9 = before + &",".to_owned();
    _smelt_tmp_10 = _smelt_tmp_9 + &after;
    return Ok(_smelt_tmp_10);
    }
    ...
    fn __smelt_proto_entries(&self) -> Vec<(String, SmeltUnknown)> {
        ...
        smelt_proto_entries.push(("__smelt_method:route".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.route(SmeltFromUnknown::smelt_from_unknown(smelt_args.get(0).cloned().unwrap_or(SmeltUnknown::Undefined)))?; Ok(SmeltUnknown::String(smelt_result.into())) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Router::route")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries
    }
}
