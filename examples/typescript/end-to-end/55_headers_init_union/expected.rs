...
fn main() {
    ...
    let _smelt_tmp_16: SmeltRecord<String, String>;
    let _smelt_tmp_17: InitLike;
    let _smelt_tmp_20: InitLike;
    let _smelt_tmp_23: SmeltList<String>;
    let _smelt_tmp_24: SmeltList<SmeltList<String>>;
    let _smelt_tmp_25: SmeltHeaders;
    let _smelt_tmp_26: SmeltHeaders;
    let _smelt_tmp_27: ();
    let _smelt_tmp_28: Option<String>;
    let _smelt_tmp_30: Option<String>;
    let _smelt_tmp_32: (String, String);
    let _smelt_tmp_33: (String, String);
    let _smelt_tmp_34: SmeltList<(String, String)>;
    let _smelt_tmp_4: (String, String) = ("content-type".to_owned(), "text/html".to_owned());
    let _smelt_tmp_5: SmeltList<(String, String)> = Into::<SmeltList<_>>::into(SmeltList::from({ let smelt_list_items: Vec<(String, String)> = vec![_smelt_tmp_4.clone()]; smelt_list_items }));
    let html_pairs: SmeltList<(String, String)> = Into::<SmeltList<_>>::into(_smelt_tmp_5);
    let _smelt_tmp_6: SmeltRecord<String, String> = SmeltRecord::from([("Content-Type".to_owned(), "text/plain".to_owned())]);
    let _smelt_tmp_7: String = content_type_of(SmeltUnion5::M1(_smelt_tmp_6));
    let _ = { println!("{}", _smelt_tmp_7); };
    let _smelt_tmp_9: String = content_type_of(SmeltUnion5::M0(html_pairs));
    ...
    _smelt_tmp_16 = SmeltRecord::from([("a".to_owned(), "1".to_owned()), ("b".to_owned(), "2".to_owned())]);
    _smelt_tmp_17 = InitLike { headers: Some(SmeltUnion5::M1(_smelt_tmp_16)) };
    let _smelt_tmp_18: String = first_header(_smelt_tmp_17);
    let _ = { println!("{}", _smelt_tmp_18); };
    _smelt_tmp_20 = InitLike { headers: None::<SmeltUnion5> };
    let _smelt_tmp_21: String = first_header(_smelt_tmp_20);
    let _ = { println!("{}", _smelt_tmp_21); };
    _smelt_tmp_23 = Into::<SmeltList<_>>::into(SmeltList::from({ let smelt_list_items: Vec<String> = vec!["x-shared".to_owned(), "original".to_owned()]; smelt_list_items }));
    _smelt_tmp_24 = Into::<SmeltList<_>>::into(SmeltList::from({ let smelt_list_items: Vec<SmeltList<String>> = vec![_smelt_tmp_23.clone()]; smelt_list_items }));
    _smelt_tmp_25 = SmeltHeaders::from_pairs(_smelt_tmp_24.to_vec().into_iter().filter_map(|smelt_pair| { let smelt_pair = smelt_pair.to_vec(); Some((smelt_pair.first()?.clone(), smelt_pair.get(1)?.clone())) }).collect::<Vec<(String, String)>>());
    source = _smelt_tmp_25;
    _smelt_tmp_26 = SmeltHeaders::from_pairs(source.clone().entries_sorted());
    copy = _smelt_tmp_26;
    _smelt_tmp_27 = copy.clone().set(&"x-shared".to_owned(), &"changed".to_owned());
    _smelt_tmp_28 = source.get(&"x-shared".to_owned());
    let _ = { println!("{}", match &_smelt_tmp_28 { Some(value) => format!("{}", value), None => "undefined".to_owned() }); };
    _smelt_tmp_30 = copy.get(&"x-shared".to_owned());
    let _ = { println!("{}", match &_smelt_tmp_30 { Some(value) => format!("{}", value), None => "undefined".to_owned() }); };
    _smelt_tmp_32 = ("content-type".to_owned(), "text/plain".to_owned());
    _smelt_tmp_33 = ("content-type".to_owned(), "text/css".to_owned());
    _smelt_tmp_34 = Into::<SmeltList<_>>::into(SmeltList::from({ let smelt_list_items: Vec<(String, String)> = vec![_smelt_tmp_32.clone(), _smelt_tmp_33.clone()]; smelt_list_items }));
    two_values = Into::<SmeltList<_>>::into(_smelt_tmp_34);
    let _smelt_tmp_35: String = content_type_of(SmeltUnion5::M0(two_values));
