...
fn main() {
    ...
    _smelt_tmp_75 = _smelt_tmp_74 + &smelt_number_to_string(value_3);
    ...
    let _ = { println!("{}", smelt_console_number(map_size)); };
    return;
}
