...
impl IntoSmeltUnknown for SmeltUnion3 {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        match self {
            ...
            Self::M2(value) => { let smelt_record = value.clone(); SmeltUnknown::Object(SmeltObject::with_id(smelt_record.id, smelt_record.iter().map(|(key, value)| (key, SmeltUnknown::Number(value as f64))).collect())) },
        }
    }
}
impl SmeltUnion3 {
    fn from_smelt_unknown(value: SmeltUnknown) -> Self {
        ...
        if matches!(value, SmeltUnknown::String(_)) { return Self::M1(match value.clone() { SmeltUnknown::String(value) | SmeltUnknown::Symbol(value) => value.to_string(), SmeltUnknown::Number(value) => smelt_number_to_string(value), SmeltUnknown::Bool(value) => value.to_string(), SmeltUnknown::Null | SmeltUnknown::Undefined => String::new(), SmeltUnknown::Array(_) | SmeltUnknown::Object(_) => "[object Object]".to_owned(), SmeltUnknown::Function(_) => "function () { [native code] }".to_owned(), SmeltUnknown::Promise(_) => "[object Promise]".to_owned() }); }
        Self::M2(match (value).into_smelt_unknown() { SmeltUnknown::Object(values) => SmeltRecord::with_id_from_entries(values.id, values.into_iter().map(|(key, value)| (key, match value.clone() { SmeltUnknown::Number(value) => value, SmeltUnknown::Object(value) => match value.get("__smelt_date") { Some(SmeltUnknown::Number(value)) => value, _ => f64::NAN }, SmeltUnknown::String(value) => value.parse::<f64>().unwrap_or(f64::NAN), SmeltUnknown::Bool(value) => if value { 1.0 } else { 0.0 }, SmeltUnknown::Null | SmeltUnknown::Undefined | SmeltUnknown::Symbol(_) | SmeltUnknown::Array(_) | SmeltUnknown::Function(_) | SmeltUnknown::Promise(_) => f64::NAN }))), SmeltUnknown::Array(values) => values.into_iter().enumerate().map(|(index, value)| (index.to_string(), match value.clone() { SmeltUnknown::Number(value) => value, SmeltUnknown::Object(value) => match value.get("__smelt_date") { Some(SmeltUnknown::Number(value)) => value, _ => f64::NAN }, SmeltUnknown::String(value) => value.parse::<f64>().unwrap_or(f64::NAN), SmeltUnknown::Bool(value) => if value { 1.0 } else { 0.0 }, SmeltUnknown::Null | SmeltUnknown::Undefined | SmeltUnknown::Symbol(_) | SmeltUnknown::Array(_) | SmeltUnknown::Function(_) | SmeltUnknown::Promise(_) => f64::NAN })).collect(), SmeltUnknown::String(value) => value.chars().enumerate().map(|(index, ch)| { let value = SmeltUnknown::String(ch.to_string().into()); (index.to_string(), match value.clone() { SmeltUnknown::Number(value) => value, SmeltUnknown::Object(value) => match value.get("__smelt_date") { Some(SmeltUnknown::Number(value)) => value, _ => f64::NAN }, SmeltUnknown::String(value) => value.parse::<f64>().unwrap_or(f64::NAN), SmeltUnknown::Bool(value) => if value { 1.0 } else { 0.0 }, SmeltUnknown::Null | SmeltUnknown::Undefined | SmeltUnknown::Symbol(_) | SmeltUnknown::Array(_) | SmeltUnknown::Function(_) | SmeltUnknown::Promise(_) => f64::NAN }) }).collect(), _ => SmeltRecord::new() })
    }
}
...
fn main() {
    let counts: SmeltRecord<String, f64>;
    let ratios: SmeltList<f64>;
    let _smelt_tmp_6: SmeltRecord<String, f64>;
    let _smelt_tmp_9: SmeltRecord<String, f64>;
    ...
    let _smelt_tmp_25: SmeltList<f64>;
    let _smelt_tmp_26: String;
    let _smelt_tmp_28: String;
    let _smelt_tmp_30: String;
    let _smelt_tmp_32: String;
    let _smelt_tmp_2: String = encode(SmeltUnion3::M0(7.0));
    let _ = { println!("{}", _smelt_tmp_2); };
    let _smelt_tmp_4: String = encode(SmeltUnion3::M1("seven".to_owned()));
    let _ = { println!("{}", _smelt_tmp_4); };
    _smelt_tmp_6 = SmeltRecord::from([("a".to_owned(), 1.0), ("b".to_owned(), 2.5)]);
    let _smelt_tmp_7: String = encode(SmeltUnion3::M2(_smelt_tmp_6));
    let _ = { println!("{}", _smelt_tmp_7); };
    _smelt_tmp_9 = SmeltRecord::from([("hits".to_owned(), 3.0), ("ratio".to_owned(), 0.5)]);
    counts = _smelt_tmp_9;
    _smelt_tmp_10 = serde_json::to_string(&{ let smelt_record = counts.clone(); SmeltUnknown::Object(SmeltObject::with_id(smelt_record.id, smelt_record.iter().map(|(key, value)| (key, SmeltUnknown::Number(value as f64))).collect())) }).expect("JSON serialization failed");
    let _ = { println!("{}", _smelt_tmp_10); };
    _smelt_tmp_12 = serde_json::to_string(&SmeltUnknown::Number(4.0 as f64)).expect("JSON serialization failed");
    let _ = { println!("{}", _smelt_tmp_12); };
    _smelt_tmp_14 = -0.0;
    _smelt_tmp_15 = serde_json::to_string(&SmeltUnknown::Number(_smelt_tmp_14 as f64)).expect("JSON serialization failed");
    let _ = { println!("{}", _smelt_tmp_15); };
    _smelt_tmp_17 = 0.0 / 0.0;
    _smelt_tmp_18 = serde_json::to_string(&SmeltUnknown::Number(_smelt_tmp_17 as f64)).expect("JSON serialization failed");
    let _ = { println!("{}", _smelt_tmp_18); };
    _smelt_tmp_20 = serde_json::to_string(&SmeltUnknown::Number(1000000000000000000000.0 as f64)).expect("JSON serialization failed");
    let _ = { println!("{}", _smelt_tmp_20); };
    _smelt_tmp_22 = 1.0 / 3.0;
    _smelt_tmp_23 = serde_json::to_string(&SmeltUnknown::Number(_smelt_tmp_22 as f64)).expect("JSON serialization failed");
    let _ = { println!("{}", _smelt_tmp_23); };
    _smelt_tmp_25 = Into::<SmeltList<_>>::into(SmeltList::from({ let smelt_list_items: Vec<f64> = vec![1.0, 2.5, 1000000000000000000000.0]; smelt_list_items }));
    ratios = Into::<SmeltList<_>>::into(_smelt_tmp_25);
    _smelt_tmp_26 = serde_json::to_string(&{ let smelt_l = ratios; let smelt_id = smelt_l.id(); let smelt_values: Vec<_> = smelt_l.into(); SmeltUnknown::Array(SmeltArray::with_id(smelt_id, smelt_values.into_iter().map(|value| SmeltUnknown::Number(value as f64)).collect::<Vec<_>>())) }).expect("JSON serialization failed");
    let _ = { println!("{}", _smelt_tmp_26); };
    _smelt_tmp_28 = serde_json::to_string(&SmeltUnknown::String("seven".into())).expect("JSON serialization failed");
    let _ = { println!("{}", _smelt_tmp_28); };
    _smelt_tmp_30 = serde_json::to_string(&SmeltUnknown::Bool(true)).expect("JSON serialization failed");
    let _ = { println!("{}", _smelt_tmp_30); };
    _smelt_tmp_32 = serde_json::to_string(&SmeltUnknown::Null).expect("JSON serialization failed");
...
pub(crate) fn encode(value: SmeltUnion3) -> String {
    let _smelt_tmp_1: String = serde_json::to_string(&value.clone().into_smelt_unknown()).expect("JSON serialization failed");
    return _smelt_tmp_1;
}
