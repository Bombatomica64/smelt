...
impl<T, U, V> ::std::fmt::Debug for Slot<T, U, V> {
    fn fmt(&self, formatter: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        formatter.debug_struct("Slot").finish_non_exhaustive()
    }
}
impl<T, U, V> Clone for Slot<T, U, V> where T: Clone, U: Clone, V: Clone {
    fn clone(&self) -> Self {
        Slot {
...
impl<T, U, V> PartialEq for Slot<T, U, V> where T: PartialEq, U: PartialEq, V: PartialEq {
    fn eq(&self, other: &Self) -> bool {
        self.first == other.first && self.second == other.second && self.third == other.third
    }
}
impl<T: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static, U: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static, V: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> IntoSmeltUnknown for Slot<T, U, V> {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        SmeltUnknown::Object(SmeltObject::new(Vec::from([
        ("first".to_owned(), (self.first).into_smelt_unknown()),
        ("second".to_owned(), (self.second).into_smelt_unknown()),
        ("third".to_owned(), (self.third).into_smelt_unknown()),
        ])))
    }
}
impl<T: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static, U: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static, V: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> SmeltFromUnknown for Slot<T, U, V> {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self {
        let mut result = Self::default();
        if let SmeltUnknown::Object(object) = value {
            if let Some(field) = object.get("first") {
                result.first = SmeltFromUnknown::smelt_from_unknown(field);
            }
            if let Some(field) = object.get("second") {
                result.second = SmeltFromUnknown::smelt_from_unknown(field);
            }
            if let Some(field) = object.get("third") {
                result.third = SmeltFromUnknown::smelt_from_unknown(field);
            }
        }
        result
    }
...
struct Holder {
    slot: Slot<bool, String, f64>,
}
impl IntoSmeltUnknown for Holder {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        SmeltUnknown::Object(SmeltObject::new(Vec::from([
        ("slot".to_owned(), (self.slot).into_smelt_unknown()),
        ])))
    }
}
impl SmeltFromUnknown for Holder {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self {
        let mut result = Self::default();
        if let SmeltUnknown::Object(object) = value {
            if let Some(field) = object.get("slot") {
                result.slot = SmeltFromUnknown::smelt_from_unknown(field);
            }
        }
        result
    }
...
impl<A, B> ::std::fmt::Debug for Config<A, B> {
    fn fmt(&self, formatter: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        formatter.debug_struct("Config").finish_non_exhaustive()
    }
}
impl<A, B> Clone for Config<A, B> where A: Clone, B: Clone {
    fn clone(&self) -> Self {
        Config {
            key: self.key.clone(),
...
impl<A, B> PartialEq for Config<A, B> where A: PartialEq, B: PartialEq {
    fn eq(&self, other: &Self) -> bool {
        self.key == other.key && self.value == other.value
    }
}
impl<A: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static, B: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> IntoSmeltUnknown for Config<A, B> {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        SmeltUnknown::Object(SmeltObject::new(Vec::from([
        ("key".to_owned(), (self.key).into_smelt_unknown()),
        ("value".to_owned(), (self.value).into_smelt_unknown()),
        ])))
    }
}
impl<A: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static, B: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> SmeltFromUnknown for Config<A, B> {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self {
        let mut result = Self::default();
        if let SmeltUnknown::Object(object) = value {
            if let Some(field) = object.get("key") {
                result.key = SmeltFromUnknown::smelt_from_unknown(field);
            }
...
impl<A, B> PartialEq for Pair<A, B> where A: PartialEq, B: PartialEq {
    fn eq(&self, other: &Self) -> bool {
        self.head == other.head && self.rest == other.rest
    }
}
impl<A: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static, B: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> IntoSmeltUnknown for Pair<A, B> {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        SmeltUnknown::Object(SmeltObject::new(Vec::from([
        ("head".to_owned(), (self.head).into_smelt_unknown()),
        ("rest".to_owned(), (self.rest).into_smelt_unknown()),
        ])))
    }
}
impl<A: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static, B: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> SmeltFromUnknown for Pair<A, B> {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self {
        let mut result = Self::default();
        if let SmeltUnknown::Object(object) = value {
            if let Some(field) = object.get("head") {
                result.head = SmeltFromUnknown::smelt_from_unknown(field);
            }
            if let Some(field) = object.get("rest") {
                result.rest = SmeltFromUnknown::smelt_from_unknown(field);
            }
        }
        result
    }
...
fn main() {
    let holder: Holder;
    let relabelled: Slot<bool, String, f64>;
    let config: Config<String, f64>;
    let pair: Pair<bool, SmeltList<bool>>;
    let _smelt_tmp_7: Slot<bool, String, f64>;
    let _smelt_tmp_19: SmeltList<bool>;
    let _smelt_tmp_22: f64;
    let _smelt_tmp_4: Slot<bool, String, f64> = Slot::new(true, "one".to_owned(), 1.0);
    let _smelt_tmp_5: Holder = Holder::new(_smelt_tmp_4);
    holder = _smelt_tmp_5;
    let _smelt_tmp_6: String = holder.describe();
    _smelt_tmp_7 = holder.slot.clone();
    let _ = { println!("{} {}", _smelt_tmp_6, _smelt_tmp_7.first); };
    let _smelt_tmp_9: Slot<bool, String, f64> = relabel(holder.slot.clone(), "two".to_owned());
    relabelled = _smelt_tmp_9;
    let _smelt_tmp_10: String = relabelled.label();
    let _smelt_tmp_11: f64 = relabelled.count();
    let _ = { println!("{} {} {}", _smelt_tmp_10, smelt_console_number(_smelt_tmp_11), relabelled.first); };
    let _smelt_tmp_13: Config<String, f64> = Config::new("width".to_owned(), 42.0);
    config = _smelt_tmp_13;
    let _smelt_tmp_14: String = config.name();
    let _smelt_tmp_15: f64 = config.amount();
    let _ = { println!("{} {}", _smelt_tmp_14, smelt_console_number(_smelt_tmp_15)); };
    let _smelt_tmp_17: String = read_config(config);
    let _ = { println!("{}", _smelt_tmp_17); };
    _smelt_tmp_19 = Into::<SmeltList<_>>::into(SmeltList::from({ let smelt_list_items: Vec<bool> = vec![false, true]; smelt_list_items }));
    let _smelt_tmp_20: Pair<bool, SmeltList<bool>> = Pair::new(true, _smelt_tmp_19);
    pair = _smelt_tmp_20;
...
impl<T: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static, U: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static, V: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> Slot<T, U, V> {
    fn new(first: T, second: U, third: V) -> Self {
    let mut this: Self = Slot { first: Default::default(), second: Default::default(), third: Default::default(), _smelt_phantom: ::std::marker::PhantomData };
    ...
    fn __smelt_proto_entries(&self) -> Vec<(String, SmeltUnknown)> {
        ...
        smelt_proto_entries.push(("__smelt_method:label".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.label(); Ok((smelt_result).into_smelt_unknown()) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Slot::label")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries.push(("__smelt_method:count".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.count(); Ok((smelt_result).into_smelt_unknown()) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Slot::count")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries
    }
}

impl Holder {
    fn new(slot: Slot<bool, String, f64>) -> Self {
    let mut this: Self = Holder { slot: Default::default() };
    ...
    let _smelt_tmp_5: Slot<bool, String, f64>;
    let _smelt_tmp_7: f64;
    let _smelt_tmp_8: String;
    let _smelt_tmp_1: Slot<bool, String, f64> = self.slot.clone();
    let _smelt_tmp_2: String = self.slot.label();
    _smelt_tmp_3 = _smelt_tmp_2.to_uppercase();
    _smelt_tmp_4 = _smelt_tmp_3 + &":".to_owned();
    _smelt_tmp_5 = self.slot.clone();
    let _smelt_tmp_6: f64 = self.slot.count();
    _smelt_tmp_7 = _smelt_tmp_6 + 1.0;
    _smelt_tmp_8 = _smelt_tmp_4 + &smelt_number_to_string(_smelt_tmp_7);
    return _smelt_tmp_8;
    }
    /// Prototype-carried members of this class, as receiver-bound erased functions.
    ///
    ...
    fn __smelt_proto_entries(&self) -> Vec<(String, SmeltUnknown)> {
        let mut smelt_proto_entries: Vec<(String, SmeltUnknown)> = Vec::new();
        smelt_proto_entries.push(("__smelt_method:describe".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.describe(); Ok(SmeltUnknown::String(smelt_result.into())) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Holder::describe")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries
    }
}

impl<A: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static, B: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> Config<A, B> {
    fn new(key: A, value: B) -> Self {
    let mut this: Self = Config { key: Default::default(), value: Default::default(), _smelt_phantom: ::std::marker::PhantomData };
    this.key = key.clone();
    ...
    fn __smelt_proto_entries(&self) -> Vec<(String, SmeltUnknown)> {
        let mut smelt_proto_entries: Vec<(String, SmeltUnknown)> = Vec::new();
        smelt_proto_entries.push(("__smelt_method:name".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.name(); Ok((smelt_result).into_smelt_unknown()) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Config::name")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries.push(("__smelt_method:amount".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.amount(); Ok((smelt_result).into_smelt_unknown()) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Config::amount")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries
    }
}

impl<A: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static, B: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> Pair<A, B> {
    fn new(head: A, rest: B) -> Self {
    let mut this: Self = Pair { head: Default::default(), rest: Default::default(), _smelt_phantom: ::std::marker::PhantomData };
    ...
    fn __smelt_proto_entries(&self) -> Vec<(String, SmeltUnknown)> {
        let mut smelt_proto_entries: Vec<(String, SmeltUnknown)> = Vec::new();
        smelt_proto_entries.push(("__smelt_method:tail".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.tail(); Ok((smelt_result).into_smelt_unknown()) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Pair::tail")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries
    }
}
...
pub(crate) fn relabel(slot: Slot<bool, String, f64>, label: String) -> Slot<bool, String, f64> {
    let _smelt_tmp_3: f64;
    let _smelt_tmp_2: f64 = slot.count();
    _smelt_tmp_3 = _smelt_tmp_2 * 2.0;
    let _smelt_tmp_4: Slot<bool, String, f64> = Slot::new(slot.first, label.clone(), _smelt_tmp_3);
    return _smelt_tmp_4;
}

pub(crate) fn read_config(input: Config<String, f64>) -> String {
    let _smelt_tmp_2: String;
    let _smelt_tmp_4: String;
    let _smelt_tmp_1: String = input.name();
    _smelt_tmp_2 = _smelt_tmp_1 + &"=".to_owned();
    let _smelt_tmp_3: f64 = input.amount();
    _smelt_tmp_4 = _smelt_tmp_2 + &smelt_number_to_string(_smelt_tmp_3);
    return _smelt_tmp_4;
}
