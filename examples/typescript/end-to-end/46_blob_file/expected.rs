...
smelt_local.block_on(&smelt_runtime, async move {
    ...
    let _ = { println!("{} {} {}", _smelt_tmp_33, _smelt_tmp_34, _smelt_tmp_35); };
    _smelt_tmp_37 = -5.0;
    ...
    let _ = { println!("{} {} {}", _smelt_tmp_74, _smelt_tmp_75, _smelt_tmp_77); };
