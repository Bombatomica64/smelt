...
struct HTTPExceptionOptions {
    message: Option<String>,
}
impl IntoSmeltUnknown for HTTPExceptionOptions {
    fn into_smelt_unknown(self) -> SmeltUnknown {
...
impl SmeltFromUnknown for HTTPExceptionOptions {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self {
...
impl IntoSmeltUnknown for HTTPException {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        SmeltUnknown::Object(SmeltObject::new(Vec::from([
...
impl SmeltFromUnknown for HTTPException {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self {
        let mut result = Self::default();
        if let SmeltUnknown::Object(object) = value {
...
impl IntoSmeltUnknown for GatewayError {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        SmeltUnknown::Object(SmeltObject::new(Vec::from([
        ("name".to_owned(), SmeltUnknown::String(self.name.into())),
        ("message".to_owned(), SmeltUnknown::String(self.message.into())),
...
impl SmeltFromUnknown for GatewayError {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self {
        let mut result = Self::default();
        if let SmeltUnknown::Object(object) = value {
            if let Some(field) = object.get("name") {
...
fn main() {
    let described: HTTPException;
    let bare: HTTPException;
    let gateway: GatewayError;
    let _smelt_tmp_7: String;
    let _smelt_tmp_10: String;
    let _smelt_tmp_3: SmeltRecord<String, String> = SmeltRecord::from([("message".to_owned(), "not found".to_owned())]);
    let _smelt_tmp_4: HTTPException = HTTPException::new(404.0, Some({ let smelt_record_map = _smelt_tmp_3.clone(); HTTPExceptionOptions { message: smelt_record_map.get("message").cloned().map(|value| value) } }));
    described = _smelt_tmp_4;
    let _ = { println!("{} {} {}", smelt_console_number(described.status), described.message.clone(), described.name.clone()); };
    ...
    let _ = { println!("{} {}", smelt_console_number(bare.status), _smelt_tmp_7); };
    ...
    let _ = { println!("{} {}", smelt_console_number(gateway.status), _smelt_tmp_10); };
    return;
}

impl HTTPException {
    fn new(status: f64, options: Option<HTTPExceptionOptions>) -> Self {
    let mut this: Self = HTTPException { name: String::new(), message: String::new(), stack: None::<String>, cause: SmeltUnknown::Null, status: 0.0 };
