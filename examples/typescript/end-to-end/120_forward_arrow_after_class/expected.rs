...
struct Request {
    headers: SmeltRecord<String, String>,
}
impl IntoSmeltUnknown for Request {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        SmeltUnknown::Object(SmeltObject::new(Vec::from([
        ("headers".to_owned(), SmeltUnknown::Object(SmeltObject::new(self.headers.into_iter().map(|(key, value)| (key, SmeltUnknown::String(value.into()))).collect()))),
        ])))
    }
}
impl SmeltFromUnknown for Request {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self {
        let mut result = Self::default();
        if let SmeltUnknown::Object(object) = value {
            if let Some(field) = object.get("headers") {
                result.headers = SmeltFromUnknown::smelt_from_unknown(field);
            }
        }
        result
    }
...
smelt_local.block_on(&smelt_runtime, async move {
    ...
    let _smelt_tmp_9: ();
    let _smelt_tmp_1: Request = Request::new();
    req = _smelt_tmp_1;
    let _smelt_tmp_2 = SmeltFuture::from_future(Box::pin(report(req.clone())));
    _smelt_tmp_3 = _smelt_tmp_2.await?;
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_3)); };
    let _smelt_tmp_5 = SmeltFuture::from_future(Box::pin(without_length(req, false)));
    _smelt_tmp_6 = _smelt_tmp_5.await?;
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_6)); };
    let _smelt_tmp_8: SmeltFuture<()> = SmeltFuture::from_future(Box::pin(async move { smelt_run_until_exit().await; Ok::<_, Box<dyn std::error::Error>>(()) }));
...
impl Request {
    fn new() -> Self {
    let mut this: Self = Request { headers: SmeltRecord::new() };
    let _smelt_tmp_1: SmeltRecord<String, String> = SmeltRecord::from([("content-length".to_owned(), "12".to_owned()), ("accept".to_owned(), "json".to_owned())]);
    this.headers = _smelt_tmp_1;
    return this;
    }
    fn all(&self) -> SmeltRecord<String, String> {
    let _smelt_tmp_1: SmeltRecord<String, String> = SmeltRecord::from([]);
    let _smelt_tmp_2: SmeltRecord<String, String> = { _smelt_tmp_1.extend(self.headers.clone().iter().map(|(key, value)| (key.clone(), value.clone()))); _smelt_tmp_1.clone() };
    return _smelt_tmp_2;
    }
    ...
    fn __smelt_proto_entries(&self) -> Vec<(String, SmeltUnknown)> {
        ...
        smelt_proto_entries.push(("__smelt_method:all".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.all(); Ok(SmeltUnknown::Object(SmeltObject::new(smelt_result.into_iter().map(|(key, value)| (key, SmeltUnknown::String(value.into()))).collect()))) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Request::all")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries.push(("__smelt_method:header".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.header(SmeltFromUnknown::smelt_from_unknown(smelt_args.get(0).cloned().unwrap_or(SmeltUnknown::Undefined))); Ok(smelt_result.map_or(SmeltUnknown::Undefined, |value| SmeltUnknown::String(value.into()))) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Request::header")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries
    }
}
...
pub(crate) async fn report(req: Request) -> Result<f64, Box<dyn std::error::Error>> {
    let _smelt_tmp_1 = SmeltFuture::from_future(Box::pin(without_length(req.clone(), true)));
    let smelt_adopted = _smelt_tmp_1.await?;
    return Ok(smelt_adopted);
}

pub(crate) async fn without_length(req: Request, strip: bool) -> Result<f64, Box<dyn std::error::Error>> {
    let mut headers: SmeltRecord<String, String>;
    let _smelt_tmp_4: bool;
    let _smelt_tmp_6: String;
    let _smelt_tmp_8: SmeltList<String>;
    let _smelt_tmp_9: f64;
    let _smelt_tmp_3: SmeltRecord<String, String> = req.all();
    headers = _smelt_tmp_3;
    if strip {
    _smelt_tmp_4 = headers.remove(&"content-length".to_owned()).is_some();
    }
    let _smelt_tmp_5: Option<String> = req.header("accept".to_owned());
    _smelt_tmp_6 = _smelt_tmp_5.clone().unwrap_or("none".to_owned());
    let _ = { println!("{}", _smelt_tmp_6); };
    _smelt_tmp_8 = Into::<SmeltList<_>>::into(headers.keys().filter(|key| !key.starts_with("__smelt_symbol") && smelt_is_for_in_record_key(&headers, key)).collect::<Vec<_>>());
    _smelt_tmp_9 = _smelt_tmp_8.len() as f64;
    return Ok(_smelt_tmp_9);
}
