...
struct InitLike<T> {
    headers: Option<SmeltUnion6>,
    status: Option<T>,
    _smelt_phantom: ::std::marker::PhantomData<(T)>,
}
impl<T: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> IntoSmeltUnknown for InitLike<T> {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        ...
        ("status".to_owned(), self.status.map_or(SmeltUnknown::Undefined, |value| (value).into_smelt_unknown())),
        ])))
    }
}
impl<T: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> SmeltFromUnknown for InitLike<T> {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self {
...
#[derive(Clone)]
pub enum SmeltUnion6 {
    M0(SmeltList<(String, String)>),
    M1(SmeltRecord<String, String>),
    M2(SmeltHeaders),
}
impl IntoSmeltUnknown for SmeltUnion6 {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        match self {
...
impl ::std::fmt::Debug for SmeltUnion6 {
    fn fmt(&self, formatter: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::std::fmt::Debug::fmt(&self.clone().into_smelt_unknown(), formatter)
    }
}
impl Default for SmeltUnion6 {
    fn default() -> Self {
...
#[derive(Clone)]
pub enum SmeltUnion10<T> {
    M0(InitLike<T>),
    M1(SmeltResponse),
}
impl<T: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> IntoSmeltUnknown for SmeltUnion10<T> {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        match self {
            Self::M0(value) => { let smelt_object_value = value; let smelt_struct_value = smelt_object_value.clone(); let mut smelt_object_entries = Vec::new(); if let Some(value) = smelt_object_value.headers.clone() { smelt_object_entries.push(("headers".to_owned(), value.into_smelt_unknown())); } if let Some(value) = smelt_object_value.status.clone() { smelt_object_entries.push(("status".to_owned(), (value).into_smelt_unknown())); } SmeltUnknown::Object(SmeltObject::new(smelt_object_entries)) },
            Self::M1(value) => value.clone().into_smelt_unknown(),
        }
    }
}
impl<T: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> SmeltUnion10<T> {
    fn from_smelt_unknown(value: SmeltUnknown) -> Self {
        if matches!(value, SmeltUnknown::Object(_)) { return Self::M0(<InitLike<T> as SmeltFromUnknown>::smelt_from_unknown(value)); }
        Self::M1(<SmeltResponse as SmeltFromUnknown>::smelt_from_unknown(value.clone()))
    }
}
impl<T: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> PartialEq for SmeltUnion10<T> {
    fn eq(&self, other: &Self) -> bool {
        self.clone().into_smelt_unknown() == other.clone().into_smelt_unknown()
    }
}
impl<T: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> SmeltFromUnknown for SmeltUnion10<T> {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self { Self::from_smelt_unknown(value) }
}
impl<T: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> SmeltJsKeyEq for SmeltUnion10<T> {
    fn same_js_key(&self, other: &Self) -> bool { self.clone().into_smelt_unknown().same_js_key(&other.clone().into_smelt_unknown()) }
    fn js_key_hash(&self) -> Option<u64> { self.clone().into_smelt_unknown().js_key_hash() }
}
impl<T: Clone + Default + IntoSmeltUnknown + SmeltFromUnknown + 'static> ::std::fmt::Debug for SmeltUnion10<T> {
    fn fmt(&self, formatter: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::std::fmt::Debug::fmt(&self.clone().into_smelt_unknown(), formatter)
    }
}
...
#[derive(Clone)]
pub enum SmeltUnion16 {
    M0(SmeltResponse),
    M1(InitLike<f64>),
}
impl IntoSmeltUnknown for SmeltUnion16 {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        match self {
            Self::M0(value) => value.clone().into_smelt_unknown(),
            Self::M1(value) => { let smelt_object_value = value; let smelt_struct_value = smelt_object_value.clone(); let mut smelt_object_entries = Vec::new(); if let Some(value) = smelt_object_value.headers.clone() { smelt_object_entries.push(("headers".to_owned(), value.into_smelt_unknown())); } if let Some(value) = smelt_object_value.status.clone() { smelt_object_entries.push(("status".to_owned(), (value).into_smelt_unknown())); } SmeltUnknown::Object(SmeltObject::new(smelt_object_entries)) },
        }
    }
}
impl SmeltUnion16 {
    fn from_smelt_unknown(value: SmeltUnknown) -> Self {
        ...
        Self::M1(match (value).into_smelt_unknown() { SmeltUnknown::Object(values) => { let smelt_record_map = SmeltRecord::with_id_from_entries(values.id, values.into_iter()); { let smelt_record_map = smelt_record_map.clone(); InitLike { headers: smelt_record_map.get("headers").or_else(|| smelt_record_map.get("__smelt_proto:headers")).or_else(|| smelt_record_map.get("__smelt_method:headers")).cloned().map(|value| SmeltUnion6::from_smelt_unknown(value)), status: smelt_record_map.get("status").or_else(|| smelt_record_map.get("__smelt_proto:status")).or_else(|| smelt_record_map.get("__smelt_method:status")).cloned().map(|value| match value.clone() { SmeltUnknown::Number(value) => value, SmeltUnknown::Object(value) => match value.get("__smelt_date") { Some(SmeltUnknown::Number(value)) => value, _ => f64::NAN }, SmeltUnknown::String(value) => value.parse::<f64>().unwrap_or(f64::NAN), SmeltUnknown::Bool(value) => if value { 1.0 } else { 0.0 }, SmeltUnknown::Null | SmeltUnknown::Undefined | SmeltUnknown::Symbol(_) | SmeltUnknown::Array(_) | SmeltUnknown::Function(_) | SmeltUnknown::Promise(_) => f64::NAN }), _smelt_phantom: ::std::marker::PhantomData } } }, _ => Default::default() })
    }
}
impl PartialEq for SmeltUnion16 {
    fn eq(&self, other: &Self) -> bool {
        self.clone().into_smelt_unknown() == other.clone().into_smelt_unknown()
    }
}
impl SmeltFromUnknown for SmeltUnion16 {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self { Self::from_smelt_unknown(value) }
}
impl SmeltJsKeyEq for SmeltUnion16 {
    fn same_js_key(&self, other: &Self) -> bool { self.clone().into_smelt_unknown().same_js_key(&other.clone().into_smelt_unknown()) }
    fn js_key_hash(&self) -> Option<u64> { self.clone().into_smelt_unknown().js_key_hash() }
}
impl ::std::fmt::Debug for SmeltUnion16 {
    fn fmt(&self, formatter: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::std::fmt::Debug::fmt(&self.clone().into_smelt_unknown(), formatter)
    }
}
impl Default for SmeltUnion16 {
    fn default() -> Self {
...
#[derive(Clone)]
pub enum SmeltUnion17 {
    M0(f64),
    M1(SmeltResponse),
    M2(InitLike<f64>),
}
impl IntoSmeltUnknown for SmeltUnion17 {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        match self {
            Self::M0(value) => SmeltUnknown::Number(value as f64),
            Self::M1(value) => value.clone().into_smelt_unknown(),
            Self::M2(value) => { let smelt_object_value = value; let smelt_struct_value = smelt_object_value.clone(); let mut smelt_object_entries = Vec::new(); if let Some(value) = smelt_object_value.headers.clone() { smelt_object_entries.push(("headers".to_owned(), value.into_smelt_unknown())); } if let Some(value) = smelt_object_value.status.clone() { smelt_object_entries.push(("status".to_owned(), (value).into_smelt_unknown())); } SmeltUnknown::Object(SmeltObject::new(smelt_object_entries)) },
        }
    }
}
impl SmeltUnion17 {
    fn from_smelt_unknown(value: SmeltUnknown) -> Self {
        ...
        if matches!(value, SmeltUnknown::Object(_)) { return Self::M1(<SmeltResponse as SmeltFromUnknown>::smelt_from_unknown(value.clone())); }
        Self::M2(match (value).into_smelt_unknown() { SmeltUnknown::Object(values) => { let smelt_record_map = SmeltRecord::with_id_from_entries(values.id, values.into_iter()); { let smelt_record_map = smelt_record_map.clone(); InitLike { headers: smelt_record_map.get("headers").or_else(|| smelt_record_map.get("__smelt_proto:headers")).or_else(|| smelt_record_map.get("__smelt_method:headers")).cloned().map(|value| SmeltUnion6::from_smelt_unknown(value)), status: smelt_record_map.get("status").or_else(|| smelt_record_map.get("__smelt_proto:status")).or_else(|| smelt_record_map.get("__smelt_method:status")).cloned().map(|value| match value.clone() { SmeltUnknown::Number(value) => value, SmeltUnknown::Object(value) => match value.get("__smelt_date") { Some(SmeltUnknown::Number(value)) => value, _ => f64::NAN }, SmeltUnknown::String(value) => value.parse::<f64>().unwrap_or(f64::NAN), SmeltUnknown::Bool(value) => if value { 1.0 } else { 0.0 }, SmeltUnknown::Null | SmeltUnknown::Undefined | SmeltUnknown::Symbol(_) | SmeltUnknown::Array(_) | SmeltUnknown::Function(_) | SmeltUnknown::Promise(_) => f64::NAN }), _smelt_phantom: ::std::marker::PhantomData } } }, _ => Default::default() })
    }
}
impl PartialEq for SmeltUnion17 {
    fn eq(&self, other: &Self) -> bool {
        self.clone().into_smelt_unknown() == other.clone().into_smelt_unknown()
    }
}
impl SmeltFromUnknown for SmeltUnion17 {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self { Self::from_smelt_unknown(value) }
}
impl SmeltJsKeyEq for SmeltUnion17 {
    fn same_js_key(&self, other: &Self) -> bool { self.clone().into_smelt_unknown().same_js_key(&other.clone().into_smelt_unknown()) }
    fn js_key_hash(&self) -> Option<u64> { self.clone().into_smelt_unknown().js_key_hash() }
}
impl ::std::fmt::Debug for SmeltUnion17 {
    fn fmt(&self, formatter: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::std::fmt::Debug::fmt(&self.clone().into_smelt_unknown(), formatter)
    }
}
impl Default for SmeltUnion17 {
    fn default() -> Self {
        Self::M0(0.0)
    }
}
...
fn main() {
    ...
    let _smelt_tmp_1: SmeltRecord<String, String> = SmeltRecord::from([("x-kind".to_owned(), "record".to_owned())]);
    let _smelt_tmp_2: InitLike<f64> = InitLike { headers: Some(SmeltUnion6::M1(_smelt_tmp_1)), status: Some(201.0), _smelt_phantom: ::std::marker::PhantomData };
    let record_init: InitLike<f64> = _smelt_tmp_2;
