...
pub(crate) async fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let _ = { println!("{} {} {}", _smelt_tmp_29, window.get(0.0).unwrap_or(0.0).clone(), true); };
    ...
    let _ = { println!("{} {}", _smelt_tmp_85, false); };
    ...
    let _ = { println!("{} {}", _smelt_tmp_90, _smelt_tmp_91); };
    return Ok(());
}
