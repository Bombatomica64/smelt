...
fn main() {
    let _smelt_tmp_3: SmeltList<String> = Into::<SmeltList<_>>::into(SmeltList::from({ let smelt_list_items: Vec<String> = vec![]; smelt_list_items }));
    let smelt_capture_rem: ::std::rc::Rc<::std::cell::RefCell<SmeltList<String>>> = ::std::rc::Rc::new(::std::cell::RefCell::new(Into::<SmeltList<_>>::into(_smelt_tmp_3)));
    let _smelt_tmp_4 = ::std::rc::Rc::new({
    let smelt_capture_rem = smelt_capture_rem.clone();
    move || {
    let _smelt_tmp_1: f64 = { let smelt_push_item = "second".to_owned(); (*smelt_capture_rem.borrow()).borrow_mut().push(smelt_push_item); (*smelt_capture_rem.borrow()).len() as f64 };
    ()
    }
});
    let second = _smelt_tmp_4.clone();
    let _smelt_tmp_5 = ::std::rc::Rc::new({
    let smelt_capture_rem = smelt_capture_rem.clone();
    let second = second.clone();
    move || {
    let _smelt_tmp_2: f64 = { let smelt_push_item = "first".to_owned(); (*smelt_capture_rem.borrow()).borrow_mut().push(smelt_push_item); (*smelt_capture_rem.borrow()).len() as f64 };
    let _smelt_tmp_3: () = take(&*second);
    ()
    }
});
    let outer = _smelt_tmp_5.clone();
    let _smelt_tmp_6: () = (outer)();
    let _smelt_tmp_7: String = (*smelt_capture_rem.borrow()).clone().borrow().join(&",".to_owned());
