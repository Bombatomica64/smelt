...
/// The forgiving-base64 decode engine `atob` is specified against.
...
fn smelt_btoa_throwing(value: &str) -> Result<String, Box<dyn ::std::error::Error>> {          use base64::Engine as _;          let mut bytes = Vec::with_capacity(value.len());          for ch in value.chars() {          let point = ch as u32;          if point > 0xFF { return Err(smelt_throw(SmeltUnknown::Object(SmeltObject::new(Vec::from([("__smelt_error".to_owned(), SmeltUnknown::String("InvalidCharacterError".into())), ("__smelt_domexception".to_owned(), SmeltUnknown::Bool(true)), ("message".to_owned(), SmeltUnknown::String("Invalid character".into())), ("stack".to_owned(), SmeltUnknown::Undefined), ("cause".to_owned(), SmeltUnknown::Undefined)]))))); }          bytes.push(point as u8);          }          Ok(base64::engine::general_purpose::STANDARD.encode(bytes)) }

/// `atob`: WHATWG forgiving-base64, throwing a catchable `InvalidCharacterError`.
fn smelt_atob_throwing(value: &str) -> Result<String, Box<dyn ::std::error::Error>> {          use base64::Engine as _;          let mut chars: Vec<char> = value.chars().filter(|ch| !matches!(ch, ' ' | '\t' | '\n' | '\r' | '\u{000c}')).collect();          if chars.len() % 4 == 0 {          if chars.ends_with(&['=', '=']) { chars.truncate(chars.len() - 2); }          else if chars.ends_with(&['=']) { chars.truncate(chars.len() - 1); }          }          if chars.len() % 4 == 1 { return Err(smelt_throw(SmeltUnknown::Object(SmeltObject::new(Vec::from([("__smelt_error".to_owned(), SmeltUnknown::String("InvalidCharacterError".into())), ("__smelt_domexception".to_owned(), SmeltUnknown::Bool(true)), ("message".to_owned(), SmeltUnknown::String("The string to be decoded is not correctly encoded.".into())), ("stack".to_owned(), SmeltUnknown::Undefined), ("cause".to_owned(), SmeltUnknown::Undefined)]))))); }          if !chars.iter().all(|ch| ch.is_ascii_alphanumeric() || *ch == '+' || *ch == '/') { return Err(smelt_throw(SmeltUnknown::Object(SmeltObject::new(Vec::from([("__smelt_error".to_owned(), SmeltUnknown::String("InvalidCharacterError".into())), ("__smelt_domexception".to_owned(), SmeltUnknown::Bool(true)), ("message".to_owned(), SmeltUnknown::String("Invalid character".into())), ("stack".to_owned(), SmeltUnknown::Undefined), ("cause".to_owned(), SmeltUnknown::Undefined)]))))); }          let encoded: String = chars.into_iter().collect();          match SMELT_BASE64_FORGIVING.decode(encoded.as_bytes()) {          Ok(bytes) => Ok(bytes.into_iter().map(char::from).collect()),          Err(_) => Err(smelt_throw(SmeltUnknown::Object(SmeltObject::new(Vec::from([("__smelt_error".to_owned(), SmeltUnknown::String("InvalidCharacterError".into())), ("__smelt_domexception".to_owned(), SmeltUnknown::Bool(true)), ("message".to_owned(), SmeltUnknown::String("Invalid character".into())), ("stack".to_owned(), SmeltUnknown::Undefined), ("cause".to_owned(), SmeltUnknown::Undefined)]))))) } }
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let _smelt_tmp_0: String = encode("hello".to_owned())?;
    let _ = { println!("{}", _smelt_tmp_0); };
    let _smelt_tmp_2: String = encode("".to_owned())?;
    let _ = { println!("{}", _smelt_tmp_2); };
    let _smelt_tmp_4: String = encode("a".to_owned())?;
    let _smelt_tmp_5: String = encode("ab".to_owned())?;
    let _smelt_tmp_6: String = encode("abc".to_owned())?;
    let _ = { println!("{} {} {}", _smelt_tmp_4, _smelt_tmp_5, _smelt_tmp_6); };
    let _smelt_tmp_8: String = encode("ÿ ".to_owned())?;
    let _ = { println!("{}", _smelt_tmp_8); };
    let _smelt_tmp_10: String = decode("aGVsbG8=".to_owned())?;
    let _ = { println!("{}", _smelt_tmp_10); };
    let _smelt_tmp_12: String = decode("".to_owned())?;
    let _ = { println!("{}", _smelt_tmp_12); };
    let _smelt_tmp_14: String = decode("YQ==".to_owned())?;
    let _smelt_tmp_15: String = decode("YWI=".to_owned())?;
    let _smelt_tmp_16: String = decode("YWJj".to_owned())?;
    let _ = { println!("{} {} {}", _smelt_tmp_14, _smelt_tmp_15, _smelt_tmp_16); };
    let _smelt_tmp_18: String = decode("aGVsbG8".to_owned())?;
    let _ = { println!("{}", _smelt_tmp_18); };
    let _smelt_tmp_20: String = decode("YR==".to_owned())?;
    let _ = { println!("{}", _smelt_tmp_20); };
    let _smelt_tmp_22: String = decode("aGVs bG8=".to_owned())?;
    let _ = { println!("{}", _smelt_tmp_22); };
    let _smelt_tmp_24: String = encode("round trip é".to_owned())?;
    let _smelt_tmp_25: String = decode(_smelt_tmp_24)?;
    let _ = { println!("{}", _smelt_tmp_25); };
    let _smelt_tmp_27: String = safe_encode("Ā".to_owned());
    let _ = { println!("{}", _smelt_tmp_27); };
    let _smelt_tmp_29: String = safe_encode("ok".to_owned());
    let _ = { println!("{}", _smelt_tmp_29); };
    let _smelt_tmp_31: String = safe_decode("a".to_owned());
    let _ = { println!("{}", _smelt_tmp_31); };
    let _smelt_tmp_33: String = safe_decode("!!!!".to_owned());
    let _ = { println!("{}", _smelt_tmp_33); };
    let _smelt_tmp_35: String = safe_decode("YR=".to_owned());
    let _ = { println!("{}", _smelt_tmp_35); };
    let _smelt_tmp_37: String = safe_decode("YWJj".to_owned());
    let _ = { println!("{}", _smelt_tmp_37); };
    let _smelt_tmp_39: bool = decoded_brand("****".to_owned());
    let _ = { println!("{}", _smelt_tmp_39); };
    let _smelt_tmp_41: bool = decoded_brand("YWJj".to_owned());
...
pub(crate) fn safe_decode(value: String) -> String {
    let _smelt_tmp_3: bool;
    let _smelt_tmp_4: String;
    let _smelt_tmp_5: String;
    let _smelt_tmp_6: String;
    match ::std::panic::catch_unwind(::std::panic::AssertUnwindSafe(|| smelt_atob_throwing(value.clone().as_str()))) {
        Ok(Ok(__smelt_value)) => {
            let _smelt_tmp_2: String = __smelt_value;
    return _smelt_tmp_2;
        }
...
pub(crate) fn decoded_brand(value: String) -> bool {
    let _smelt_tmp_3: bool;
    match ::std::panic::catch_unwind(::std::panic::AssertUnwindSafe(|| smelt_atob_throwing(value.clone().as_str()))) {
        Ok(Ok(__smelt_value)) => {
            let _smelt_tmp_2: String = __smelt_value;
    return false;
        ...
        Ok(Err(__smelt_error)) => {
            let error = smelt_thrown_value(&*__smelt_error);
    _smelt_tmp_3 = matches!(error.clone(), SmeltUnknown::Object(value) if value.contains_key("__smelt_domexception"));
    return _smelt_tmp_3;
        }
        Err(__smelt_panic) => {
            let __smelt_error = smelt_panic_message(&*__smelt_panic);
