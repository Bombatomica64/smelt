...
#[allow(dead_code)]
struct Index(::std::rc::Rc<::std::cell::RefCell<IndexInner>>);
#[derive(Debug, Default)]
#[allow(dead_code)]
struct IndexInner {
    _known: SmeltRecord<String, bool>,
}
impl Clone for Index {
    fn clone(&self) -> Self {
        Index(::std::rc::Rc::clone(&self.0))
    }
}
...
impl Default for Index {
    fn default() -> Self {
        Index(::std::rc::Rc::new(::std::cell::RefCell::new(IndexInner::default())))
    }
}
...
impl IntoSmeltUnknown for Index {
    fn into_smelt_unknown(self) -> SmeltUnknown {
...
fn main() {
    ...
    let _smelt_tmp_1: Index = Index::new();
    index = _smelt_tmp_1;
    let _ = index.add("a".to_owned());
    let _ = index.add("c".to_owned());
    _smelt_tmp_4 = Into::<SmeltList<_>>::into(SmeltList::from({ let smelt_list_items: Vec<String> = vec!["a".to_owned(), "b".to_owned(), "c".to_owned()]; smelt_list_items }));
    let _smelt_tmp_5: SmeltList<String> = index.keep(_smelt_tmp_4);
    _smelt_tmp_6 = _smelt_tmp_5.borrow().join(&",".to_owned());
    _smelt_tmp_7 = "kept: ".to_owned() + &_smelt_tmp_6;
    ...
    let _smelt_tmp_10: SmeltList<String> = index.label(_smelt_tmp_9, "!".to_owned());
    _smelt_tmp_11 = _smelt_tmp_10.borrow().join(&",".to_owned());
    _smelt_tmp_12 = "labelled: ".to_owned() + &_smelt_tmp_11;
...
impl Index {
    fn new() -> Self {
    let mut this: Self = Index(::std::rc::Rc::new(::std::cell::RefCell::new(IndexInner { _known: SmeltRecord::new() })));
    let _smelt_tmp_1: SmeltRecord<String, bool> = SmeltRecord::from([]);
    this.0.borrow_mut()._known = _smelt_tmp_1;
    return this;
    }
    fn add(&self, key: String) -> () {
    let mut _smelt_tmp_2: SmeltRecord<String, bool> = self.0.borrow()._known.clone();
    _smelt_tmp_2.insert(key.clone(), true);
    self.0.borrow_mut()._known = _smelt_tmp_2;
    return;
    }
    fn keep(&self, keys: SmeltList<String>) -> SmeltList<String> {
    let _smelt_tmp_2 = ::std::rc::Rc::new({
    let smelt_self = self.clone();
    move |closure_arg_0: String, _arg0: i64, _arg1: &SmeltList<String>| {
    let _smelt_tmp_2: SmeltRecord<String, bool> = smelt_self.0.borrow()._known.clone();
    let _smelt_tmp_3: bool = _smelt_tmp_2.get(&closure_arg_0.clone()).unwrap_or(false) == true;
    _smelt_tmp_3
    }
});
...
}); let smelt_array = keys.clone(); smelt_array.borrow().iter().enumerate().filter_map(|(index, item)| if (smelt_callback)(item.clone(), index as i64, &smelt_array) { Some(item.clone()) } else { None }).collect::<Vec<_>>() });
    return _smelt_tmp_3;
    }
    fn label(&self, keys: SmeltList<String>, suffix: String) -> SmeltList<String> {
    ...
    let _smelt_tmp_6: String;
    let _smelt_tmp_3: SmeltRecord<String, bool> = smelt_self.0.borrow()._known.clone();
    let _smelt_tmp_4: bool = _smelt_tmp_3.get(&closure_arg_0.clone()).unwrap_or(false) == true;
    if _smelt_tmp_4 {
    ...
    fn __smelt_proto_entries(&self) -> Vec<(String, SmeltUnknown)> {
        ...
        smelt_proto_entries.push(("__smelt_method:add".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.add(SmeltFromUnknown::smelt_from_unknown(smelt_args.get(0).cloned().unwrap_or(SmeltUnknown::Undefined))); Ok({ let () = smelt_result; SmeltUnknown::Undefined }) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Index::add")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries.push(("__smelt_method:keep".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.keep(SmeltFromUnknown::smelt_from_unknown(smelt_args.get(0).cloned().unwrap_or(SmeltUnknown::Undefined))); Ok(SmeltUnknown::Array(smelt_result.into_iter().map(|value| SmeltUnknown::String(value.into())).collect())) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Index::keep")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries.push(("__smelt_method:label".to_owned(), { let smelt_method: ::std::rc::Rc<dyn Fn(Vec<SmeltUnknown>) -> Result<SmeltUnknown, Box<dyn std::error::Error>>> = ::std::rc::Rc::new({ let smelt_receiver = self.clone(); move |smelt_args: Vec<SmeltUnknown>| { let _ = &smelt_args; let smelt_result = smelt_receiver.label(SmeltFromUnknown::smelt_from_unknown(smelt_args.get(0).cloned().unwrap_or(SmeltUnknown::Undefined)), SmeltFromUnknown::smelt_from_unknown(smelt_args.get(1).cloned().unwrap_or(SmeltUnknown::Undefined))); Ok(SmeltUnknown::Array(smelt_result.into_iter().map(|value| SmeltUnknown::String(value.into())).collect())) } }); smelt_link_function_identity_key(&smelt_method, smelt_method_identity("Index::label")); SmeltUnknown::Function(smelt_method) }));
        smelt_proto_entries
    }
}
