...
fn main() {
    ...
    let _ = { println!("{} {}", smelt_console_number(_smelt_tmp_40), converted.get(0.0).unwrap_or(0.0).clone()); };
    ...
    let _ = { println!("{} {} {}", smelt_console_number(_smelt_tmp_51), smelt_console_number(_smelt_tmp_52), wide.get(1.0).unwrap_or(0.0).clone()); };
    ...
    let _ = { println!("{} {} {}", from_elements.get(1.0).unwrap_or(0.0).clone(), shared.get(0.0).unwrap_or(0.0).clone(), smelt_console_number(_smelt_tmp_56)); };
    ...
    let _ = { println!("{} {} {}", from_elements.get(0.0).unwrap_or(0.0).clone(), copied.get(0.0).unwrap_or(0.0).clone(), smelt_console_number(_smelt_tmp_59)); };
    ...
    let _ = { println!("{} {}", smelt_console_number(_smelt_tmp_155), encoded.get(0.0).unwrap_or(0.0).clone()); };
    return;
}
