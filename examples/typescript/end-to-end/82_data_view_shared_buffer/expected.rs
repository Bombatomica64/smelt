...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let view: SmeltDataView;
    let windowed: SmeltDataView;
    let shared_view: SmeltDataView;
    ...
    let _smelt_tmp_22: SmeltTypedArray;
    let _smelt_tmp_23: SmeltArrayBuffer;
    let _smelt_tmp_24: bool;
    let _smelt_tmp_26: SmeltArrayBuffer;
    let _smelt_tmp_27: f64;
    let _smelt_tmp_28: bool;
    let _smelt_tmp_30: SmeltArrayBuffer;
    let _smelt_tmp_31: SmeltDataView;
    let _smelt_tmp_32: f64;
    let _smelt_tmp_33: f64;
    let _smelt_tmp_34: SmeltArrayBuffer;
    let _smelt_tmp_35: bool;
    ...
    let _smelt_tmp_83: String;
    let _smelt_tmp_85: bool;
    let mut _smelt_tmp_86: f64;
    let _smelt_tmp_87: f64;
    let _smelt_tmp_88: f64;
    let _smelt_tmp_8: SmeltArrayBuffer = SmeltArrayBuffer::new_shared(((8.0) as f64).max(0.0) as usize);
    let shared: SmeltArrayBuffer = _smelt_tmp_8;
    let _smelt_tmp_9: SmeltArrayBuffer = SmeltArrayBuffer::new(((8.0) as f64).max(0.0) as usize);
    let plain: SmeltArrayBuffer = _smelt_tmp_9;
    let _smelt_tmp_10: f64 = shared.clone().byte_length();
    let _smelt_tmp_11: f64 = plain.clone().byte_length();
    let _ = { println!("{} {}", smelt_console_number(_smelt_tmp_10), smelt_console_number(_smelt_tmp_11)); };
    _smelt_tmp_13 = shared.clone().is_shared();
    _smelt_tmp_14 = !shared.clone().is_shared();
    let _ = { println!("{} {}", _smelt_tmp_13, _smelt_tmp_14); };
    _smelt_tmp_16 = !plain.clone().is_shared();
    _smelt_tmp_17 = plain.clone().is_shared();
    let _ = { println!("{} {}", _smelt_tmp_16, _smelt_tmp_17); };
    _smelt_tmp_19 = format!("[object {}]", shared.clone().class_name());
    _smelt_tmp_20 = format!("[object {}]", plain.class_name());
    let _ = { println!("{} {}", _smelt_tmp_19, _smelt_tmp_20); };
    _smelt_tmp_22 = SmeltTypedArray::over_buffer(SmeltTypedArrayKind::Uint8, &shared.clone(), 0, None);
    over_shared = _smelt_tmp_22;
    ...
    _smelt_tmp_28 = copied.is_shared();
    let _ = { println!("{} {}", smelt_console_number(_smelt_tmp_27), _smelt_tmp_28); };
    _smelt_tmp_30 = SmeltArrayBuffer::new(((16.0) as f64).max(0.0) as usize);
    buffer = _smelt_tmp_30;
    _smelt_tmp_31 = SmeltDataView::over_buffer(&buffer.clone(), 0, None);
    view = _smelt_tmp_31;
    _smelt_tmp_32 = view.clone().byte_length();
    _smelt_tmp_33 = view.clone().byte_offset();
    _smelt_tmp_34 = view.clone().buffer();
    _smelt_tmp_35 = _smelt_tmp_34.id() == buffer.clone().id();
    let _ = { println!("{} {} {}", smelt_console_number(_smelt_tmp_32), smelt_console_number(_smelt_tmp_33), _smelt_tmp_35); };
    _smelt_tmp_37 = true;
    _smelt_tmp_38 = "[object DataView]".to_owned();
    let _ = { println!("{} {} {}", _smelt_tmp_37, _smelt_tmp_38, true); };
    _smelt_tmp_40 = -2.0;
    let _ = smelt_data_view_set_throwing(&view.clone(), SmeltTypedArrayKind::Int16, (0.0) as f64, _smelt_tmp_40, false)?;
    let _smelt_tmp_42: f64 = smelt_data_view_get_throwing(&view.clone(), SmeltTypedArrayKind::Int16, (0.0) as f64, false)?;
    let _smelt_tmp_43: f64 = smelt_data_view_get_throwing(&view.clone(), SmeltTypedArrayKind::Uint16, (0.0) as f64, false)?;
    let _ = { println!("{} {}", smelt_console_number(_smelt_tmp_42), smelt_console_number(_smelt_tmp_43)); };
    let _smelt_tmp_45: f64 = smelt_data_view_get_throwing(&view.clone(), SmeltTypedArrayKind::Uint8, (0.0) as f64, false)?;
    let _smelt_tmp_46: f64 = smelt_data_view_get_throwing(&view.clone(), SmeltTypedArrayKind::Uint8, (1.0) as f64, false)?;
    let _ = { println!("{} {}", smelt_console_number(_smelt_tmp_45), smelt_console_number(_smelt_tmp_46)); };
    _smelt_tmp_48 = -2.0;
    let _ = smelt_data_view_set_throwing(&view.clone(), SmeltTypedArrayKind::Int16, (2.0) as f64, _smelt_tmp_48, true)?;
    let _smelt_tmp_50: f64 = smelt_data_view_get_throwing(&view.clone(), SmeltTypedArrayKind::Uint8, (2.0) as f64, false)?;
    let _smelt_tmp_51: f64 = smelt_data_view_get_throwing(&view.clone(), SmeltTypedArrayKind::Uint8, (3.0) as f64, false)?;
    let _ = { println!("{} {}", smelt_console_number(_smelt_tmp_50), smelt_console_number(_smelt_tmp_51)); };
    let _smelt_tmp_53: f64 = smelt_data_view_get_throwing(&view.clone(), SmeltTypedArrayKind::Int16, (2.0) as f64, true)?;
    let _smelt_tmp_54: f64 = smelt_data_view_get_throwing(&view.clone(), SmeltTypedArrayKind::Int16, (2.0) as f64, false)?;
    let _ = { println!("{} {}", smelt_console_number(_smelt_tmp_53), smelt_console_number(_smelt_tmp_54)); };
    let _ = smelt_data_view_set_throwing(&view.clone(), SmeltTypedArrayKind::Uint32, (4.0) as f64, 4294967295.0, false)?;
    let _smelt_tmp_57: f64 = smelt_data_view_get_throwing(&view.clone(), SmeltTypedArrayKind::Uint32, (4.0) as f64, false)?;
    let _smelt_tmp_58: f64 = smelt_data_view_get_throwing(&view.clone(), SmeltTypedArrayKind::Int32, (4.0) as f64, false)?;
    let _ = { println!("{} {}", smelt_console_number(_smelt_tmp_57), smelt_console_number(_smelt_tmp_58)); };
    let _ = smelt_data_view_set_throwing(&view.clone(), SmeltTypedArrayKind::Float64, (8.0) as f64, 1.5, false)?;
    let _smelt_tmp_61: f64 = smelt_data_view_get_throwing(&view.clone(), SmeltTypedArrayKind::Float64, (8.0) as f64, false)?;
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_61)); };
    _smelt_tmp_63 = SmeltDataView::over_buffer(&buffer, ((8.0) as f64).max(0.0) as usize, Some((((4.0)) as f64).max(0.0) as usize));
    ...
    let _ = smelt_data_view_set_throwing(&windowed.clone(), SmeltTypedArrayKind::Int8, (0.0) as f64, 7.0, false)?;
    let _smelt_tmp_68: f64 = smelt_data_view_get_throwing(&view.clone(), SmeltTypedArrayKind::Int8, (8.0) as f64, false)?;
    let _smelt_tmp_69: f64 = smelt_data_view_get_throwing(&windowed, SmeltTypedArrayKind::Int8, (0.0) as f64, false)?;
    ...
    _smelt_tmp_72 = shared_view.clone().buffer();
    ...
    let _smelt_tmp_76: f64 = smelt_data_view_get_throwing(&shared_view, SmeltTypedArrayKind::Uint8, (0.0) as f64, false)?;
    ...
    _smelt_tmp_80 = _smelt_tmp_79.len() as f64;
    let _ = { println!("{} {}", _smelt_tmp_78, smelt_console_number(_smelt_tmp_80)); };
    _smelt_tmp_82 = smelt_object_to_string_tag(&(view.clone().into_smelt_unknown()));
    _smelt_tmp_83 = smelt_object_to_string_tag(&(shared.clone().into_smelt_unknown()));
    let _ = { println!("{} {}", _smelt_tmp_82, _smelt_tmp_83); };
    _smelt_tmp_85 = true;
    let mut _smelt_tmp_86: f64 = 0.0;
    if _smelt_tmp_85 {
    _smelt_tmp_87 = view.byte_length();
    _smelt_tmp_86 = _smelt_tmp_87;
    } else {
    _smelt_tmp_88 = -1.0;
    _smelt_tmp_86 = _smelt_tmp_88;
    }
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_86)); };
    return Ok(());
}
