...
fn main() {
    ...
    let _ = { println!("{} {}", _smelt_tmp_10, _smelt_tmp_11); };
    ...
    let _ = { println!("{} {}", _smelt_tmp_27, _smelt_tmp_28); };
    ...
    let _ = { println!("{} {} {}", _smelt_tmp_32, _smelt_tmp_33, _smelt_tmp_35); };
    _smelt_tmp_37 = true;
    ...
    let _ = { println!("{} {}", _smelt_tmp_42, _smelt_tmp_43); };
    ...
    let _ = { println!("{} {}", _smelt_tmp_50, _smelt_tmp_51); };
    ...
    let _ = { println!("{} {}", _smelt_tmp_53, _smelt_tmp_54); };
    ...
    let _ = { println!("{} {}", _smelt_tmp_57, _smelt_tmp_58); };
    ...
    let _ = { println!("{} {}", _smelt_tmp_64, _smelt_tmp_65); };
    ...
    let _ = { println!("{} {}", _smelt_tmp_68, _smelt_tmp_69); };
    ...
    let _ = { println!("{} {}", _smelt_tmp_78, _smelt_tmp_80); };
    let _smelt_tmp_82: String = tag_of(view.clone().into_smelt_unknown());
    let _smelt_tmp_83: String = tag_of(shared.clone().into_smelt_unknown());
    ...
    let _ = { println!("{} {}", _smelt_tmp_85, _smelt_tmp_86); };
    return;
}
...
pub(crate) fn tag_of(value: SmeltUnknown) -> String {
    let _smelt_tmp_1: String = smelt_object_to_string_tag(&(value.clone()));
    return _smelt_tmp_1;
}

pub(crate) fn width_of(value: SmeltUnknown) -> f64 {
    let mut _smelt_tmp_2: f64;
    let _smelt_tmp_3: SmeltDataView;
    let _smelt_tmp_4: f64;
    let _smelt_tmp_5: f64;
    let _smelt_tmp_1: bool = matches!(value.clone().clone(), SmeltUnknown::Object(value) if value.contains_key("__smelt_dataview"));
    let mut _smelt_tmp_2: f64 = 0.0;
    if _smelt_tmp_1 {
    _smelt_tmp_3 = <SmeltDataView as SmeltFromUnknown>::smelt_from_unknown(value.clone());
    _smelt_tmp_4 = _smelt_tmp_3.byte_length();
    _smelt_tmp_2 = _smelt_tmp_4;
    } else {
    _smelt_tmp_5 = -1.0;
