...
smelt_local.block_on(&smelt_runtime, async move {
    ...
    let _smelt_tmp_8: ();
    let _smelt_tmp_0: f64 = outer(2.0);
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_0)); };
    let _smelt_tmp_2: f64 = via_function(4.0);
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_2)); };
    let _smelt_tmp_4 = SmeltFuture::from_future(Box::pin(twice(1.0)));
    _smelt_tmp_5 = _smelt_tmp_4.await?;
    let _ = { println!("{}", smelt_console_number(_smelt_tmp_5)); };
    let _smelt_tmp_7: SmeltFuture<()> = SmeltFuture::from_future(Box::pin(async move { smelt_run_until_exit().await; Ok::<_, Box<dyn std::error::Error>>(()) }));
...
pub(crate) fn via_function(n: f64) -> f64 {
    let _smelt_tmp_2: f64;
    let _smelt_tmp_1: f64 = lastly(n);
    _smelt_tmp_2 = _smelt_tmp_1 - 1.0;
    return _smelt_tmp_2;
}

pub(crate) fn inner(n: f64) -> f64 {
    let _smelt_tmp_1: f64 = n * 10.0;
    return _smelt_tmp_1;
}

pub(crate) async fn later(n: f64) -> Result<f64, Box<dyn std::error::Error>> {
    let _smelt_tmp_1: f64 = n + 1.0;
    return Ok(_smelt_tmp_1);
}

pub(crate) fn lastly(n: f64) -> f64 {
    let _smelt_tmp_1: f64 = n * n;
    return _smelt_tmp_1;
}

pub(crate) fn outer(n: f64) -> f64 {
    let _smelt_tmp_2: f64;
    let _smelt_tmp_1: f64 = inner(n);
    _smelt_tmp_2 = _smelt_tmp_1 + 1.0;
    return _smelt_tmp_2;
}

pub(crate) async fn twice(n: f64) -> Result<f64, Box<dyn std::error::Error>> {
    let r: f64;
    let _smelt_tmp_3: f64;
    let _smelt_tmp_4: f64;
    let _smelt_tmp_2 = SmeltFuture::from_future(Box::pin(later(n)));
