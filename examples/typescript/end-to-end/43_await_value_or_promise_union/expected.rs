...
impl IntoSmeltUnknown for Cell {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        SmeltUnknown::Object(SmeltObject::new(Vec::from([
        ("value".to_owned(), SmeltUnknown::Number(self.value as f64)),
        ])))
    }
}
impl SmeltFromUnknown for Cell {
    fn smelt_from_unknown(value: SmeltUnknown) -> Self {
...
impl IntoSmeltUnknown for SmeltUnion3 {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        match self {
            Self::M0(value) => { let smelt_object_value = value; let smelt_struct_value = smelt_object_value.clone(); let mut smelt_object_entries = Vec::new(); smelt_object_entries.push(("value".to_owned(), SmeltUnknown::Number(smelt_object_value.value as f64))); smelt_object_entries.push(("__smelt_class".to_owned(), SmeltUnknown::String("Cell".into()))); SmeltUnknown::Object(SmeltObject::new(smelt_object_entries)) },
            Self::M1(value) => { let smelt_future = value; SmeltUnknown::Promise(SmeltPromise::from_future(Box::pin(async move { let smelt_value = smelt_future.await?; Ok::<SmeltUnknown, Box<dyn std::error::Error>>({ let smelt_object_value = smelt_value; let smelt_struct_value = smelt_object_value.clone(); let mut smelt_object_entries = Vec::new(); smelt_object_entries.push(("value".to_owned(), SmeltUnknown::Number(smelt_object_value.value as f64))); smelt_object_entries.push(("__smelt_class".to_owned(), SmeltUnknown::String("Cell".into()))); SmeltUnknown::Object(SmeltObject::new(smelt_object_entries)) }) }))) },
        }
    }
}
impl SmeltUnion3 {
    fn from_smelt_unknown(value: SmeltUnknown) -> Self {
        ...
        Self::M1({ let smelt_erased_future = (value).into_smelt_unknown(); SmeltFuture::from_future(Box::pin(async move { let smelt_awaited = smelt_await_flatten(smelt_erased_future).await?; Ok::<_, Box<dyn std::error::Error>>(Default::default()) })) })
    }
}
...
impl IntoSmeltUnknown for SmeltUnion7 {
    fn into_smelt_unknown(self) -> SmeltUnknown {
        match self {
            ...
            Self::M1(value) => { let smelt_future = value; SmeltUnknown::Promise(SmeltPromise::from_future(Box::pin(async move { let smelt_value = smelt_future.await?; Ok::<SmeltUnknown, Box<dyn std::error::Error>>(SmeltUnknown::Number(smelt_value as f64)) }))) },
        }
    }
}
impl SmeltUnion7 {
    fn from_smelt_unknown(value: SmeltUnknown) -> Self {
        ...
        Self::M1({ let smelt_erased_future = (value).into_smelt_unknown(); SmeltFuture::from_future(Box::pin(async move { let smelt_awaited = smelt_await_flatten(smelt_erased_future).await?; Ok::<_, Box<dyn std::error::Error>>(match smelt_awaited.clone() { SmeltUnknown::Number(value) => value, SmeltUnknown::Object(value) => match value.get("__smelt_date") { Some(SmeltUnknown::Number(value)) => value, _ => f64::NAN }, SmeltUnknown::String(value) => value.parse::<f64>().unwrap_or(f64::NAN), SmeltUnknown::Bool(value) => if value { 1.0 } else { 0.0 }, SmeltUnknown::Null | SmeltUnknown::Undefined | SmeltUnknown::Symbol(_) | SmeltUnknown::Array(_) | SmeltUnknown::Function(_) | SmeltUnknown::Promise(_) => f64::NAN }) })) })
    }
}
...
impl Cell {
    ...
    let mut this: Self = Cell { value: 0.0 };
    this.value = value;
    return this;
    }
}
...
pub(crate) fn pick(sync: bool) -> SmeltUnion3 {
    let mut _smelt_tmp_1: SmeltUnion3;
    if sync {
    let _smelt_tmp_2: Cell = Cell::new(1.0);
    _smelt_tmp_1 = SmeltUnion3::M0(_smelt_tmp_2);
    return _smelt_tmp_1;
    } else {
    let _smelt_tmp_3: Cell = Cell::new(2.0);
    let _smelt_tmp_4: SmeltFuture<Cell> = SmeltFuture::from_future(Box::pin(async move { smelt_sleep_ms(0.0 as f64).await; Ok::<_, Box<dyn std::error::Error>>(_smelt_tmp_3) }));
    _smelt_tmp_1 = SmeltUnion3::M1(_smelt_tmp_4);
    return _smelt_tmp_1;
    }
}

pub(crate) fn pick_number(sync: bool) -> SmeltUnion7 {
    let mut _smelt_tmp_1: SmeltUnion7;
    let mut _smelt_tmp_1: SmeltUnion7 = SmeltUnion7::M0(0.0);
    if sync {
    _smelt_tmp_1 = SmeltUnion7::M0(10.0);
    } else {
    let _smelt_tmp_2: SmeltFuture<f64> = SmeltFuture::from_future(Box::pin(async move { smelt_sleep_ms(0.0 as f64).await; Ok::<_, Box<dyn std::error::Error>>(20.0) }));
    _smelt_tmp_1 = SmeltUnion7::M1(_smelt_tmp_2);
    }
    return _smelt_tmp_1;
}
...
pub(crate) async fn run() -> Result<String, Box<dyn std::error::Error>> {
    let direct: Cell;
    let deferred: Cell;
    let direct_number: f64;
    let deferred_number: f64;
    let _smelt_tmp_6: Cell;
    let _smelt_tmp_9: Cell;
    ...
    let _smelt_tmp_4: SmeltUnion3 = pick(true);
    let _smelt_tmp_5: SmeltFuture<Cell> = match _smelt_tmp_4 { SmeltUnion3::M0(value) => SmeltFuture::<Cell>::resolved(value), SmeltUnion3::M1(value) => value };
    _smelt_tmp_6 = _smelt_tmp_5.await?;
    direct = _smelt_tmp_6;
    let _smelt_tmp_7: SmeltUnion3 = pick(false);
    let _smelt_tmp_8: SmeltFuture<Cell> = match _smelt_tmp_7 { SmeltUnion3::M0(value) => SmeltFuture::<Cell>::resolved(value), SmeltUnion3::M1(value) => value };
    _smelt_tmp_9 = _smelt_tmp_8.await?;
    deferred = _smelt_tmp_9;
    let _smelt_tmp_10: SmeltUnion7 = pick_number(true);
    let _smelt_tmp_11: SmeltFuture<f64> = match _smelt_tmp_10 { SmeltUnion7::M0(value) => SmeltFuture::<f64>::resolved(value), SmeltUnion7::M1(value) => value };
    _smelt_tmp_12 = _smelt_tmp_11.await?;
    direct_number = _smelt_tmp_12;
    let _smelt_tmp_13: SmeltUnion7 = pick_number(false);
    let _smelt_tmp_14: SmeltFuture<f64> = match _smelt_tmp_13 { SmeltUnion7::M0(value) => SmeltFuture::<f64>::resolved(value), SmeltUnion7::M1(value) => value };
    _smelt_tmp_15 = _smelt_tmp_14.await?;
    deferred_number = _smelt_tmp_15;
    _smelt_tmp_16 = direct.value + deferred.value;
    _smelt_tmp_17 = "".to_owned() + &smelt_number_to_string(_smelt_tmp_16);
    _smelt_tmp_18 = _smelt_tmp_17 + &"/".to_owned();
    _smelt_tmp_19 = direct_number + deferred_number;
    _smelt_tmp_20 = _smelt_tmp_18 + &smelt_number_to_string(_smelt_tmp_19);
    return Ok(_smelt_tmp_20);
}
