...
impl<'mir> FunctionEmitter<'mir> {
    ...
    fn operand_as_type_text(&self, operand: &Operand, target: TypeId) -> Result<String, EmitError> {
    ...
    fn unknown_wrap_text(&self, operand: &Operand) -> Result<String, EmitError> {
    ...
    fn unknown_cast_text(&self, value: &Operand, target: TypeId) -> Result<String, EmitError> {
        let text = self.operand_text(value)?;
    ...
    fn instance_of_text(&self, value: &Operand, class: Symbol) -> Result<String, EmitError> {
    ...
    fn class_extends_or_equals(&self, source: Symbol, target: Symbol) -> bool {
