...
/// Every TypeScript end-to-end example fixture, in numeric order.
///
/// Kept beside the test rather than inside it: the list grows with every
/// fixture, and a function whose body is one long literal trips the
/// line-count lint for a reason that has nothing to do with the test's logic.
