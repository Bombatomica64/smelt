...
pub use lowering::{
    ...
    predeclare_type_declarations_with_path, scan_declared_type_names, scan_type_reexports,
    scan_written_host_globals, TypeReexport,
    to_hir, to_hir_with_options, to_hir_with_path,
};
