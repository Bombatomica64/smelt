...
| `smelt-cli` | 71.68% | 75.54% | 65.57% |
| `smelt-codegen-rust` | 87.42% | 79.32% | 55.68% |
| `smelt-frontend-py` | 76.29% | 73.20% | 66.15% |
| `smelt-frontend-ts` | 81.94% | 71.93% | 68.71% |
| `smelt-hir` | 51.69% | 30.44% | 50.00% |
| `smelt-mir` | 82.23% | 67.89% | 63.10% |
