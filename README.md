...
| `smelt-cli` | 79.02% | 80.32% | 68.39% |
| `smelt-codegen-rust` | 77.63% | 71.94% | 53.14% |
| `smelt-frontend-py` | 78.71% | 73.59% | 65.79% |
| `smelt-frontend-ts` | 78.40% | 71.18% | 64.69% |
| `smelt-hir` | 51.61% | 31.77% | 51.69% |
| `smelt-mir` | 75.11% | 61.60% | 60.65% |
