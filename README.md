...
| `smelt-cli` | 72.97% | 77.56% | 66.95% |
| `smelt-codegen-rust` | 85.31% | 77.10% | 54.83% |
| `smelt-frontend-py` | 76.55% | 73.31% | 65.51% |
| `smelt-frontend-ts` | 80.82% | 73.02% | 67.96% |
| `smelt-hir` | 51.65% | 29.97% | 51.85% |
| `smelt-mir` | 79.23% | 68.12% | 62.50% |
