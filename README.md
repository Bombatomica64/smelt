...
| `smelt-cli` | 76.38% | 80.41% | 68.45% |
| `smelt-codegen-rust` | 81.92% | 73.58% | 53.85% |
| `smelt-frontend-py` | 78.09% | 73.06% | 65.34% |
| `smelt-frontend-ts` | 78.31% | 71.41% | 65.51% |
| `smelt-hir` | 52.17% | 31.98% | 51.69% |
| `smelt-mir` | 78.95% | 67.07% | 61.76% |
